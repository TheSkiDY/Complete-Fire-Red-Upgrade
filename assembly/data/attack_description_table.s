...
.word DESC_DIRECLAW
.word DESC_PSYSHIELDBASH
.word DESC_SPRINGTIDESTORM
.word DESC_MYSTICALPOWER
.word DESC_RAGINGFURY
.word DESC_WAVECRASH
.word DESC_CHLOROBLAST
.word DESC_MOUNTAINGALE
.word DESC_VICTORYDANCE
.word DESC_HEADLONGRUSH
.word DESC_BARBBARRAGE
.word DESC_ESPERWING
.word DESC_BITTERMALICE
.word DESC_SHELTER
.word DESC_TRIPLEARROWS
.word DESC_INFERNALPARADE
.word DESC_CEASELESSEDGE
.word DESC_BLEAKWINDSTORM
.word DESC_WILDBOLTSTORM
.word DESC_SANDSEARSTORM
.word DESC_LUNARBLESSING
.word DESC_TAKEHEART
