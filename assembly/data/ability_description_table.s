...
.word DESC_ABILITY_EMPTY_8
.word DESC_ABILITY_EMPTY_9
...
.word DESC_PUREAURA
.word 0x824f9ec		@ABILITY_BLAZE_LIKE
.word DESC_DEFLECTOR
.word DESC_COMPRESSION
...
.word DESC_ABILITY_EMPTY_1
.word DESC_ABILITY_EMPTY_20
.word DESC_ABILITY_EMPTY_2
...
.word DESC_DARKAURA
.word DESC_COMPLETIONIST
.word DESC_AURABREAK
.word DESC_REFRIGERATE
.word DESC_SPLIT_CHANGE
.word DESC_BEWILDER
.word DESC_NORMALIZE
.word DESC_UNBURDEN
.word DESC_SIMPLE
...
.word DESC_ABILITY_EMPTY_6
.word DESC_UNSEENFIST
.word DESC_FORM_CHANGE_SIGNATURE
.word DESC_ABILITY_EMPTY_17
.word DESC_BEASTBOOST
.word DESC_CORROSION
.word DESC_ABILITY_EMPTY_16
.word DESC_EMERGENCYEXIT
.word DESC_FLUFFY
.word DESC_STEELYSPIRIT
.word DESC_PERISHBODY
.word DESC_WANDERINGSPIRIT
.word DESC_ABILITY_EMPTY_18
.word DESC_ABILITY_EMPTY_4
.word DESC_RKS_SYSTEM
.word DESC_ABILITY_EMPTY_14
.word DESC_PURIFIEDPOLLEN
.word DESC_ABILITY_EMPTY_15
.word DESC_SLUSHRUSH
.word DESC_SOULHEART
.word DESC_STAMINA
...
.word DESC_ABILITY_EMPTY_10
.word DESC_ABILITY_EMPTY_11
.word DESC_ABILITY_EMPTY_12
...
.word DESC_BADDREAMS
.word DESC_SANITY
.word DESC_RAPIDKICKS
.word DESC_POISONTOUCH
.word DESC_PLUNDER
.word DESC_ABILITY_EMPTY_13
