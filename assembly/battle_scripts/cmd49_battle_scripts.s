...
BattleScript_SpikyShield:
	...
	setword BATTLE_STRING_LOADER gText_SpikyShield
	printstring 0x184
	waitmessage DELAY_1SECOND
...
BattleScript_BanefulBunker:
	...
	setword BATTLE_STRING_LOADER gText_BanefulBunkerPSN
	printstring 0x184
	waitmessage DELAY_1SECOND
	return
...
BattleScript_MindBlownDamage:
	...
	graphicalhpupdate BANK_ATTACKER
	datahpupdate BANK_ATTACKER
	setword BATTLE_STRING_LOADER gText_MindBlown
	printstring 0x184
	waitmessage DELAY_1SECOND
	faintpokemon BANK_ATTACKER 0x0 0x0
	return
...
BattleScript_LifeOrbDamage:
	...
	graphicalhpupdate BANK_ATTACKER
	datahpupdate BANK_ATTACKER
	setword BATTLE_STRING_LOADER gText_LifeOrb
	printstring 0x184
	waitmessage DELAY_1SECOND
	faintpokemon BANK_ATTACKER 0x0 0x0
	return
...
ToxicSpikesPSN:
	setbyte POISONED_BY 0x0
	setword BATTLE_STRING_LOADER gText_ToxicSpikesPSN
	printstring 0x184
	waitmessage DELAY_1SECOND
	goto 0x81D91C3
...
ToxicSpikesBadPSN:
	setbyte POISONED_BY 0x0
	setword BATTLE_STRING_LOADER gText_ToxicSpikesBadPSN
	printstring 0x184
	waitmessage DELAY_1SECOND
	goto 0x81D91C3
...
BeakBlastBurnBS:
	setbyte POISONED_BY 0x0
	setword BATTLE_STRING_LOADER gText_BeakBlast
	printstring 0x184
	waitmessage DELAY_1SECOND
	goto 0x81D91C3
...
BattleScript_PluckEat:
	setword BATTLE_STRING_LOADER gText_Pluck
	printstring 0x184
	waitmessage DELAY_1SECOND
