...
BattleScript_CheekPouch:
	...
	graphicalhpupdate BANK_SCRIPTING
	datahpupdate BANK_SCRIPTING
	setword BATTLE_STRING_LOADER gText_CheekPouch
	printstring 0x184
	waitmessage DELAY_1SECOND
...
BattleScript_AirBallooonPop:
	setword BATTLE_STRING_LOADER gText_AirBalloonPop
	printstring 0x184
	waitmessage DELAY_1SECOND
...
BattleScript_WeaknessPolicy:
	playanimation BANK_TARGET ANIM_ITEM_USE 0x0
	setword BATTLE_STRING_LOADER gText_WeaknessPolicy
	printstring 0x184
...
BattleScript_RockyHelmetDamage:
	...
	setword BATTLE_STRING_LOADER gText_RockyHelmet
	printstring 0x184
	waitmessage DELAY_1SECOND
...
BattleScript_BlackSludgeHurt:
	...
	graphicalhpupdate BANK_SCRIPTING
	datahpupdate BANK_SCRIPTING
	setword BATTLE_STRING_LOADER gText_BlackSludgeHurt
	printstring 0x184
	waitmessage DELAY_1SECOND
...
BattleScript_MicleBerryRet:
	call BattleScript_TryPrintRipenAbilityPopUp
	playanimation BANK_SCRIPTING ANIM_BERRY_EAT 0x0
	setword BATTLE_STRING_LOADER gText_MicleBerry
	printstring 0x184
	waitmessage DELAY_1SECOND
	call BattleScript_CheekPouch
	return
...
BattleScript_StickyBarbTransfer:
	...
	setword BATTLE_STRING_LOADER gText_StickyBarb
	printstring 0x184
	waitmessage DELAY_1SECOND
	removeitem BANK_SCRIPTING
	return
...
BattleScript_EjectButton:
	...
	setword BATTLE_STRING_LOADER gText_EjectButton
	printstring 0x184
	waitmessage DELAY_1SECOND
...
BattleScript_RedCard:
	...
	playanimation BANK_SCRIPTING ANIM_ITEM_USE 0x0
	setword BATTLE_STRING_LOADER gText_RedCard
	printstring 0x184
	waitmessage DELAY_1SECOND
...
RedCard_Ingrain:
	setword BATTLE_STRING_LOADER gText_RedCardIngrain
	printstring 0x184
	waitmessage DELAY_1SECOND
	goto RedCardEnd

RedCard_SuctionCups:
	setword BATTLE_STRING_LOADER gText_RedCardSuctionCups
	printstring 0x184
	waitmessage DELAY_1SECOND
	goto RedCardEnd
...
BattleScript_Gems:
	...
	setword BATTLE_STRING_LOADER gText_Gem
	printstring 0x184
	waitmessage DELAY_1SECOND
...
BattleScript_WeaknessBerryActivate:
	...
	call BattleScript_TryPrintRipenAbilityPopUp
	playanimation BANK_SCRIPTING ANIM_BERRY_EAT 0x0
	setword BATTLE_STRING_LOADER gText_WeaknessBerry
	printstring 0x184
