...
.global BattleScript_Blaze
.global BattleScript_GulpMissile
...
EmergencyExitSwitchBS:
	...
	callasm SetNoMoreMovingThisTurnSwitchingBank @;New Pokemon cant attack after being switched in
...
BattleScript_Blaze:
	call BattleScript_AbilityPopUp
	setword BATTLE_STRING_LOADER BlazeString
	printstring 0x184
	waitmessage DELAY_1SECOND
	call BattleScript_AbilityPopUpRevert
	return
...
BattleScript_RoughSkinActivates:
	...
	jumpifability BANK_TARGET ABILITY_AFTERMATH AftermathSpeedDrop
	call RoughSkinEnd
	return
...
AftermathSpeedDrop:
	...
	statbuffchange STAT_ATTACKER | STAT_BS_PTR RoughSkinEnd
	jumpifbyte EQUALS MULTISTRING_CHOOSER 0x2 RoughSkinEnd
	printfromtable 0x83FE588
	goto RoughSkinEnd
...
BlazeString: .byte 0xC7, 0xE3, 0xEA, 0xD9, 0xE7, 0x00, 0xE3, 0xDA, 0x00, 0xE8, 0xDC, 0xD9, 0x00, 0xE8, 0xED, 0xE4, 0xD9, 0x00, 0xD6, 0xD9, 0xD7, 0xD5, 0xE1, 0xD9, 0xFE, 0xE1, 0xE3, 0xE6, 0xD9, 0x00, 0xE4, 0xE3, 0xEB, 0xD9, 0xE6, 0xDA, 0xE9, 0xE0, 0xAB, 0xFF
