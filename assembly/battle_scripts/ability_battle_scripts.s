...
.global gText_MimikyuDisguisedTookDamageString
...
BS_IntimidateActivatesLoop:
	callasm GuardDogInitialFunc
	jumpifability BANK_ATTACKER ABILITY_TERRORIZE BS_TerrorizeActivatesLoop
	jumpifbyte EQUALS FORM_COUNTER 0x1 BS_GuardDogStatSwitchIntimidate
	setstatchanger STAT_ATK | DECREASE_1
	goto BS_IntimidateMain

BS_TerrorizeActivatesLoop:
	jumpifbyte EQUALS FORM_COUNTER 0x1 BS_GuardDogStatSwitchTerrorize
	setstatchanger STAT_SPD | DECREASE_1
	goto BS_IntimidateMain

BS_GuardDogStatSwitchIntimidate:
	setstatchanger STAT_ATK | INCREASE_1
	goto BS_IntimidateMain

BS_GuardDogStatSwitchTerrorize:
...
BS_IntimidateMain:
	...
	jumpifbyte EQUALS FORM_COUNTER 0x1 BS_GuardDogString
...
BS_GuardDogString:
	...
	setword BATTLE_STRING_LOADER gText_AttackRoseCauseOfGuardDog
	printstring 0x184
	waitmessage DELAY_1SECOND
	goto BS_IntimidateRest
...
BattleScript_AdrenalineOrbCall:
	...
	setgraphicalstatchangevalues
	playanimation BANK_TARGET ANIM_STAT_BUFF ANIM_ARG_1
	setword BATTLE_STRING_LOADER gText_AdrenalineOrbString
	printstring 0x184
	waitmessage DELAY_1SECOND
...
BattleScript_WonderGuardDamage:
	...
	graphicalhpupdate BANK_SCRIPTING
	datahpupdate BANK_SCRIPTING
	setword BATTLE_STRING_LOADER gText_HurtByAbilityString
	printstring 0x184
	waitmessage DELAY_1SECOND
	call BattleScript_AbilityPopUpRevert
...
BattleScript_BadDreams_Hurt:
	...
	setword BATTLE_STRING_LOADER gText_BadDreamsHurtString
	printstring 0x184
	waitmessage DELAY_1SECOND
...
BattleScript_Harvest:
	...
	call BattleScript_AbilityPopUp
	setword BATTLE_STRING_LOADER gText_HarvestString
	printstring 0x184
	waitmessage DELAY_1SECOND
	call BattleScript_AbilityPopUpRevert
...
BattleScript_Pickup:
	call BattleScript_AbilityPopUp
	setword BATTLE_STRING_LOADER gText_PickupString
	printstring 0x184
	waitmessage DELAY_1SECOND
	call BattleScript_AbilityPopUpRevert
	end3
...
BattleScript_AttackerCantUseMove:
	...
	pause DELAY_HALFSECOND
	call BattleScript_AbilityPopUp
	setword BATTLE_STRING_LOADER gText_CantUseMove
	printstring 0x184
	waitmessage DELAY_1SECOND
	call BattleScript_AbilityPopUpRevert
...
.global gText_DestinyKnotString
...
BattleScript_MummyActivates:
	...
	call BattleScript_AbilityPopUp
	setword BATTLE_STRING_LOADER gText_MummyString
	printstring 0x184
	waitmessage DELAY_1SECOND
	call BattleScript_AbilityPopUpRevert
	return
...
BattleScript_AngerPointActivates:
	...
	setgraphicalstatchangevalues
	playanimation BANK_TARGET ANIM_STAT_BUFF ANIM_ARG_1
	setword BATTLE_STRING_LOADER gText_AngerPointString
	printstring 0x184
	waitmessage DELAY_1SECOND
	call BattleScript_AbilityPopUpRevert
	return
...
SynchronizeNoEffect:
	setword BATTLE_STRING_LOADER gText_SynchronizeNoEffectString
	printstring 0x184
	waitmessage DELAY_1SECOND
...
BattleScript_DisguiseTookDamage:
	call BattleScript_AbilityPopUp
	setword BATTLE_STRING_LOADER gText_MimikyuDisguisedTookDamageString
	printstring 0x184
	waitmessage DELAY_1SECOND
	call BattleScript_AbilityPopUpRevert
	return
...
BattleScript_DisguiseTransform:
	...
	setword BATTLE_STRING_LOADER gText_DisguiseBustedString
	printstring 0x184
	waitmessage DELAY_1SECOND
	return
...
BattleScript_Receiver:
	...
	call BattleScript_AbilityPopUpRevert
	call BattleScript_AbilityPopUp
	setword BATTLE_STRING_LOADER gText_ReceiverString
	printstring 0x184
	waitmessage DELAY_1SECOND
	call BattleScript_AbilityPopUpRevert
	clearspecialstatusbit BANK_SCRIPTING STATUS3_SWITCH_IN_ABILITY_DONE
...
BattleScript_SoulHeart:
	call BattleScript_AbilityPopUp
	playanimation BANK_SCRIPTING ANIM_STAT_BUFF ANIM_ARG_1
	setword BATTLE_STRING_LOADER gText_AbilityRaisedStatString
	printstring 0x184
	waitmessage DELAY_1SECOND
	call BattleScript_AbilityPopUpRevert
	return
...
BattleScript_ToxicDebris:
	setspikes ToxicDebris_Return
	call BattleScript_AbilityPopUp
	playanimation BANK_ATTACKER ANIM_TSPIKES_TOXIC_DEBRIS 0x0
	copybyte USER_BANK TARGET_BANK
	printstring 0x184
	waitmessage DELAY_1SECOND
	call BattleScript_AbilityPopUpRevert
	jumpiffainted BANK_ATTACKER ToxicDebris_Return
