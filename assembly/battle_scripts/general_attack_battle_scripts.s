...
.global gText_GuardSwap
.global gText_SpeedSwap
.global gText_PowerTrick
.global gText_PowerSwap
.global gText_HeartSwap
.global gText_PowerSplit
.global gText_GuardSplit
.global gText_PowerHerb
.global gText_CantUseHyperspaceFury
...
ProtectedByTerrainBS:
	pause DELAY_HALFSECOND
	setword BATTLE_STRING_LOADER gText_ProtectedByTerrain
	printstring 0x184
	waitmessage DELAY_1SECOND
	goto BS_MOVE_END
...
BattleScript_AbsorbLiquidOoze:
	...
	printfromtable 0x83FE5DC @;gText_gLeechSeedDrainIds
	waitmessage DELAY_1SECOND
	call BattleScript_AbilityPopUpRevert
...
BattleScript_CantRaiseMultipleStats:
	pause DELAY_HALFSECOND
	orbyte OUTCOME OUTCOME_FAILED
	jumpifability BANK_ATTACKER ABILITY_CONTRARY gText_BattleScript_CantLowerMultipleStatsPrint
gText_BattleScript_CantRaiseMultipleStatsPrint:
...
BattleScript_CantLowerMultipleStats:
	pause DELAY_HALFSECOND
	orbyte OUTCOME OUTCOME_FAILED
	jumpifability BANK_TARGET ABILITY_CONTRARY gText_BattleScript_CantRaiseMultipleStatsPrint
gText_BattleScript_CantLowerMultipleStatsPrint:
...
ReflectTypeBS:
	...
	attackanimation
	waitanimation
	setword BATTLE_STRING_LOADER gText_ReflectType
	printstring 0x184
	waitmessage DELAY_1SECOND
	goto BS_MOVE_END
...
BattleScript_NoHealPartnerAfterHealBlock_JungleHealing:
	pause DELAY_HALFSECOND
	setword BATTLE_STRING_LOADER gText_HealBlockTarget
	printstring 0x184
	waitmessage DELAY_1SECOND
	goto JungleHealingTryClearPartnerStatusBS
...
BS_037_SetRest:
	...
	setrest 0x0
	pause DELAY_HALFSECOND
	printfromtable 0x83FE562 @;gText_gRestUsedIds
	waitmessage DELAY_1SECOND
	refreshhpbar BANK_ATTACKER
	waitstateatk
...
AutotomizeBS:
	...
	setword BATTLE_STRING_LOADER gText_BecameNimble
	printstring 0x184
	waitmessage DELAY_1SECOND
	goto BS_MOVE_END
...
SpicyExtractBS:
	...
	setbyte ANIM_TARGETS_HIT 0x1
	setbyte STAT_ANIM_PLAYED 0x0
	jumpifstat BANK_TARGET EQUALS STAT_DEF STAT_MIN SpicyExtract_BoostAtk
...
SpicyExtract_DropDef:
	...
	setstatchanger STAT_DEF | DECREASE_2
	statbuffchange STAT_TARGET | STAT_BS_PTR | STAT_CERTAIN SpicyExtract_BoostAtk
	jumpifbyte EQUALS MULTISTRING_CHOOSER 0x2 SpicyExtract_BoostAtk
	printfromtable gStatUpStringIds
	waitmessage DELAY_1SECOND

SpicyExtract_BoostAtk:
	playstatchangeanimation BANK_TARGET, STAT_ANIM_ATK, STAT_ANIM_UP | STAT_ANIM_IGNORE_ABILITIES
	setstatchanger STAT_ATK | INCREASE_2
...
BattleScript_FirstChargingTurn:
	attackcanceler
	printstring 0x130 @;gText_Blank 
	ppreduce
	attackanimation
	waitanimation
	jumpifmove MOVE_FREEZESHOCK gText_PrintFreezeShock
	jumpifmove MOVE_ICEBURN gText_PrintIceBurn
	jumpifmove MOVE_SHADOWFORCE gText_PrintShadowForce
	jumpifmove MOVE_PHANTOMFORCE gText_PrintShadowForce
	jumpifmove MOVE_METEORBEAM gText_PrintMeteorBeam
	jumpifmove MOVE_ELECTROSHOT gText_PrintElectroShot
	copyarray MULTISTRING_CHOOSER TWOTURN_STRINGID 0x1
	printfromtable 0x83FE590
	return

gText_PrintFreezeShock:
	setword BATTLE_STRING_LOADER gText_FreezeShockCharging
	printstring 0x184
	waitmessage DELAY_1SECOND
	return

gText_PrintIceBurn:
	setword BATTLE_STRING_LOADER gText_IceBurnCharging
	printstring 0x184
	waitmessage DELAY_1SECOND
	return
	
gText_PrintShadowForce:
	setword BATTLE_STRING_LOADER gText_ShadowForce
	printstring 0x184
	waitmessage DELAY_1SECOND
	return

gText_PrintMeteorBeam:
	setword BATTLE_STRING_LOADER gText_MeteorBeamCharge
	printstring 0x184
	waitmessage DELAY_1SECOND
	return

gText_PrintElectroShot:
...
BS_076_SetConfusionChance:
	jumpifmove MOVE_ALLURINGVOICE BS_AlluringVoice
	setmoveeffect MOVE_EFFECT_CONFUSION
	goto BS_STANDARD_HIT
...
@code from CFRU-expansion
ShedTailBS:
	attackcanceler
	ppreduce
	attackstring
	callasm FailMoveIfBelowHalfHP
	waitstateatk
	jumpifcannotswitch BANK_ATTACKER | ATK4F_DONT_CHECK_STATUSES FAILED_PRE
	jumpifbehindsubstitute BANK_ATTACKER 0x81D7321
	setsubstituteeffect
	jumpifbyte NOTEQUALS MULTISTRING_CHOOSER 0x1 ShedTail_SubstituteAnim
	pause DELAY_HALFSECOND
	goto ShedTail_SubstituteStringFail

ShedTail_SubstituteAnim:
    playanimation BANK_TARGET ANIM_SUBSTITUTE2 0x0
    waitanimation
	setdamagetobankhealthfraction BANK_ATTACKER 2 0x0
    graphicalhpupdate BANK_ATTACKER
    datahpupdate BANK_ATTACKER

ShedTail_SubstituteString:
	setword BATTLE_STRING_LOADER 0x83FBE8B
	printstring 0x184
	waitmessage DELAY_1SECOND

ShedTail_SwitchingOut:
	attackanimation
	waitanimation
	...
	callasm ClearTargetStatFellThisTurn
	...
	waitanimation
	callasm EnsureSubstituteOnSwitchInAfterShedTail
	goto BS_MOVE_END

ShedTail_SubstituteStringFail:
    setword BATTLE_STRING_LOADER 0x83FCE08
	printstring 0x184
	waitmessage DELAY_1SECOND
    goto BS_MOVE_END
...
LaserFocusBS:
	...
	attackanimation
	waitanimation
	setword BATTLE_STRING_LOADER gText_LaserFocus
	printstring 0x184
	waitmessage DELAY_1SECOND
	goto BS_MOVE_END
...
AttractDestinyKnot:
	...
	setword BATTLE_STRING_LOADER gText_DestinyKnot
	printstring 0x184
	waitmessage DELAY_1SECOND
	goto BS_MOVE_END
...
DoBurnUp:
	...
	callasm BurnUpFunc
	setword BATTLE_STRING_LOADER gText_BurnUp
	printstring 0x184
	waitmessage DELAY_1SECOND
...
DoDoubleShock:
	...
	setword BATTLE_STRING_LOADER gText_DoubleShock
	printstring 0x184
	waitmessage DELAY_1SECOND
	goto BurnUpEnd
...
UTurnSwitchBS:
	copybyte BATTLE_SCRIPTING_BANK USER_BANK
	setword BATTLE_STRING_LOADER gText_UTurn
	printstring 0x184
	waitmessage DELAY_1SECOND
...
RemoveFogBS:
	...
	setword BATTLE_STRING_LOADER gText_RemoveFog
	printstring 0x184
	waitmessage DELAY_1SECOND
	breakfree
	goto BS_MOVE_END
...
PlaySpectBoost:
	...
	callasm ToggleSpectralThiefByte
	setword BATTLE_STRING_LOADER gText_SpectralThief
	printstring 0x184
	waitmessage DELAY_1SECOND
	setbyte ANIM_TURN 0x1
	callasm ClearCalculatedSpreadMoveData @;So the damage can be calculated
...
StockpileWearOff:
	...
	setword BATTLE_STRING_LOADER gText_StockpileWoreOff
	printstring 0x184
	waitmessage DELAY_1SECOND
	goto BS_MOVE_END
...
BS_DragonCheer:
	...
	attackanimation
	waitanimation
	setword BATTLE_STRING_LOADER gText_DragonCheer
	printstring 0x184
	waitmessage DELAY_1SECOND
	goto BS_MOVE_END
...
TrickBS:
	...
	waitmessage DELAY_1SECOND
	printfromtable 0x83FE64A @;gText_gItemSwapIds
	waitmessage DELAY_1SECOND
...
BestowBS:
	...
	attackanimation
	waitanimation
	setword BATTLE_STRING_LOADER gText_Bestow
	printstring 0x184
	waitmessage DELAY_1SECOND
	call 0x81D92DC @;BattleScript_WeatherFormChanges - In case of Utility Umbrella
	goto BS_MOVE_END
...
AquaRingBS:
	...
	attackanimation
	waitanimation
	setword BATTLE_STRING_LOADER gText_AquaRingSet
	printstring 0x184
	waitmessage DELAY_1SECOND
...
PsychoShiftBS:
	...
	seteffectprimary
	refreshhpbar BANK_ATTACKER
	setword BATTLE_STRING_LOADER gText_PsychoShift
	printstring 0x184
	waitmessage DELAY_1SECOND
	goto BS_MOVE_END
...
BS_210_WaterSport:
	...
	attackanimation
	waitanimation
	printfromtable 0x83FE5E0 @;gText_gSportsUsedIds
	waitmessage DELAY_1SECOND
	goto BS_MOVE_END
...
Geomancy_Charge:	
	...
	setmoveeffect MOVE_EFFECT_CHARGING | MOVE_EFFECT_AFFECTS_USER
	seteffectprimary
	setword BATTLE_STRING_LOADER gText_GeomancyCharge
	printstring 0x184
	waitmessage DELAY_1SECOND
	goto BS_MOVE_END
...
TidyUpBS:
	...
	attackstring
	ppreduce
	goto TidyUp_RaiseStats
	
.global BattleScript_TidyUpRemoveHazards
BattleScript_TidyUpRemoveHazards:
	breakfree
	callasm TidyUpRemoveSubstitutes
	goto BS_MOVE_END

TidyUp_RaiseStats:
	jumpifstat BANK_ATTACKER LESSTHAN STAT_ATK STAT_MAX TidyUp_Atk
	jumpifstat BANK_ATTACKER EQUALS STAT_SPD STAT_MAX BattleScript_CantRaiseMultipleStats
...
TidyUp_Atk:
	...
	playstatchangeanimation BANK_ATTACKER, STAT_ANIM_ATK | STAT_ANIM_SPD, STAT_ANIM_UP | STAT_ANIM_IGNORE_ABILITIES
	setstatchanger STAT_ATK | INCREASE_1
	statbuffchange STAT_ATTACKER | STAT_BS_PTR | STAT_CERTAIN TidyUp_Speed
	jumpifbyte EQUALS MULTISTRING_CHOOSER 0x2 TidyUp_Speed
	printfromtable gStatUpStringIds
	waitmessage DELAY_1SECOND
...
TidyUp_Speed:
	...
	printfromtable gStatUpStringIds
	waitmessage DELAY_1SECOND
	goto BattleScript_TidyUpRemoveHazards
...
FilletAwayBS:
	callasm FailMoveIfBelowHalfHP
	jumpifstat BANK_ATTACKER LESSTHAN STAT_ATK STAT_MAX FilletAway_SharpAtk
	jumpifstat BANK_ATTACKER LESSTHAN STAT_SPATK STAT_MAX FilletAway_SharpAtk
	jumpifstat BANK_ATTACKER EQUALS STAT_SPD STAT_MAX BattleScript_CantRaiseMultipleStats
...
FilletAway_SharpSpAtk:
	setstatchanger STAT_SPATK | INCREASE_2
	statbuffchange STAT_ATTACKER | STAT_BS_PTR | STAT_CERTAIN FilletAway_SharpSpeed
	jumpifbyte EQUALS MULTISTRING_CHOOSER 0x2 FilletAway_SharpSpeed
	printfromtable gStatUpStringIds
	waitmessage DELAY_1SECOND
	goto FilletAway_SharpSpeed

FilletAway_SharpSpeed:
	setstatchanger STAT_SPD | INCREASE_2
	statbuffchange STAT_ATTACKER | STAT_BS_PTR | STAT_CERTAIN FilletAway_CutHP
	jumpifbyte EQUALS MULTISTRING_CHOOSER 0x2 FilletAway_CutHP
	printfromtable gStatUpStringIds
	waitmessage DELAY_1SECOND
	goto FilletAway_CutHP

FilletAway_CutHP:
	orword HIT_MARKER HITMARKER_IGNORE_SUBSTITUTE | HITMARKER_NON_ATTACK_DMG
	setdamagetobankhealthfraction BANK_ATTACKER 2 0x0 @1/2 of Base Max HP
	graphicalhpupdate BANK_ATTACKER
	datahpupdate BANK_ATTACKER
	faintpokemon BANK_ATTACKER 0x0 0x0
	goto BS_MOVE_END
...
.global BS_224_GlaiveRush
BS_224_GlaiveRush:
	attackcanceler
	accuracycheck BS_MOVE_MISSED 0x0
	call STANDARD_DAMAGE
	callasm SetGlaiveRushTimer
	seteffectwithchancetarget
	prefaintmoveendeffects 0x0
	faintpokemonaftermove
	goto BS_MOVE_END
...
.global BS_225_RevivalBlessing
BS_225_RevivalBlessing: @effect to do
	goto BS_MOVE_MISSED
...
.global gText_Swamp
.global gText_SeaOfFire
.global gText_Rainbow
BS_227_Pledges:
	attackcanceler
...
BattleScript_PledgeReady:
	...
	ppreduce
	pause DELAY_HALFSECOND
	setword BATTLE_STRING_LOADER gText_PledgeReady
	printstring 0x184
	waitmessage DELAY_1SECOND
	goto BS_MOVE_END
	
BattleScript_PledgeCombined:
	setword BATTLE_STRING_LOADER gText_PledgeCombined
	printstring 0x184
	waitmessage DELAY_1SECOND
...
BS_229_Fling:
	...
	callasm TryFling
	pause DELAY_HALFSECOND
	setword BATTLE_STRING_LOADER gText_Fling
	printstring 0x184
...
FeintSkipBS:
	...
	setword BATTLE_STRING_LOADER gText_ProtectLifted
	printstring 0x184
	waitmessage DELAY_1SECOND
	goto BS_MOVE_FAINT	
...
HealBlockBS:
	...
	setword BATTLE_STRING_LOADER gText_HealBlockSet
	printstring 0x184
	waitmessage DELAY_1SECOND
	goto BS_MOVE_END
...
EmbargoBS:
	...
	setword BATTLE_STRING_LOADER gText_EmbargoSet
	printstring 0x184
	waitmessage DELAY_1SECOND
	goto BS_MOVE_END
...
PowderBS:
	...
	setword BATTLE_STRING_LOADER gText_PowderSet
	printstring 0x184
	waitmessage DELAY_1SECOND
	goto BS_MOVE_END
...
TelekinesisBS:
	...
	setword BATTLE_STRING_LOADER gText_TelekinesisSet
	printstring 0x184
	waitmessage DELAY_1SECOND
	goto BS_MOVE_END
...
BS_234_TopsyTurvyElectrify:
	...
	attackanimation
	waitanimation
	setword BATTLE_STRING_LOADER gText_TopsyTurvy
	printstring 0x184
	waitmessage DELAY_1SECOND
	goto BS_MOVE_END
...
ElectrifyBS:
	...
	attackanimation
	waitanimation
	setword BATTLE_STRING_LOADER gText_Electrify
	printstring 0x184
	waitmessage DELAY_1SECOND
	goto BS_MOVE_END
...
AfterYouBS:
	...
	attackanimation
	waitanimation
	setword BATTLE_STRING_LOADER gText_AfterYou
	printstring 0x184
	waitmessage DELAY_1SECOND
	goto BS_MOVE_END
...
QuashBS:
	...
	attackanimation
	waitanimation
	setword BATTLE_STRING_LOADER gText_Quash
	printstring 0x184
	waitmessage DELAY_1SECOND
	goto BS_MOVE_END
...
BS_241_FlameBurst:
	...
	setword BATTLE_STRING_LOADER gText_FlameBurst
	printstring 0x184
	waitmessage DELAY_1SECOND
...
BS_246_SkyDrop:
	...
	setsemiinvulnerablebit
	setword BATTLE_STRING_LOADER gText_SkyDropUp
	printstring 0x184
	waitmessage DELAY_1SECOND
	orword HIT_MARKER HITMARKER_CHARGING
	setmoveeffect MOVE_EFFECT_CHARGING | MOVE_EFFECT_AFFECTS_USER
...
SkyDropDropTurn2:
	...
	copyarray BATTLE_SCRIPTING_BANK TARGET_BANK 0x1
	setword BATTLE_STRING_LOADER gText_FreedFromSkyDrop
	printstring 0x184
	waitmessage DELAY_1SECOND
	goto BS_HIT_FROM_DAMAGE_CALC
...
.global BS_247_Comeuppance
BS_247_Comeuppance:
	attackcanceler
	comeuppancedamagecalculator FAILED_PRE
	accuracycheck BS_MOVE_MISSED 0x0
	attackstring
	ppreduce
	typecalc2
...
.global BS_248_SetSleepChance
BS_248_SetSleepChance:
	setmoveeffect MOVE_EFFECT_SLEEP
	goto BS_STANDARD_HIT
	
@;@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

.global BS_249_FickleBeam
BS_249_FickleBeam:
	callasm FickleBeamHelperFunc
	goto BS_STANDARD_HIT

.global BattleScript_FickleBeamAllOut
BattleScript_FickleBeamAllOut:
	attackcanceler
	accuracycheck BS_MOVE_MISSED 0x0
	attackstring
	ppreduce
	waitmessage DELAY_1SECOND
	setword BATTLE_STRING_LOADER gText_FickleBeamAllOut
	printstring 0x184
	waitmessage DELAY_HALFSECOND
	goto BS_HIT_FROM_DAMAGE_CALC
