...
.global gText_MagicRoomEnd
.global gText_GravityEnd
.global gText_TerrainEnd
.global gText_Transformed

.global gText_AbilityActivated
...
BattleScript_FogEnded:
	setword BATTLE_STRING_LOADER gText_FogEnded
	printstring 0x184
	waitmessage DELAY_1SECOND
	end2
...
BattleScript_FogContinues:
	setword BATTLE_STRING_LOADER gText_FogContinues
	printstring 0x184
	waitmessage DELAY_1SECOND
...
BattleScript_GrassyTerrainHeal:
	...
	graphicalhpupdate BANK_ATTACKER
	datahpupdate BANK_ATTACKER
	setword BATTLE_STRING_LOADER gText_GrassyTerrainHeal
	printstring 0x184
	waitmessage DELAY_1SECOND
	end2
...
BattleScript_AquaRing:
	...
	graphicalhpupdate BANK_ATTACKER
	datahpupdate BANK_ATTACKER
	setword BATTLE_STRING_LOADER gText_AquaRingHeal
	printstring 0x184
	waitmessage DELAY_1SECOND
	end2
...
BattleScript_MagnetRiseEnd:
	...
	setword BATTLE_STRING_LOADER gText_MagnetRiseEnd
	printstring 0x184
	waitmessage DELAY_1SECOND
    end2
...
BattleScript_TelekinesisEnd:
	...
	setword BATTLE_STRING_LOADER gText_TelekinesisStringEnd
	printstring 0x184
	waitmessage DELAY_1SECOND
    end2
...
BattleScript_HealBlockEnd:
	setword BATTLE_STRING_LOADER gText_HealBlockEnd
	printstring 0x184
	waitmessage DELAY_1SECOND
	end2
...
BattleScript_EmbargoEnd:
	setword BATTLE_STRING_LOADER gText_EmbargoEnd
	printstring 0x184
	waitmessage DELAY_1SECOND
	end2
...
BattleScript_TrickRoomEnd:
	setword BATTLE_STRING_LOADER gText_TrickRoomEnd
	goto PrintTimerString


BattleScript_WaterSportEnd:
	setword BATTLE_STRING_LOADER gText_WaterSportEnd
	goto PrintTimerString


BattleScript_MudSportEnd:
	setword BATTLE_STRING_LOADER gText_MudSportEnd
	goto PrintTimerString


BattleScript_WonderRoomEnd:
	setword BATTLE_STRING_LOADER gText_WonderRoomEnd
	goto PrintTimerString


BattleScript_MagicRoomEnd:
	setword BATTLE_STRING_LOADER gText_MagicRoomEnd
	goto PrintTimerString


BattleScript_GravityEnd:
	setword BATTLE_STRING_LOADER gText_GravityEnd
	printstring 0x184
	waitmessage DELAY_1SECOND
...
BattleScript_TerrainEnd:
	...
	setword BATTLE_STRING_LOADER gText_TerrainEnd
	printstring 0x184
	waitmessage DELAY_1SECOND
...
BattleScript_ToxicOrb:
	...
	statusanimation BANK_EFFECT
	setword BATTLE_STRING_LOADER gText_ToxicOrb
	goto ToxicOrbRest
	end
...
BattleScript_PowerConstruct:
	setword BATTLE_STRING_LOADER gText_PresenceOfMany
	printstring 0x184
	waitmessage DELAY_HALFSECOND
	call BattleScript_AbilityPopUp
	...
	setword BATTLE_STRING_LOADER gText_PowerConstructComplete
	printstring 0x184
	waitmessage DELAY_1SECOND
	end2
...
BattleScript_ShieldsDownToCoreRet:
	...
	setword BATTLE_STRING_LOADER gText_ToCore
	printstring 0x184
	waitmessage DELAY_1SECOND
	call BattleScript_AbilityPopUpRevert
	return
...
BattleScript_ShieldsDownToMeteorRet:
	call BattleScript_AbilityPopUp
	playanimation BANK_SCRIPTING ANIM_TRANSFORM 0x0
	setword BATTLE_STRING_LOADER gText_ToMeteor
	printstring 0x184
	waitmessage DELAY_1SECOND
	call BattleScript_AbilityPopUpRevert
	return
