...
extern const u8 BG_Shadow_TerrainTiles[];
extern const u8 BG_Shadow_TerrainMap[];
extern const u8 BG_Shadow_TerrainPal[];
extern const u8 BG_Draco_TerrainTiles[];
extern const u8 BG_Draco_TerrainMap[];
extern const u8 BG_Draco_TerrainPal[];
...
const struct TerrainTableStruct gTerrainTable[] =
{
	...
	[SHADOW_TERRAIN - 1] =
		{
			...
			.secretPowerEffect = MOVE_EFFECT_EVS_PLUS_1,
	...
	[BATTLE_TERRAIN_GRASS + TERRAIN_COUNT] =
		{
			.camouflageType = TYPE_GRASS,
			.secretPowerEffect = MOVE_EFFECT_SLEEP,
			.secretPowerAnim = MOVE_VINEWHIP,
	...
	[BATTLE_TERRAIN_LONG_GRASS + TERRAIN_COUNT] =
		{
			.camouflageType = TYPE_GRASS,
			.secretPowerEffect = MOVE_EFFECT_SLEEP,
			.secretPowerAnim = MOVE_VINEWHIP,
	...
	[BATTLE_TERRAIN_SAND + TERRAIN_COUNT] =
		{
	...
	[BATTLE_TERRAIN_UNDERWATER + TERRAIN_COUNT] =
		{
	...
	[BATTLE_TERRAIN_WATER + TERRAIN_COUNT] =
		{
			.camouflageType = TYPE_WATER,
			.secretPowerEffect = MOVE_EFFECT_ATK_MINUS_1,
			.secretPowerAnim = MOVE_WATERPULSE,
	...
	[BATTLE_TERRAIN_POND + TERRAIN_COUNT] =
		{
			.camouflageType = TYPE_WATER,
			.secretPowerEffect = MOVE_EFFECT_ATK_MINUS_1,
			.secretPowerAnim = MOVE_WATERPULSE,
	...
	[BATTLE_TERRAIN_MOUNTAIN + TERRAIN_COUNT] =
		{
			.camouflageType = TYPE_GROUND,
			.secretPowerEffect = MOVE_EFFECT_ACC_MINUS_1,
			.secretPowerAnim = MOVE_MUDSLAP,
	...
	[BATTLE_TERRAIN_CAVE + TERRAIN_COUNT] =
		{
	...
	[BATTLE_TERRAIN_INSIDE + TERRAIN_COUNT] =
		{
	...
	[BATTLE_TERRAIN_PLAIN + TERRAIN_COUNT] =
		{
			.camouflageType = TYPE_NORMAL,
			.secretPowerEffect = MOVE_EFFECT_PARALYSIS,
	...
	[BATTLE_TERRAIN_INSIDE_2 + TERRAIN_COUNT] =
		{
			.camouflageType = TYPE_NORMAL,
			.secretPowerEffect = MOVE_EFFECT_PARALYSIS,
			.secretPowerAnim = MOVE_BODYSLAM,
	...
	[BATTLE_TERRAIN_INSIDE_3 + TERRAIN_COUNT] =
		{
			.camouflageType = TYPE_NORMAL,
			.secretPowerEffect = MOVE_EFFECT_PARALYSIS,
			.secretPowerAnim = MOVE_BODYSLAM,
	...
	[BATTLE_TERRAIN_INSIDE_4 + TERRAIN_COUNT] =
		{
			.camouflageType = TYPE_NORMAL,
			.secretPowerEffect = MOVE_EFFECT_PARALYSIS,
			.secretPowerAnim = MOVE_BODYSLAM,
	...
	[BATTLE_TERRAIN_INSIDE_5 + TERRAIN_COUNT] =
		{
			.camouflageType = TYPE_NORMAL,
			.secretPowerEffect = MOVE_EFFECT_PARALYSIS,
			.secretPowerAnim = MOVE_BODYSLAM,
	...
	[BATTLE_TERRAIN_INSIDE_6 + TERRAIN_COUNT] =
		{
			.camouflageType = TYPE_NORMAL,
			.secretPowerEffect = MOVE_EFFECT_PARALYSIS,
			.secretPowerAnim = MOVE_BODYSLAM,
...
#ifndef UNBOUND
	[BATTLE_TERRAIN_LORLEI + TERRAIN_COUNT] =
		{
	...
	[BATTLE_TERRAIN_BRUNO + TERRAIN_COUNT] =
		{
	...
	[BATTLE_TERRAIN_AGATHA + TERRAIN_COUNT] =
		{
			.camouflageType = TYPE_GHOST,
	...
	[BATTLE_TERRAIN_LANCE + TERRAIN_COUNT] =
		{
			.camouflageType = TYPE_DRAGON,
			.secretPowerEffect = MOVE_EFFECT_ATK_MINUS_1,
			.secretPowerAnim = MOVE_DRAGONRAGE,
	...
	[BATTLE_TERRAIN_CHAMPION + TERRAIN_COUNT] =
		{
			.camouflageType = TYPE_NORMAL,
			.secretPowerEffect = MOVE_EFFECT_PARALYSIS,
			.secretPowerAnim = MOVE_BODYSLAM,
...
const struct BattleBackground gAttackTerrainTable[] =
{
    ...
    {
    	.tileset = BG_Shadow_TerrainTiles,
        .tilemap = BG_Shadow_TerrainMap,
        .entryTileset = gBattleTerrainAnimTiles_Building,
        .entryTilemap = gBattleTerrainAnimTilemap_Building,
        .palette = BG_Shadow_TerrainPal,
    },

    {
    	.tileset = BG_Draco_TerrainTiles,
        .tilemap = BG_Draco_TerrainMap,
        .entryTileset = gBattleTerrainAnimTiles_Building,
        .entryTilemap = gBattleTerrainAnimTilemap_Building,
        .palette = BG_Draco_TerrainPal,
    },
};
