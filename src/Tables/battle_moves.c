...
const struct BattleMove gBattleMoves[] =
{
	...
	{ //ANIMATION TO DO
		...
		.target = MOVE_TARGET_SELECTED,
		.priority = 0,
		.flags = FLAG_PROTECT_AFFECTED | FLAG_TRIAGE_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED,
		.z_move_power = 175,
		.split = SPLIT_SPECIAL,
		.z_move_effect = 0
	},
	...
	[MOVE_GLITZYGLOW] =
	{ //ANIMATION TO DO
		.effect = EFFECT_DAMAGE_SET_SCREENS,
		.power = 90,
		.type = TYPE_PSYCHIC,
		.accuracy = 100,
		.pp = 15,
	...
	[MOVE_SAPPYSEED] =
	{ //ANIMATION TO DO
		.effect = EFFECT_DAMAGE_LEECH_SEED,
		.power = 90,
		.type = TYPE_GRASS,
		.accuracy = 100,
		.pp = 15,
	...
	[MOVE_SPARKLYSWIRL] =
	{ //ANIMATION TO DO
		.effect = EFFECT_DAMAGE_HEAL_BELL,
		.power = 90,
		.type = TYPE_FAIRY,
		.accuracy = 100,
		.pp = 5,
	...
	{ //ANIMATION TO DO
		...
		.target = MOVE_TARGET_SELECTED,
		.priority = 0,
		.flags = FLAG_MIRROR_MOVE_AFFECTED | FLAG_MAKES_CONTACT,
		.z_move_power = 175,
		.split = SPLIT_PHYSICAL,
		.z_move_effect = 0
	},
	...
	[MOVE_UPPERHAND] =
	{ //ANIMATION TO DO
		.effect = EFFECT_FAKE_OUT, //EFFECT TO DO
		.power = 65,
		.type = TYPE_FIGHTING,
		.accuracy = 100,
		.pp = 15,
