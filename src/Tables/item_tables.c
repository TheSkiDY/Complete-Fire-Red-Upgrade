...
const struct FlingStruct gFlingTable[ITEMS_COUNT] =
{
	...
	[ITEM_NATURE_PILL_HARDY] = {20, 0},
	[ITEM_NATURE_PILL_LONELY] = {20, 0},
	[ITEM_NATURE_PILL_BRAVE] = {20, 0},
	[ITEM_NATURE_PILL_ADAMANT] = {20, 0},
	[ITEM_NATURE_PILL_NAUGHTY] = {20, 0},
	[ITEM_NATURE_PILL_BOLD] = {20, 0},
	[ITEM_NATURE_PILL_DOCILE] = {20, 0},
	[ITEM_NATURE_PILL_RELAXED] = {20, 0},
	[ITEM_NATURE_PILL_IMPISH] = {20, 0},
	[ITEM_NATURE_PILL_LAX] = {20, 0},
	[ITEM_NATURE_PILL_TIMID] = {20, 0},
	[ITEM_NATURE_PILL_HASTY] = {20, 0},
	[ITEM_NATURE_PILL_SERIOUS] = {20, 0},
	[ITEM_NATURE_PILL_JOLLY] = {20, 0},
	[ITEM_NATURE_PILL_NAIVE] = {20, 0},
	[ITEM_NATURE_PILL_MODEST] = {20, 0},
	[ITEM_NATURE_PILL_MILD] = {20, 0},
	[ITEM_NATURE_PILL_QUIET] = {20, 0},
	[ITEM_NATURE_PILL_BASHFUL] = {20, 0},
	[ITEM_NATURE_PILL_RASH] = {20, 0},
	[ITEM_NATURE_PILL_CALM] = {20, 0},
	[ITEM_NATURE_PILL_GENTLE] = {20, 0},
	[ITEM_NATURE_PILL_SASSY] = {20, 0},
	[ITEM_NATURE_PILL_CAREFUL] = {20, 0},
	[ITEM_NATURE_PILL_QUIRKY] = {20, 0},
	[ITEM_ETHER] = {30, 0},
	[ITEM_ELIXIR] = {30, 0},
	[ITEM_MAX_ETHER] = {30, 0},
	...
	[ITEM_RELIC_MIRROR] = {60, 0},
	[ITEM_LEEK] = {60, 0},
	[ITEM_TERRAIN_EXTENDER] = {60, 0},
	[ITEM_ROOM_EXTENDER] = {60, 0},
	...
	[ITEM_AUDINITE] = {80, 0},
	[ITEM_DIANCITE] = {80, 0},
	[ITEM_ALAKAZITE_S] = {80, 0},
	[ITEM_LOPUNNITE_S] = {80, 0},
	[ITEM_LANTURNITE] = {80, 0},
	[ITEM_OCTILLERITE] = {80, 0},
	[ITEM_SMEARGLITE] = {80, 0},
	[ITEM_CHIMECHITE] = {80, 0},
	[ITEM_SWELLOWITE] = {80, 0},
	[ITEM_TALONFLITE] = {80, 0},
	[ITEM_CARBINKITE] = {80, 0},
	...
	[ITEM_PARALYZE_ORB] = {30, MOVE_EFFECT_PARALYSIS},
	[ITEM_SLEEP_ORB] = {30, MOVE_EFFECT_SLEEP},
...
const u16 gItemsByType[ITEMS_COUNT] =
{
	...
	[ITEM_NATURE_PILL_HARDY] = ITEM_TYPE_NATURE_PILL,
	[ITEM_NATURE_PILL_LONELY] = ITEM_TYPE_NATURE_PILL,
	[ITEM_NATURE_PILL_BRAVE] = ITEM_TYPE_NATURE_PILL,
	[ITEM_NATURE_PILL_ADAMANT] = ITEM_TYPE_NATURE_PILL,
	[ITEM_NATURE_PILL_NAUGHTY] = ITEM_TYPE_NATURE_PILL,
	[ITEM_NATURE_PILL_BOLD] = ITEM_TYPE_NATURE_PILL,
	[ITEM_NATURE_PILL_DOCILE] = ITEM_TYPE_NATURE_PILL,
	[ITEM_NATURE_PILL_RELAXED] = ITEM_TYPE_NATURE_PILL,
	[ITEM_NATURE_PILL_IMPISH] = ITEM_TYPE_NATURE_PILL,
	[ITEM_NATURE_PILL_LAX] = ITEM_TYPE_NATURE_PILL,
	[ITEM_NATURE_PILL_TIMID] = ITEM_TYPE_NATURE_PILL,
	[ITEM_NATURE_PILL_HASTY] = ITEM_TYPE_NATURE_PILL,
	[ITEM_NATURE_PILL_SERIOUS] = ITEM_TYPE_NATURE_PILL,
	[ITEM_NATURE_PILL_JOLLY] = ITEM_TYPE_NATURE_PILL,
	[ITEM_NATURE_PILL_NAIVE] = ITEM_TYPE_NATURE_PILL,
	[ITEM_NATURE_PILL_MODEST] = ITEM_TYPE_NATURE_PILL,
	[ITEM_NATURE_PILL_MILD] = ITEM_TYPE_NATURE_PILL,
	[ITEM_NATURE_PILL_QUIET] = ITEM_TYPE_NATURE_PILL,
	[ITEM_NATURE_PILL_BASHFUL] = ITEM_TYPE_NATURE_PILL,
	[ITEM_NATURE_PILL_RASH] = ITEM_TYPE_NATURE_PILL,
	[ITEM_NATURE_PILL_CALM] = ITEM_TYPE_NATURE_PILL,
	[ITEM_NATURE_PILL_GENTLE] = ITEM_TYPE_NATURE_PILL,
	[ITEM_NATURE_PILL_SASSY] = ITEM_TYPE_NATURE_PILL,
	[ITEM_NATURE_PILL_CAREFUL] = ITEM_TYPE_NATURE_PILL,
	[ITEM_NATURE_PILL_QUIRKY] = ITEM_TYPE_NATURE_PILL,
	...
	[ITEM_EMPATHY_ROCK] = ITEM_TYPE_EVOLUTION_STONE,
	...
	[ITEM_PUNCHING_GLOVES] = ITEM_TYPE_HELD_ITEM,
	[ITEM_MIRROR_HERB] = ITEM_TYPE_HELD_ITEM,

	[ITEM_PINK_BOW] = ITEM_TYPE_HELD_ITEM,
	[ITEM_ROOM_EXTENDER] = ITEM_TYPE_HELD_ITEM,
	[ITEM_RELIC_MIRROR] = ITEM_TYPE_HELD_ITEM,
	[ITEM_PARALYZE_ORB] = ITEM_TYPE_HELD_ITEM,
	[ITEM_SLEEP_ORB] = ITEM_TYPE_HELD_ITEM,
	...
	[ITEM_ALAKAZITE_S] = ITEM_TYPE_MEGA_STONE,
	[ITEM_LOPUNNITE_S] = ITEM_TYPE_MEGA_STONE,
	[ITEM_LANTURNITE] = ITEM_TYPE_MEGA_STONE,
	[ITEM_OCTILLERITE] = ITEM_TYPE_MEGA_STONE,
	[ITEM_SMEARGLITE] = ITEM_TYPE_MEGA_STONE,
	[ITEM_CHIMECHITE] = ITEM_TYPE_MEGA_STONE,
	[ITEM_SWELLOWITE] = ITEM_TYPE_MEGA_STONE,
	[ITEM_TALONFLITE] = ITEM_TYPE_MEGA_STONE,
	[ITEM_CARBINKITE] = ITEM_TYPE_MEGA_STONE,
	...
	[ITEM_CYAN_NECTAR] = ITEM_TYPE_NECTAR,
