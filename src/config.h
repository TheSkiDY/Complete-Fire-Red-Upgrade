...
#define NUM_MOVE_TUTORS 144 //keep this defined even if EXPANDED_MOVE_TUTORS is not!! If using DPE, set to 128.
#define LAST_TOTAL_TUTOR_NUM 152 //Should be equal to (NUM_MOVE_TUTORS - 1) + 9. Must be set to an actual integer or the compilation will not work.
...
#define BIKE_ENCOUNTER_PERCENT 40 //Biking through grass or in caves only has this percentage of the encounter rate (vanilla FR is 80)
...
#define FLAG_RANDOMIZER_LOAD_DEX_AREA 0x978
