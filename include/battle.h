...
#define BATTLE_TERRAIN_LINK       	    0xA
#define BATTLE_TERRAIN_GYM       	    0xB
#define BATTLE_TERRAIN_LEADER       	0xC
#define BATTLE_TERRAIN_INDOOR_2       	0xD
#define BATTLE_TERRAIN_INDOOR_1       	0xE
