...
extern const u8 BattleScript_FlashFireBurnSetup[];
extern const u8 BattleScript_SilkTrap[];
...
extern const u8 gText_ParalyzeOrb[];
extern const u8 gText_SleepOrb[];
extern const u8 gText_FrostOrb[];
