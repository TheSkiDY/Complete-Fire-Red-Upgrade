...
enum BallTypes
{
	...
	BALL_TYPE_SHINY_BALL,	//27
	BALL_TYPE_SOLAR_BALL, 	//28
	BALL_TYPE_FLOOD_BALL,	//29
	BALL_TYPE_HAIL_BALL,	//30
	BALL_TYPE_EARTH_BALL,	//31
	BALL_TYPE_DYNAMAX_BALL, //32 - Don't give to player!
...
#define BALL_TYPE_DYNAMAX_BALL 32

#define LAST_BALL_INDEX BALL_TYPE_EARTH_BALL
#define NUM_BALLS (BALL_TYPE_EARTH_BALL + 1) //Make sure to update 0804B5AA in bytereplacement!
