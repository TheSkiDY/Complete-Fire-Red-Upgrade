...
extern const u8 gText_HurtByAbility[];
extern const u8 gText_BadDreamsHurt[];
extern const u8 gText_Harvest[];
extern const u8 gText_Pickup[];
extern const u8 gText_DestinyKnot[];
extern const u8 gText_Mummy[];
extern const u8 gText_AngerPoint[];
extern const u8 gText_IllusionWoreOff[];
extern const u8 gText_SynchronizeNoEffect[];
extern const u8 gText_MimikyuDisguisedTookDamage[];
