...
extern const u8 gAbilityName_TanglingHair[];
extern const u8 gAbilityName_Gooey[];
extern const u8 gAbilityName_AirLock[];
extern const u8 gAbilityName_ShellArmor[];
extern const u8 gAbilityName_ChillingNeigh[];
extern const u8 gAbilityName_Dazzling[];
extern const u8 gAbilityName_QueenlyMajesty[];
extern const u8 gAbilityName_FullMetalBody[];
extern const u8 gAbilityName_WimpOut[];
extern const u8 gAbilityName_Turboblaze[];
extern const u8 gAbilityName_Teravolt[];
extern const u8 gAbilityName_SolidRock[];
extern const u8 gAbilityName_PrismArmor[];
extern const u8 gAbilityName_IronBarbs[];
extern const u8 gAbilityName_Libero[];
extern const u8 gAbilityName_Magician[];
extern const u8 gAbilityName_Pickpocket[];
extern const u8 gAbilityName_Multiscale[];
extern const u8 gAbilityName_ShadowShield[];
extern const u8 gAbilityName_PowerOfAlchemy[];
extern const u8 gAbilityName_PropellerTail[];
extern const u8 gAbilityName_Cacophony[];
extern const u8 gAbilityName_Blaze[];
extern const u8 gAbilityName_Torrent[];
extern const u8 gAbilityName_Overgrow[];
extern const u8 gAbilityName_Swarm[];
extern const u8 gAbilityName_Virtue[];
extern const u8 gAbilityName_Overcharged[];
extern const u8 gAbilityName_Snowfall[];
extern const u8 gAbilityName_Brainstorm[];
extern const u8 gAbilityName_Cyclone[];
extern const u8 gAbilityName_Biohazard[];
extern const u8 gAbilityName_Rampage[];
extern const u8 gAbilityName_Upheaval[];
extern const u8 gAbilityName_Bedrock[];
extern const u8 gAbilityName_Wrath[];
extern const u8 gAbilityName_Haunted[];
extern const u8 gAbilityName_Temper[];
extern const u8 gAbilityName_MythicRage[];
extern const u8 gAbilityName_Enchant[];
extern const u8 gAbilityName_NormalAura[];
extern const u8 gAbilityName_FightingAura[];
extern const u8 gAbilityName_FlyingAura[];
extern const u8 gAbilityName_PoisonAura[];
extern const u8 gAbilityName_GroundAura[];
extern const u8 gAbilityName_RockAura[];
extern const u8 gAbilityName_BugAura[];
extern const u8 gAbilityName_GhostAura[];
extern const u8 gAbilityName_SteelAura[];
extern const u8 gAbilityName_FireAura[];
extern const u8 gAbilityName_WaterAura[];
extern const u8 gAbilityName_GrassAura[];
extern const u8 gAbilityName_ElectricAura[];
extern const u8 gAbilityName_PsychicAura[];
extern const u8 gAbilityName_IceAura[];
extern const u8 gAbilityName_DragonAura[];
extern const u8 gAbilityName_DarkAura[];
extern const u8 gAbilityName_FairyAura[];
extern const u8 gAbilityName_FlameBody[];
extern const u8 gAbilityName_PoisonPoint[];
extern const u8 gAbilityName_Static[];

extern const u8 gAbilityDesc_Blaze[];
extern const u8 gAbilityDesc_Torrent[];
extern const u8 gAbilityDesc_Swarm[];
extern const u8 gAbilityDesc_Overgrow[];
extern const u8 gAbilityDesc_Virtue[];
extern const u8 gAbilityDesc_Overcharged[];
extern const u8 gAbilityDesc_Snowfall[];
extern const u8 gAbilityDesc_Brainstorm[];
extern const u8 gAbilityDesc_Cyclone[];
extern const u8 gAbilityDesc_Biohazard[];
extern const u8 gAbilityDesc_Rampage[];
extern const u8 gAbilityDesc_Upheaval[];
extern const u8 gAbilityDesc_Bedrock[];
extern const u8 gAbilityDesc_Wrath[];
extern const u8 gAbilityDesc_Haunted[];
extern const u8 gAbilityDesc_Temper[];
extern const u8 gAbilityDesc_MythicRage[];
extern const u8 gAbilityDesc_Enchant[];
extern const u8 gAbilityDesc_NormalAura[];
extern const u8 gAbilityDesc_FightingAura[];
extern const u8 gAbilityDesc_FlyingAura[];
extern const u8 gAbilityDesc_PoisonAura[];
extern const u8 gAbilityDesc_GroundAura[];
extern const u8 gAbilityDesc_RockAura[];
extern const u8 gAbilityDesc_BugAura[];
extern const u8 gAbilityDesc_GhostAura[];
extern const u8 gAbilityDesc_SteelAura[];
extern const u8 gAbilityDesc_FireAura[];
extern const u8 gAbilityDesc_WaterAura[];
extern const u8 gAbilityDesc_GrassAura[];
extern const u8 gAbilityDesc_ElectricAura[];
extern const u8 gAbilityDesc_PsychicAura[];
extern const u8 gAbilityDesc_IceAura[];
extern const u8 gAbilityDesc_DragonAura[];
extern const u8 gAbilityDesc_DarkAura[];
extern const u8 gAbilityDesc_FairyAura[];