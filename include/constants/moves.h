...
#define MOVE_SNOWSCAPE MOVE_HAIL
...
//Let's Go
#define MOVE_ZIPPYZAP 0x2FF
#define MOVE_SPLISHYSPLASH 0x300
#define MOVE_FLOATYFALL 0x301
#define MOVE_PIKAPAPOW 0x302
#define MOVE_BOUNCYBUBBLE 0x303
#define MOVE_BUZZYBUZZ 0x304
#define MOVE_SIZZLYSLIDE 0x305
#define MOVE_GLITZYGLOW 0x306
#define MOVE_BADDYBAD 0x307
#define MOVE_SAPPYSEED 0x308
#define MOVE_FREEZYFROST 0x309
#define MOVE_SPARKLYSWIRL 0x30A
#define MOVE_VEEVEEVOLLEY 0x30B

//Gen 9
#define MOVE_TERABLAST 0x30C
#define MOVE_SILKTRAP 0x30D
#define MOVE_AXEKICK 0x30E
#define MOVE_LASTRESPECTS 0x30F
#define MOVE_LUMINACRASH 0x310
#define MOVE_ORDERUP 0x311
#define MOVE_JETPUNCH 0x312
#define MOVE_SPICYEXTRACT 0x313
#define MOVE_SPINOUT 0x314
#define MOVE_POPULATIONBOMB 0x315
#define MOVE_ICESPINNER 0x316
#define MOVE_GLAIVERUSH 0x317
#define MOVE_REVIVALBLESSING 0x318
#define MOVE_SALTCURE 0x319
#define MOVE_TRIPLEDIVE 0x31A
#define MOVE_MORTALSPIN 0x31B
#define MOVE_DOODLE 0x31C
#define MOVE_FILLETAWAY 0x31D
#define MOVE_KOWTOWCLEAVE 0x31E
#define MOVE_FLOWERTRICK 0x31F
#define MOVE_TORCHSONG 0x320
#define MOVE_AQUASTEP 0x321
#define MOVE_RAGINGBULL 0x322
#define MOVE_MAKEITRAIN 0x323
#define MOVE_PSYBLADE 0x324
#define MOVE_HYDROSTEAM 0x325
#define MOVE_RUINATION 0x326
#define MOVE_COLLISIONCOURSE 0x327
#define MOVE_ELECTRODRIFT 0x328
#define MOVE_SHEDTAIL 0x329
#define MOVE_CHILLYRECEPTION 0x32A
#define MOVE_TIDYUP 0x32B
#define MOVE_POUNCE 0x32C
#define MOVE_TRAILBLAZE 0x32D
#define MOVE_CHILLINGWATER 0x32E
#define MOVE_HYPERDRILL 0x32F
#define MOVE_TWINBEAM 0x330
#define MOVE_RAGEFIST 0x331
#define MOVE_ARMORCANNON 0x332
#define MOVE_BITTERBLADE 0x333
#define MOVE_DOUBLESHOCK 0x334
#define MOVE_GIGATONHAMMER 0x335
#define MOVE_COMEUPPANCE 0x336
#define MOVE_AQUACUTTER 0x337
#define MOVE_BLAZINGTORQUE 0x338
#define MOVE_WICKEDTORQUE 0x339
#define MOVE_NOXIOUSTORQUE 0x33A
#define MOVE_COMBATTORQUE 0x33B
#define MOVE_MAGICALTORQUE 0x33C
#define MOVE_BLOODMOON 0x33D
#define MOVE_MATCHAGOTCHA 0x33E
#define MOVE_SYRUPBOMB 0x33F
...
#define MOVE_NIHILLIGHT 0x350


#define LAST_VIABLE_MOVE MOVE_NIHILLIGHT
#define Z_MOVE_INDEX (LAST_VIABLE_MOVE + 1)

//Z-Moves
#define MOVE_BREAKNECK_BLITZ_P (Z_MOVE_INDEX + 0)
#define MOVE_BREAKNECK_BLITZ_S (Z_MOVE_INDEX + 1)
#define MOVE_ALL_OUT_PUMMELING_P (Z_MOVE_INDEX + 2)
#define MOVE_ALL_OUT_PUMMELING_S (Z_MOVE_INDEX + 3)
#define MOVE_SUPERSONIC_SKYSTRIKE_P (Z_MOVE_INDEX + 4)
#define MOVE_SUPERSONIC_SKYSTRIKE_S (Z_MOVE_INDEX + 5)
#define MOVE_ACID_DOWNPOUR_P (Z_MOVE_INDEX + 6)
#define MOVE_ACID_DOWNPOUR_S (Z_MOVE_INDEX + 7)
#define MOVE_TECTONIC_RAGE_P (Z_MOVE_INDEX + 8)
#define MOVE_TECTONIC_RAGE_S (Z_MOVE_INDEX + 9)
#define MOVE_CONTINENTAL_CRUSH_P (Z_MOVE_INDEX + 10)
#define MOVE_CONTINENTAL_CRUSH_S (Z_MOVE_INDEX + 11)
#define MOVE_SAVAGE_SPIN_OUT_P (Z_MOVE_INDEX + 12)
#define MOVE_SAVAGE_SPIN_OUT_S (Z_MOVE_INDEX + 13)
#define MOVE_NEVER_ENDING_NIGHTMARE_P (Z_MOVE_INDEX + 14)
#define MOVE_NEVER_ENDING_NIGHTMARE_S (Z_MOVE_INDEX + 15)
#define MOVE_CORKSCREW_CRASH_P (Z_MOVE_INDEX + 16)
#define MOVE_CORKSCREW_CRASH_S (Z_MOVE_INDEX + 17)
#define MOVE_INFERNO_OVERDRIVE_P (Z_MOVE_INDEX + 18)
#define MOVE_INFERNO_OVERDRIVE_S (Z_MOVE_INDEX + 19)
#define MOVE_HYDRO_VORTEX_P (Z_MOVE_INDEX + 20)
#define MOVE_HYDRO_VORTEX_S (Z_MOVE_INDEX + 21)
#define MOVE_BLOOM_DOOM_P (Z_MOVE_INDEX + 22)
#define MOVE_BLOOM_DOOM_S (Z_MOVE_INDEX + 23)
#define MOVE_GIGAVOLT_HAVOC_P (Z_MOVE_INDEX + 24)
#define MOVE_GIGAVOLT_HAVOC_S (Z_MOVE_INDEX + 25)
#define MOVE_SHATTERED_PSYCHE_P (Z_MOVE_INDEX + 26)
#define MOVE_SHATTERED_PSYCHE_S (Z_MOVE_INDEX + 27)
#define MOVE_SUBZERO_SLAMMER_P (Z_MOVE_INDEX + 28)
#define MOVE_SUBZERO_SLAMMER_S (Z_MOVE_INDEX + 29)
#define MOVE_DEVASTATING_DRAKE_P (Z_MOVE_INDEX + 30)
#define MOVE_DEVASTATING_DRAKE_S (Z_MOVE_INDEX + 31)
#define MOVE_BLACK_HOLE_ECLIPSE_P (Z_MOVE_INDEX + 32)
#define MOVE_BLACK_HOLE_ECLIPSE_S (Z_MOVE_INDEX + 33)
#define MOVE_TWINKLE_TACKLE_P (Z_MOVE_INDEX + 34)
#define MOVE_TWINKLE_TACKLE_S (Z_MOVE_INDEX + 35)

#define MOVE_CATASTROPIKA (Z_MOVE_INDEX + 36)
#define MOVE_10000000_VOLT_THUNDERBOLT (Z_MOVE_INDEX + 37)
#define MOVE_STOKED_SPARKSURFER (Z_MOVE_INDEX + 38) //Paralyze Target
#define MOVE_EXTREME_EVOBOOST (Z_MOVE_INDEX + 39) //Double Ancient Power
#define MOVE_PULVERIZING_PANCAKE (Z_MOVE_INDEX + 40)
#define MOVE_GENESIS_SUPERNOVA (Z_MOVE_INDEX + 41) //Sets up Psychic Terrain
#define MOVE_SINISTER_ARROW_RAID (Z_MOVE_INDEX + 42)
#define MOVE_MALICIOUS_MOONSAULT (Z_MOVE_INDEX + 43)
#define MOVE_OCEANIC_OPERETTA (Z_MOVE_INDEX + 44)
#define MOVE_SPLINTERED_STORMSHARDS (Z_MOVE_INDEX + 45) //Removes Terrain
#define MOVE_LETS_SNUGGLE_FOREVER (Z_MOVE_INDEX + 46)
#define MOVE_CLANGOROUS_SOULBLAZE (Z_MOVE_INDEX + 47) //Ancient Power
#define MOVE_GUARDIAN_OF_ALOLA (Z_MOVE_INDEX + 48)
#define MOVE_SEARING_SUNRAZE_SMASH (Z_MOVE_INDEX + 49)
#define MOVE_MENACING_MOONRAZE_MAELSTROM (Z_MOVE_INDEX + 50)
#define MOVE_LIGHT_THAT_BURNS_THE_SKY (Z_MOVE_INDEX + 51)
#define MOVE_SOUL_STEALING_7_STAR_STRIKE (Z_MOVE_INDEX + 52)

#define FIRST_Z_MOVE        MOVE_BREAKNECK_BLITZ_P
#define LAST_Z_MOVE         MOVE_SOUL_STEALING_7_STAR_STRIKE

#define GMAX_MOVE_INDEX (LAST_Z_MOVE + 1)

//Max Moves
#define MOVE_MAX_GUARD (GMAX_MOVE_INDEX + 0)
#define MOVE_MAX_STRIKE_P (GMAX_MOVE_INDEX + 1)
#define MOVE_MAX_STRIKE_S (GMAX_MOVE_INDEX + 2)
#define MOVE_MAX_KNUCKLE_P (GMAX_MOVE_INDEX + 3)
#define MOVE_MAX_KNUCKLE_S (GMAX_MOVE_INDEX + 4)
#define MOVE_MAX_AIRSTREAM_P (GMAX_MOVE_INDEX + 5)
#define MOVE_MAX_AIRSTREAM_S (GMAX_MOVE_INDEX + 6)
#define MOVE_MAX_OOZE_P (GMAX_MOVE_INDEX + 7)
#define MOVE_MAX_OOZE_S (GMAX_MOVE_INDEX + 8)
#define MOVE_MAX_QUAKE_P (GMAX_MOVE_INDEX + 9)
#define MOVE_MAX_QUAKE_S (GMAX_MOVE_INDEX + 10)
#define MOVE_MAX_ROCKFALL_P (GMAX_MOVE_INDEX + 11)
#define MOVE_MAX_ROCKFALL_S (GMAX_MOVE_INDEX + 12)
#define MOVE_MAX_FLUTTERBY_P (GMAX_MOVE_INDEX + 13)
#define MOVE_MAX_FLUTTERBY_S (GMAX_MOVE_INDEX + 14)
#define MOVE_MAX_PHANTASM_P (GMAX_MOVE_INDEX + 15)
#define MOVE_MAX_PHANTASM_S (GMAX_MOVE_INDEX + 16)
#define MOVE_MAX_STEELSPIKE_P (GMAX_MOVE_INDEX + 17)
#define MOVE_MAX_STEELSPIKE_S (GMAX_MOVE_INDEX + 18)
#define MOVE_MAX_FLARE_P (GMAX_MOVE_INDEX + 19)
#define MOVE_MAX_FLARE_S (GMAX_MOVE_INDEX + 20)
#define MOVE_MAX_GEYSER_P (GMAX_MOVE_INDEX + 21)
#define MOVE_MAX_GEYSER_S (GMAX_MOVE_INDEX + 22)
#define MOVE_MAX_OVERGROWTH_P (GMAX_MOVE_INDEX + 23)
#define MOVE_MAX_OVERGROWTH_S (GMAX_MOVE_INDEX + 24)
#define MOVE_MAX_LIGHTNING_P (GMAX_MOVE_INDEX + 25)
#define MOVE_MAX_LIGHTNING_S (GMAX_MOVE_INDEX + 26)
#define MOVE_MAX_MINDSTORM_P (GMAX_MOVE_INDEX + 27)
#define MOVE_MAX_MINDSTORM_S (GMAX_MOVE_INDEX + 28)
#define MOVE_MAX_HAILSTORM_P (GMAX_MOVE_INDEX + 29)
#define MOVE_MAX_HAILSTORM_S (GMAX_MOVE_INDEX + 30)
#define MOVE_MAX_WYRMWIND_P (GMAX_MOVE_INDEX + 31)
#define MOVE_MAX_WYRMWIND_S (GMAX_MOVE_INDEX + 32)
#define MOVE_MAX_DARKNESS_P (GMAX_MOVE_INDEX + 33)
#define MOVE_MAX_DARKNESS_S (GMAX_MOVE_INDEX + 34)
#define MOVE_MAX_STARFALL_P (GMAX_MOVE_INDEX + 35)
#define MOVE_MAX_STARFALL_S (GMAX_MOVE_INDEX + 36)
#define MOVE_G_MAX_VINE_LASH_P (GMAX_MOVE_INDEX + 37)
#define MOVE_G_MAX_VINE_LASH_S (GMAX_MOVE_INDEX + 38)
#define MOVE_G_MAX_WILDFIRE_P (GMAX_MOVE_INDEX + 39)
#define MOVE_G_MAX_WILDFIRE_S (GMAX_MOVE_INDEX + 40)
#define MOVE_G_MAX_CANNONADE_P (GMAX_MOVE_INDEX + 41)
#define MOVE_G_MAX_CANNONADE_S (GMAX_MOVE_INDEX + 42)
#define MOVE_G_MAX_BEFUDDLE_P (GMAX_MOVE_INDEX + 43)
#define MOVE_G_MAX_BEFUDDLE_S (GMAX_MOVE_INDEX + 44)
#define MOVE_G_MAX_VOLT_CRASH_P (GMAX_MOVE_INDEX + 45)
#define MOVE_G_MAX_VOLT_CRASH_S (GMAX_MOVE_INDEX + 46)
#define MOVE_G_MAX_GOLD_RUSH_P (GMAX_MOVE_INDEX + 47)
#define MOVE_G_MAX_GOLD_RUSH_S (GMAX_MOVE_INDEX + 48)
#define MOVE_G_MAX_CHI_STRIKE_P (GMAX_MOVE_INDEX + 49)
#define MOVE_G_MAX_CHI_STRIKE_S (GMAX_MOVE_INDEX + 50)
#define MOVE_G_MAX_TERROR_P (GMAX_MOVE_INDEX + 51)
#define MOVE_G_MAX_TERROR_S (GMAX_MOVE_INDEX + 52)
#define MOVE_G_MAX_FOAM_BURST_P (GMAX_MOVE_INDEX + 53)
#define MOVE_G_MAX_FOAM_BURST_S (GMAX_MOVE_INDEX + 54)
#define MOVE_G_MAX_RESONANCE_P (GMAX_MOVE_INDEX + 55)
#define MOVE_G_MAX_RESONANCE_S (GMAX_MOVE_INDEX + 56)
#define MOVE_G_MAX_CUDDLE_P (GMAX_MOVE_INDEX + 57)
#define MOVE_G_MAX_CUDDLE_S (GMAX_MOVE_INDEX + 58)
#define MOVE_G_MAX_REPLENISH_P (GMAX_MOVE_INDEX + 59)
#define MOVE_G_MAX_REPLENISH_S (GMAX_MOVE_INDEX + 60)
#define MOVE_G_MAX_MALODOR_P (GMAX_MOVE_INDEX + 61)
#define MOVE_G_MAX_MALODOR_S (GMAX_MOVE_INDEX + 62)
#define MOVE_G_MAX_MELTDOWN_P (GMAX_MOVE_INDEX + 63)
#define MOVE_G_MAX_MELTDOWN_S (GMAX_MOVE_INDEX + 64)
#define MOVE_G_MAX_DRUM_SOLO_P (GMAX_MOVE_INDEX + 65)
#define MOVE_G_MAX_DRUM_SOLO_S (GMAX_MOVE_INDEX + 66)
#define MOVE_G_MAX_FIREBALL_P (GMAX_MOVE_INDEX + 67)
#define MOVE_G_MAX_FIREBALL_S (GMAX_MOVE_INDEX + 68)
#define MOVE_G_MAX_HYDROSNIPE_P (GMAX_MOVE_INDEX + 69)
#define MOVE_G_MAX_HYDROSNIPE_S (GMAX_MOVE_INDEX + 70)
#define MOVE_G_MAX_WIND_RAGE_P (GMAX_MOVE_INDEX + 71)
#define MOVE_G_MAX_WIND_RAGE_S (GMAX_MOVE_INDEX + 72)
#define MOVE_G_MAX_GRAVITAS_P (GMAX_MOVE_INDEX + 73)
#define MOVE_G_MAX_GRAVITAS_S (GMAX_MOVE_INDEX + 74)
#define MOVE_G_MAX_STONESURGE_P (GMAX_MOVE_INDEX + 75)
#define MOVE_G_MAX_STONESURGE_S (GMAX_MOVE_INDEX + 76)
#define MOVE_G_MAX_VOLCALITH_P (GMAX_MOVE_INDEX + 77)
#define MOVE_G_MAX_VOLCALITH_S (GMAX_MOVE_INDEX + 78)
#define MOVE_G_MAX_TARTNESS_P (GMAX_MOVE_INDEX + 79)
#define MOVE_G_MAX_TARTNESS_S (GMAX_MOVE_INDEX + 80)
#define MOVE_G_MAX_SWEETNESS_P (GMAX_MOVE_INDEX + 81)
#define MOVE_G_MAX_SWEETNESS_S (GMAX_MOVE_INDEX + 82)
#define MOVE_G_MAX_SANDBLAST_P (GMAX_MOVE_INDEX + 83)
#define MOVE_G_MAX_SANDBLAST_S (GMAX_MOVE_INDEX + 84)
#define MOVE_G_MAX_STUN_SHOCK_P (GMAX_MOVE_INDEX + 85)
#define MOVE_G_MAX_STUN_SHOCK_S (GMAX_MOVE_INDEX + 86)
#define MOVE_G_MAX_CENTIFERNO_P (GMAX_MOVE_INDEX + 87)
#define MOVE_G_MAX_CENTIFERNO_S (GMAX_MOVE_INDEX + 88)
#define MOVE_G_MAX_SMITE_P (GMAX_MOVE_INDEX + 89)
#define MOVE_G_MAX_SMITE_S (GMAX_MOVE_INDEX + 90)
#define MOVE_G_MAX_SNOOZE_P (GMAX_MOVE_INDEX + 91)
#define MOVE_G_MAX_SNOOZE_S (GMAX_MOVE_INDEX + 92)
#define MOVE_G_MAX_FINALE_P (GMAX_MOVE_INDEX + 93)
#define MOVE_G_MAX_FINALE_S (GMAX_MOVE_INDEX + 94)
#define MOVE_G_MAX_STEELSURGE_P (GMAX_MOVE_INDEX + 95)
#define MOVE_G_MAX_STEELSURGE_S (GMAX_MOVE_INDEX + 96)
#define MOVE_G_MAX_DEPLETION_P (GMAX_MOVE_INDEX + 97)
#define MOVE_G_MAX_DEPLETION_S (GMAX_MOVE_INDEX + 98)
#define MOVE_G_MAX_ONE_BLOW_P (GMAX_MOVE_INDEX + 99)
#define MOVE_G_MAX_ONE_BLOW_S (GMAX_MOVE_INDEX + 100)
#define MOVE_G_MAX_RAPID_FLOW_P (GMAX_MOVE_INDEX + 101)
#define MOVE_G_MAX_RAPID_FLOW_S (GMAX_MOVE_INDEX + 102)
...
#define NON_Z_MOVE_COUNT   (LAST_VIABLE_MOVE + 1)
