...
//Custom moves
#define MOVE_FLAMEBULLET 0x2E4
#define MOVE_STONEAXE 0x2E5
#define MOVE_PHANTOMBOLT 0x2E6
#define MOVE_PIXIESPREE 0x2E7
#define MOVE_VAMPIRICBITE 0x2E8
#define MOVE_RUSTYWATER 0x2E9
#define MOVE_TWIRLINGDANCE 0x2EA
#define MOVE_NATUREBREAK 0x2EB
#define MOVE_METALARROWS 0x2EC
#define MOVE_TOXICCLENCH 0x2ED
#define MOVE_SOULFOCUS 0x2EE
#define MOVE_HITANDRUN 0x2EF
#define MOVE_POWERSHIFT 0x2F0
#define MOVE_EERIESPELL 0x2F1
#define MOVE_GLACIALLANCE 0x2F2
#define MOVE_ASTRALBARRAGE 0x2F3
#define MOVE_DIRECLAW 0x2F4
#define MOVE_PSYSHIELDBASH 0x2F5
#define MOVE_SPRINGTIDESTORM 0x2F6
#define MOVE_MYSTICALPOWER 0x2F7
#define MOVE_RAGINGFURY 0x2F8
#define MOVE_WAVECRASH 0x2F9
#define MOVE_CHLOROBLAST 0x2FA
#define MOVE_MOUNTAINGALE 0x2FB
#define MOVE_VICTORYDANCE 0x2FC
#define MOVE_HEADLONGRUSH 0x2FD
#define MOVE_BARBBARRAGE 0x2FE
#define MOVE_ESPERWING 0x2FF
#define MOVE_BITTERMALICE 0x300
#define MOVE_SHELTER 0x301
#define MOVE_TRIPLEARROWS 0x302
#define MOVE_INFERNALPARADE 0x303
#define MOVE_CEASELESSEDGE 0x304
#define MOVE_BLEAKWINDSTORM 0x305
#define MOVE_WILDBOLTSTORM 0x306
#define MOVE_SANDSEARSTORM 0x307
#define MOVE_LUNARBLESSING 0x308
#define MOVE_TAKEHEART 0x309
#define MOVE_SHADOWTERRAIN 0x30A
#define MOVE_DRACOTERRAIN 0x30B
#define MOVE_STEELYSPIKES 0x30C
#define MOVE_EMPTY_42 0x30D
#define MOVE_EMPTY_43 0x30E
#define MOVE_EMPTY_44 0x30F
#define MOVE_EMPTY_45 0x310
#define MOVE_EMPTY_46 0x311
#define MOVE_EMPTY_47 0x312
#define MOVE_EMPTY_48 0x313
#define MOVE_EMPTY_49 0x314
#define MOVE_EMPTY_50 0x315
#define MOVE_EMPTY_51 0x316
#define MOVE_EMPTY_52 0x317
#define MOVE_EMPTY_53 0x318
#define MOVE_EMPTY_54 0x319
#define MOVE_EMPTY_55 0x31A
#define MOVE_EMPTY_56 0x31B
#define MOVE_EMPTY_57 0x31C
#define MOVE_EMPTY_58 0x31D
#define MOVE_EMPTY_59 0x31E
#define MOVE_EMPTY_60 0x31F
#define MOVE_EMPTY_61 0x320
#define MOVE_EMPTY_62 0x321
#define MOVE_EMPTY_63 0x322
#define MOVE_EMPTY_64 0x323
#define MOVE_EMPTY_65 0x324
#define MOVE_EMPTY_66 0x325
#define MOVE_EMPTY_67 0x326
#define MOVE_EMPTY_68 0x327
#define MOVE_EMPTY_69 0x328
#define MOVE_EMPTY_70 0x329
#define MOVE_EMPTY_71 0x32A
#define MOVE_EMPTY_72 0x32B
#define MOVE_EMPTY_73 0x32C
#define MOVE_EMPTY_74 0x32D
#define MOVE_EMPTY_75 0x32E
#define MOVE_EMPTY_76 0x32F
#define MOVE_EMPTY_77 0x330
#define MOVE_EMPTY_78 0x331
#define MOVE_EMPTY_79 0x332
#define MOVE_EMPTY_80 0x333
#define MOVE_EMPTY_81 0x334
#define MOVE_EMPTY_82 0x335
#define MOVE_EMPTY_83 0x336
#define MOVE_EMPTY_84 0x337
#define MOVE_EMPTY_85 0x338
#define MOVE_EMPTY_86 0x339
#define MOVE_EMPTY_87 0x33A
#define MOVE_EMPTY_88 0x33B
#define MOVE_EMPTY_89 0x33C
#define MOVE_EMPTY_90 0x33D
#define MOVE_EMPTY_91 0x33E
#define MOVE_EMPTY_92 0x33F
#define MOVE_EMPTY_93 0x340
#define MOVE_EMPTY_94 0x341
#define MOVE_EMPTY_95 0x342
#define MOVE_EMPTY_96 0x343
#define MOVE_EMPTY_97 0x344
#define MOVE_EMPTY_98 0x345
#define MOVE_EMPTY_99 0x346
#define MOVE_EMPTY_100 0x347

//Z-Moves
#define MOVE_BREAKNECK_BLITZ_P 0x348
#define MOVE_BREAKNECK_BLITZ_S 0x349
#define MOVE_ALL_OUT_PUMMELING_P 0x34A
#define MOVE_ALL_OUT_PUMMELING_S 0x34B
#define MOVE_SUPERSONIC_SKYSTRIKE_P 0x34C
#define MOVE_SUPERSONIC_SKYSTRIKE_S 0x34D
#define MOVE_ACID_DOWNPOUR_P 0x34E
#define MOVE_ACID_DOWNPOUR_S 0x34F
#define MOVE_TECTONIC_RAGE_P 0x350
#define MOVE_TECTONIC_RAGE_S 0x351
#define MOVE_CONTINENTAL_CRUSH_P 0x352
#define MOVE_CONTINENTAL_CRUSH_S 0x353
#define MOVE_SAVAGE_SPIN_OUT_P 0x354
#define MOVE_SAVAGE_SPIN_OUT_S 0x355
#define MOVE_NEVER_ENDING_NIGHTMARE_P 0x356
#define MOVE_NEVER_ENDING_NIGHTMARE_S 0x357
#define MOVE_CORKSCREW_CRASH_P 0x358
#define MOVE_CORKSCREW_CRASH_S 0x359
#define MOVE_INFERNO_OVERDRIVE_P 0x35A
#define MOVE_INFERNO_OVERDRIVE_S 0x35B
#define MOVE_HYDRO_VORTEX_P 0x35C
#define MOVE_HYDRO_VORTEX_S 0x35D
#define MOVE_BLOOM_DOOM_P 0x35E
#define MOVE_BLOOM_DOOM_S 0x35F
#define MOVE_GIGAVOLT_HAVOC_P 0x360
#define MOVE_GIGAVOLT_HAVOC_S 0x361
#define MOVE_SHATTERED_PSYCHE_P 0x362
#define MOVE_SHATTERED_PSYCHE_S 0x363
#define MOVE_SUBZERO_SLAMMER_P 0x364
#define MOVE_SUBZERO_SLAMMER_S 0x365
#define MOVE_DEVASTATING_DRAKE_P 0x366
#define MOVE_DEVASTATING_DRAKE_S 0x367
#define MOVE_BLACK_HOLE_ECLIPSE_P 0x368
#define MOVE_BLACK_HOLE_ECLIPSE_S 0x369
#define MOVE_TWINKLE_TACKLE_P 0x36A
#define MOVE_TWINKLE_TACKLE_S 0x36B

#define MOVE_CATASTROPIKA 0x36C
#define MOVE_10000000_VOLT_THUNDERBOLT 0x36D
#define MOVE_STOKED_SPARKSURFER 0x36E
#define MOVE_EXTREME_EVOBOOST 0x36F
#define MOVE_PULVERIZING_PANCAKE 0x370
#define MOVE_GENESIS_SUPERNOVA 0x371
#define MOVE_SINISTER_ARROW_RAID 0x372
#define MOVE_MALICIOUS_MOONSAULT 0x373
#define MOVE_OCEANIC_OPERETTA 0x374
#define MOVE_SPLINTERED_STORMSHARDS 0x375
#define MOVE_LETS_SNUGGLE_FOREVER 0x376
#define MOVE_CLANGOROUS_SOULBLAZE 0x377
#define MOVE_GUARDIAN_OF_ALOLA 0x378
#define MOVE_SEARING_SUNRAZE_SMASH 0x379
#define MOVE_MENACING_MOONRAZE_MAELSTROM 0x37A
#define MOVE_LIGHT_THAT_BURNS_THE_SKY 0x37B
#define MOVE_SOUL_STEALING_7_STAR_STRIKE 0x37C

#define FIRST_Z_MOVE        MOVE_BREAKNECK_BLITZ_P
#define LAST_Z_MOVE         MOVE_SOUL_STEALING_7_STAR_STRIKE

//Max Moves
#define MOVE_MAX_GUARD 0x37D
#define MOVE_MAX_STRIKE_P 0x37E
#define MOVE_MAX_STRIKE_S 0x37F
#define MOVE_MAX_KNUCKLE_P 0x380
#define MOVE_MAX_KNUCKLE_S 0x381
#define MOVE_MAX_AIRSTREAM_P 0x382
#define MOVE_MAX_AIRSTREAM_S 0x383
#define MOVE_MAX_OOZE_P 0x384
#define MOVE_MAX_OOZE_S 0x385
#define MOVE_MAX_QUAKE_P 0x386
#define MOVE_MAX_QUAKE_S 0x387
#define MOVE_MAX_ROCKFALL_P 0x388
#define MOVE_MAX_ROCKFALL_S 0x389
#define MOVE_MAX_FLUTTERBY_P 0x38A
#define MOVE_MAX_FLUTTERBY_S 0x38B
#define MOVE_MAX_PHANTASM_P 0x38C
#define MOVE_MAX_PHANTASM_S 0x38D
#define MOVE_MAX_STEELSPIKE_P 0x38E
#define MOVE_MAX_STEELSPIKE_S 0x38F
#define MOVE_MAX_FLARE_P 0x390
#define MOVE_MAX_FLARE_S 0x391
#define MOVE_MAX_GEYSER_P 0x392
#define MOVE_MAX_GEYSER_S 0x393
#define MOVE_MAX_OVERGROWTH_P 0x394
#define MOVE_MAX_OVERGROWTH_S 0x395
#define MOVE_MAX_LIGHTNING_P 0x396
#define MOVE_MAX_LIGHTNING_S 0x397
#define MOVE_MAX_MINDSTORM_P 0x398
#define MOVE_MAX_MINDSTORM_S 0x399
#define MOVE_MAX_HAILSTORM_P 0x39A
#define MOVE_MAX_HAILSTORM_S 0x39B
#define MOVE_MAX_WYRMWIND_P 0x39C
#define MOVE_MAX_WYRMWIND_S 0x39D
#define MOVE_MAX_DARKNESS_P 0x39E
#define MOVE_MAX_DARKNESS_S 0x39F
#define MOVE_MAX_STARFALL_P 0x3A0
#define MOVE_MAX_STARFALL_S 0x3A1
#define MOVE_G_MAX_VINE_LASH_P 0x3A2
#define MOVE_G_MAX_VINE_LASH_S 0x3A3
#define MOVE_G_MAX_WILDFIRE_P 0x3A4
#define MOVE_G_MAX_WILDFIRE_S 0x3A5
#define MOVE_G_MAX_CANNONADE_P 0x3A6
#define MOVE_G_MAX_CANNONADE_S 0x3A7
#define MOVE_G_MAX_BEFUDDLE_P 0x3A8
#define MOVE_G_MAX_BEFUDDLE_S 0x3A9
#define MOVE_G_MAX_VOLT_CRASH_P 0x3AA
#define MOVE_G_MAX_VOLT_CRASH_S 0x3AB
#define MOVE_G_MAX_GOLD_RUSH_P 0x3AC
#define MOVE_G_MAX_GOLD_RUSH_S 0x3AD
#define MOVE_G_MAX_CHI_STRIKE_P 0x3AE
#define MOVE_G_MAX_CHI_STRIKE_S 0x3AF
#define MOVE_G_MAX_TERROR_P 0x3B0
#define MOVE_G_MAX_TERROR_S 0x3B1
#define MOVE_G_MAX_FOAM_BURST_P 0x3B2
#define MOVE_G_MAX_FOAM_BURST_S 0x3B3
#define MOVE_G_MAX_RESONANCE_P 0x3B4
#define MOVE_G_MAX_RESONANCE_S 0x3B5
#define MOVE_G_MAX_CUDDLE_P 0x3B6
#define MOVE_G_MAX_CUDDLE_S 0x3B7
#define MOVE_G_MAX_REPLENISH_P 0x3B8
#define MOVE_G_MAX_REPLENISH_S 0x3B9
#define MOVE_G_MAX_MALODOR_P 0x3BA
#define MOVE_G_MAX_MALODOR_S 0x3BB
#define MOVE_G_MAX_MELTDOWN_P 0x3BC
#define MOVE_G_MAX_MELTDOWN_S 0x3BD
#define MOVE_G_MAX_DRUM_SOLO_P 0x3BE
#define MOVE_G_MAX_DRUM_SOLO_S 0x3BF
#define MOVE_G_MAX_FIREBALL_P 0x3C0
#define MOVE_G_MAX_FIREBALL_S 0x3C1
#define MOVE_G_MAX_HYDROSNIPE_P 0x3C2
#define MOVE_G_MAX_HYDROSNIPE_S 0x3C3
#define MOVE_G_MAX_WIND_RAGE_P 0x3C4
#define MOVE_G_MAX_WIND_RAGE_S 0x3C5
#define MOVE_G_MAX_GRAVITAS_P 0x3C6
#define MOVE_G_MAX_GRAVITAS_S 0x3C7
#define MOVE_G_MAX_STONESURGE_P 0x3C8
#define MOVE_G_MAX_STONESURGE_S 0x3C9
#define MOVE_G_MAX_VOLCALITH_P 0x3CA
#define MOVE_G_MAX_VOLCALITH_S 0x3CB
#define MOVE_G_MAX_TARTNESS_P 0x3CC
#define MOVE_G_MAX_TARTNESS_S 0x3CD
#define MOVE_G_MAX_SWEETNESS_P 0x3CE
#define MOVE_G_MAX_SWEETNESS_S 0x3CF
#define MOVE_G_MAX_SANDBLAST_P 0x3D0
#define MOVE_G_MAX_SANDBLAST_S 0x3D1
#define MOVE_G_MAX_STUN_SHOCK_P 0x3D2
#define MOVE_G_MAX_STUN_SHOCK_S 0x3D3
#define MOVE_G_MAX_CENTIFERNO_P 0x3D4
#define MOVE_G_MAX_CENTIFERNO_S 0x3D5
#define MOVE_G_MAX_SMITE_P 0x3D6
#define MOVE_G_MAX_SMITE_S 0x3D7
#define MOVE_G_MAX_SNOOZE_P 0x3D8
#define MOVE_G_MAX_SNOOZE_S 0x3D9
#define MOVE_G_MAX_FINALE_P 0x3DA
#define MOVE_G_MAX_FINALE_S 0x3DB
#define MOVE_G_MAX_STEELSURGE_P 0x3DC
#define MOVE_G_MAX_STEELSURGE_S 0x3DD
#define MOVE_G_MAX_DEPLETION_P 0x3DE
#define MOVE_G_MAX_DEPLETION_S 0x3DF
#define MOVE_G_MAX_ONE_BLOW_P 0x3E0
#define MOVE_G_MAX_ONE_BLOW_S 0x3E1
#define MOVE_G_MAX_RAPID_FLOW_P 0x3E2
#define MOVE_G_MAX_RAPID_FLOW_S 0x3E3
...
#define NON_Z_MOVE_COUNT   (MOVE_EMPTY_100 + 1)
