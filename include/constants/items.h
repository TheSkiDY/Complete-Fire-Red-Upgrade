...
#define ITEM_PINK_BOW 0x2DA
#define ITEM_ROOM_EXTENDER 0x2DB
#define ITEM_RELIC_MIRROR 0x2DC
#define ITEM_BLACK_AUGURITE 0x2DD
#define ITEM_PEAT_BLOCK 0x2DE
#define ITEM_ALAKAZITE_S 0x2DF
#define ITEM_LOPUNNITE_S 0x2E0
#define ITEM_LANTURNITE 0x2E1
#define ITEM_OCTILLERITE 0x2E2
#define ITEM_SMEARGLITE 0x2E3
#define ITEM_CHIMECHITE 0x2E4
#define ITEM_SWELLOWITE 0x2E5
#define ITEM_TALONFLITE 0x2E6
#define ITEM_CARBINKITE 0x2E7
#define ITEM_EMPATHY_ROCK 0x2E8
#define ITEM_ADAMANT_CRYSTAL 0x2E9
#define ITEM_LUSTROUS_GLOBE 0x2EA
#define ITEM_GRISEOUS_CORE 0x2EB
#define ITEM_INFINITE_REPEL 0x2EC
#define ITEM_PORTABLE_PC 0x2ED
#define ITEM_STAT_SCANNER 0x2EE
#define ITEM_CATCHING_CHARM 0x2EF
#define ITEM_EXP_CHARM 0x2F0
#define ITEM_NATURE_PILL_HARDY 753
#define ITEM_NATURE_PILL_LONELY 754
#define ITEM_NATURE_PILL_BRAVE 755
#define ITEM_NATURE_PILL_ADAMANT 756
#define ITEM_NATURE_PILL_NAUGHTY 757
#define ITEM_NATURE_PILL_BOLD 758
#define ITEM_NATURE_PILL_DOCILE 759
#define ITEM_NATURE_PILL_RELAXED 760
#define ITEM_NATURE_PILL_IMPISH 761
#define ITEM_NATURE_PILL_LAX 762
#define ITEM_NATURE_PILL_TIMID 763
#define ITEM_NATURE_PILL_HASTY 764
#define ITEM_NATURE_PILL_SERIOUS 765
#define ITEM_NATURE_PILL_JOLLY 766
#define ITEM_NATURE_PILL_NAIVE 767
#define ITEM_NATURE_PILL_MODEST 768
#define ITEM_NATURE_PILL_MILD 769
#define ITEM_NATURE_PILL_QUIET 770
#define ITEM_NATURE_PILL_BASHFUL 771
#define ITEM_NATURE_PILL_RASH 772
#define ITEM_NATURE_PILL_CALM 773
#define ITEM_NATURE_PILL_GENTLE 774
#define ITEM_NATURE_PILL_SASSY 775
#define ITEM_NATURE_PILL_CAREFUL 776
#define ITEM_NATURE_PILL_QUIRKY 777
#define ITEM_ELECTRIC_CANDY 0x30A
#define ITEM_MISTY_CANDY 0x30B
#define ITEM_PSYCHIC_CANDY 0x30C
#define ITEM_GRASSY_CANDY 0x30D
#define ITEM_PARALYZE_ORB 0x30E
#define ITEM_SLEEP_ORB 0x30F
#define ITEM_FROST_ORB 0x310
#define ITEM_SHINY_BALL 0x311
#define ITEM_SOLAR_BALL 0x312
#define ITEM_FLOOD_BALL 0x313
#define ITEM_HAIL_BALL 0x314
#define ITEM_EARTH_BALL 0x315
#define ITEM_CYAN_NECTAR 0x316
#define ITEM_AUSPICIOUS_ARMOR 0x317
#define ITEM_MALICIOUS_ARMOR 0x318
#define ITEM_LEADERS_CREST 0x319
#define ITEM_LOADED_DICE 0x31A
#define ITEM_PUNCHING_GLOVES 0x31B
#define ITEM_MIRROR_HERB 0x31C
#define ITEM_FREE_797 0x31D
#define ITEM_FREE_798 0x31E
#define ITEM_FREE_799 0x31F
#define ITEM_FREE_800 0x320
#define ITEM_FREE_801 0x321
#define ITEM_FREE_802 0x322
#define ITEM_FREE_803 0x323
#define ITEM_FREE_804 0x324
#define ITEM_FREE_805 0x325
#define ITEM_FREE_806 0x326
#define ITEM_FREE_807 0x327
#define ITEM_FREE_808 0x328
#define ITEM_FREE_809 0x329
#define ITEM_FREE_810 0x32A
#define ITEM_FREE_811 0x32B
#define ITEM_FREE_812 0x32C
#define ITEM_FREE_813 0x32D
#define ITEM_FREE_814 0x32E
#define ITEM_FREE_815 0x32F
#define ITEM_FREE_816 0x330
#define ITEM_FREE_817 0x331
#define ITEM_FREE_818 0x332
#define ITEM_FREE_819 0x333
#define ITEM_FREE_820 0x334
#define ITEM_FREE_821 0x335
#define ITEM_FREE_822 0x336
#define ITEM_FREE_823 0x337
#define ITEM_FREE_824 0x338
#define ITEM_FREE_825 0x339
#define ITEM_FREE_826 0x33A
#define ITEM_FREE_827 0x33B
#define ITEM_FREE_828 0x33C
#define ITEM_FREE_829 0x33D
#define ITEM_FREE_830 0x33E
#define ITEM_FREE_831 0x33F
#define ITEM_FREE_832 0x340
#define ITEM_FREE_833 0x341
#define ITEM_FREE_834 0x342
#define ITEM_FREE_835 0x343
#define ITEM_FREE_836 0x344
#define ITEM_FREE_837 0x345
#define ITEM_FREE_838 0x346
#define ITEM_FREE_839 0x347
#define ITEM_FREE_840 0x348
#define ITEM_FREE_841 0x349
#define ITEM_FREE_842 0x34A
#define ITEM_FREE_843 0x34B
#define ITEM_FREE_844 0x34C
#define ITEM_FREE_845 0x34D
#define ITEM_FREE_846 0x34E
#define ITEM_FREE_847 0x34F
#define ITEM_FREE_848 0x350
#define ITEM_FREE_849 0x351
#define ITEM_FREE_850 0x352
#define ITEM_FREE_851 0x353
#define ITEM_FREE_852 0x354
#define ITEM_FREE_853 0x355
#define ITEM_FREE_854 0x356
#define ITEM_FREE_855 0x357
#define ITEM_FREE_856 0x358
#define ITEM_FREE_857 0x359
#define ITEM_FREE_858 0x35A
#define ITEM_FREE_859 0x35B
#define ITEM_FREE_860 0x35C
#define ITEM_FREE_861 0x35D
#define ITEM_FREE_862 0x35E
#define ITEM_FREE_863 0x35F
#define ITEM_FREE_864 0x360
#define ITEM_FREE_865 0x361
#define ITEM_FREE_866 0x362
#define ITEM_FREE_867 0x363
#define ITEM_FREE_868 0x364
#define ITEM_FREE_869 0x365
#define ITEM_FREE_870 0x366
#define ITEM_FREE_871 0x367
#define ITEM_FREE_872 0x368
#define ITEM_FREE_873 0x369
#define ITEM_FREE_874 0x36A
#define ITEM_FREE_875 0x36B
#define ITEM_FREE_876 0x36C
#define ITEM_FREE_877 0x36D
#define ITEM_FREE_878 0x36E
#define ITEM_FREE_879 0x36F
#define ITEM_FREE_880 0x370
#define ITEM_FREE_881 0x371
#define ITEM_FREE_882 0x372
#define ITEM_FREE_883 0x373
#define ITEM_FREE_884 0x374
#define ITEM_FREE_885 0x375
#define ITEM_FREE_886 0x376
#define ITEM_FREE_887 0x377
#define ITEM_FREE_888 0x378
#define ITEM_FREE_889 0x379
#define ITEM_FREE_890 0x37A
#define ITEM_FREE_891 0x37B
#define ITEM_FREE_892 0x37C
#define ITEM_FREE_893 0x37D
#define ITEM_FREE_894 0x37E
#define ITEM_FREE_895 0x37F
#define ITEM_FREE_896 0x380
#define ITEM_FREE_897 0x381
#define ITEM_FREE_898 0x382
#define ITEM_FREE_899 0x383
#define ITEM_FREE_900 0x384
#define ITEM_FREE_901 0x385
#define ITEM_FREE_902 0x386
#define ITEM_FREE_903 0x387
#define ITEM_FREE_904 0x388
#define ITEM_FREE_905 0x389
#define ITEM_FREE_906 0x38A
#define ITEM_FREE_907 0x38B
#define ITEM_FREE_908 0x38C
#define ITEM_FREE_909 0x38D
#define ITEM_FREE_910 0x38E
#define ITEM_FREE_911 0x38F
#define ITEM_FREE_912 0x390
#define ITEM_FREE_913 0x391
#define ITEM_FREE_914 0x392
#define ITEM_FREE_915 0x393
#define ITEM_FREE_916 0x394
#define ITEM_FREE_917 0x395
#define ITEM_FREE_918 0x396
#define ITEM_FREE_919 0x397
#define ITEM_FREE_920 0x398
#define ITEM_FREE_921 0x399
#define ITEM_FREE_922 0x39A
#define ITEM_FREE_923 0x39B
#define ITEM_FREE_924 0x39C
#define ITEM_FREE_925 0x39D
#define ITEM_FREE_926 0x39E
#define ITEM_FREE_927 0x39F
#define ITEM_FREE_928 0x3A0
#define ITEM_FREE_929 0x3A1
#define ITEM_FREE_930 0x3A2
#define ITEM_FREE_931 0x3A3
#define ITEM_FREE_932 0x3A4
#define ITEM_FREE_933 0x3A5
#define ITEM_FREE_934 0x3A6
#define ITEM_FREE_935 0x3A7
#define ITEM_FREE_936 0x3A8
#define ITEM_FREE_937 0x3A9
#define ITEM_FREE_938 0x3AA
#define ITEM_FREE_939 0x3AB
#define ITEM_FREE_940 0x3AC
#define ITEM_FREE_941 0x3AD
#define ITEM_FREE_942 0x3AE
#define ITEM_FREE_943 0x3AF
#define ITEM_FREE_944 0x3B0
#define ITEM_FREE_945 0x3B1
#define ITEM_FREE_946 0x3B2
#define ITEM_FREE_947 0x3B3
#define ITEM_FREE_948 0x3B4
#define ITEM_FREE_949 0x3B5
#define ITEM_FREE_950 0x3B6
#define ITEM_FREE_951 0x3B7
#define ITEM_FREE_952 0x3B8
#define ITEM_FREE_953 0x3B9
#define ITEM_FREE_954 0x3BA
#define ITEM_FREE_955 0x3BB
#define ITEM_FREE_956 0x3BC
#define ITEM_FREE_957 0x3BD
#define ITEM_FREE_958 0x3BE
#define ITEM_FREE_959 0x3BF
#define ITEM_FREE_960 0x3C0
#define ITEM_FREE_961 0x3C1
#define ITEM_FREE_962 0x3C2
#define ITEM_FREE_963 0x3C3
#define ITEM_FREE_964 0x3C4
#define ITEM_FREE_965 0x3C5
#define ITEM_FREE_966 0x3C6
#define ITEM_FREE_967 0x3C7
#define ITEM_FREE_968 0x3C8
#define ITEM_FREE_969 0x3C9
#define ITEM_FREE_970 0x3CA
#define ITEM_FREE_971 0x3CB
#define ITEM_FREE_972 0x3CC
#define ITEM_FREE_973 0x3CD
#define ITEM_FREE_974 0x3CE
#define ITEM_FREE_975 0x3CF
#define ITEM_FREE_976 0x3D0
#define ITEM_FREE_977 0x3D1
#define ITEM_FREE_978 0x3D2
#define ITEM_FREE_979 0x3D3
#define ITEM_FREE_980 0x3D4
#define ITEM_FREE_981 0x3D5
#define ITEM_FREE_982 0x3D6
#define ITEM_FREE_983 0x3D7
#define ITEM_FREE_984 0x3D8
#define ITEM_FREE_985 0x3D9
#define ITEM_FREE_986 0x3DA
#define ITEM_FREE_987 0x3DB
#define ITEM_FREE_988 0x3DC
#define ITEM_FREE_989 0x3DD
#define ITEM_FREE_990 0x3DE
#define ITEM_FREE_991 0x3DF
#define ITEM_FREE_992 0x3E0
#define ITEM_FREE_993 0x3E1
#define ITEM_FREE_994 0x3E2
#define ITEM_FREE_995 0x3E3
#define ITEM_FREE_996 0x3E4
#define ITEM_FREE_997 0x3E5
#define ITEM_FREE_998 0x3E6

#define ITEM_LAST 0x3E7
