...
extern const u8 gTrainerFrontPic_YoungsterTiles[];
extern const u8 gTrainerFrontPic_YoungsterPal[];
extern const u8 gTrainerFrontPic_BugCatcherTiles[];
extern const u8 gTrainerFrontPic_BugCatcherPal[];
extern const u8 gTrainerFrontPic_LassTiles[];
extern const u8 gTrainerFrontPic_LassPal[];
extern const u8 gTrainerFrontPic_SailorTiles[];
extern const u8 gTrainerFrontPic_SailorPal[];
extern const u8 gTrainerFrontPic_CamperTiles[];
extern const u8 gTrainerFrontPic_CamperPal[];
extern const u8 gTrainerFrontPic_PicnickerTiles[];
extern const u8 gTrainerFrontPic_PicnickerPal[];
extern const u8 gTrainerFrontPic_PokemaniacTiles[];
extern const u8 gTrainerFrontPic_PokemaniacPal[];
extern const u8 gTrainerFrontPic_SuperNerdTiles[];
extern const u8 gTrainerFrontPic_SuperNerdPal[];
extern const u8 gTrainerFrontPic_HikerTiles[];
extern const u8 gTrainerFrontPic_HikerPal[];
extern const u8 gTrainerFrontPic_BikerTiles[];
extern const u8 gTrainerFrontPic_BikerPal[];
extern const u8 gTrainerFrontPic_BurglarTiles[];
extern const u8 gTrainerFrontPic_BurglarPal[];
extern const u8 gTrainerFrontPic_EngineerTiles[];
extern const u8 gTrainerFrontPic_EngineerPal[];
extern const u8 gTrainerFrontPic_FishermanTiles[];
extern const u8 gTrainerFrontPic_FishermanPal[];
extern const u8 gTrainerFrontPic_SwimmerMTiles[];
extern const u8 gTrainerFrontPic_SwimmerMPal[];
extern const u8 gTrainerFrontPic_CueBallTiles[];
extern const u8 gTrainerFrontPic_CueBallPal[];
extern const u8 gTrainerFrontPic_BeautyTiles[];
extern const u8 gTrainerFrontPic_BeautyPal[];
extern const u8 gTrainerFrontPic_SwimmerFTiles[];
extern const u8 gTrainerFrontPic_SwimmerFPal[];
extern const u8 gTrainerFrontPic_PsychicMTiles[];
extern const u8 gTrainerFrontPic_PsychicMPal[];
extern const u8 gTrainerFrontPic_JugglerTiles[];
extern const u8 gTrainerFrontPic_JugglerPal[];
extern const u8 gTrainerFrontPic_TamerTiles[];
extern const u8 gTrainerFrontPic_TamerPal[];
extern const u8 gTrainerFrontPic_BirdKeeperTiles[];
extern const u8 gTrainerFrontPic_BirdKeeperPal[];
extern const u8 gTrainerFrontPic_BlackBeltTiles[];
extern const u8 gTrainerFrontPic_BlackBeltPal[];
extern const u8 gTrainerFrontPic_RivalEarlyTiles[];
extern const u8 gTrainerFrontPic_RivalEarlyPal[];
extern const u8 gTrainerFrontPic_ScientistTiles[];
extern const u8 gTrainerFrontPic_ScientistPal[];
extern const u8 gTrainerFrontPic_LeaderGiovanniTiles[];
extern const u8 gTrainerFrontPic_LeaderGiovanniPal[];
extern const u8 gTrainerFrontPic_RocketGruntMTiles[];
extern const u8 gTrainerFrontPic_RocketGruntMPal[];
extern const u8 gTrainerFrontPic_CooltrainerMTiles[];
extern const u8 gTrainerFrontPic_CooltrainerMPal[];
extern const u8 gTrainerFrontPic_CooltrainerFTiles[];
extern const u8 gTrainerFrontPic_CooltrainerFPal[];
extern const u8 gTrainerFrontPic_EliteFourBrunoTiles[];
extern const u8 gTrainerFrontPic_EliteFourBrunoPal[];
extern const u8 gTrainerFrontPic_EliteFourLanceTiles[];
extern const u8 gTrainerFrontPic_EliteFourLancePal[];
extern const u8 gTrainerFrontPic_LeaderBrockTiles[];
extern const u8 gTrainerFrontPic_LeaderBrockPal[];
extern const u8 gTrainerFrontPic_LeaderMistyTiles[];
extern const u8 gTrainerFrontPic_LeaderMistyPal[];
extern const u8 gTrainerFrontPic_LeaderLtSurgeTiles[];
extern const u8 gTrainerFrontPic_LeaderLtSurgePal[];
extern const u8 gTrainerFrontPic_LeaderErikaTiles[];
extern const u8 gTrainerFrontPic_LeaderErikaPal[];
extern const u8 gTrainerFrontPic_LeaderKogaTiles[];
extern const u8 gTrainerFrontPic_LeaderKogaPal[];
extern const u8 gTrainerFrontPic_LeaderBlaineTiles[];
extern const u8 gTrainerFrontPic_LeaderBlainePal[];
extern const u8 gTrainerFrontPic_LeaderSabrinaTiles[];
extern const u8 gTrainerFrontPic_LeaderSabrinaPal[];
extern const u8 gTrainerFrontPic_GentlemanTiles[];
extern const u8 gTrainerFrontPic_GentlemanPal[];
extern const u8 gTrainerFrontPic_RivalLateTiles[];
extern const u8 gTrainerFrontPic_RivalLatePal[];
extern const u8 gTrainerFrontPic_TwinsTiles[];
extern const u8 gTrainerFrontPic_TwinsPal[];
extern const u8 gTrainerFrontPic_CoolCoupleTiles[];
extern const u8 gTrainerFrontPic_CoolCouplePal[];
extern const u8 gTrainerFrontPic_YoungCoupleTiles[];
extern const u8 gTrainerFrontPic_YoungCouplePal[];
extern const u8 gTrainerFrontPic_RocketGruntFTiles[];
extern const u8 gTrainerFrontPic_RocketGruntFPal[];
extern const u8 gTrainerFrontPic_PsychicFTiles[];
extern const u8 gTrainerFrontPic_PsychicFPal[];
extern const u8 gTrainerFrontPic_CrushGirlTiles[];
extern const u8 gTrainerFrontPic_CrushGirlPal[];
extern const u8 gTrainerFrontPic_TuberFTiles[];
extern const u8 gTrainerFrontPic_TuberFPal[];
extern const u8 gTrainerFrontPic_PokemonBreederTiles[];
extern const u8 gTrainerFrontPic_PokemonBreederPal[];
extern const u8 gTrainerFrontPic_PokemonRangerMTiles[];
extern const u8 gTrainerFrontPic_PokemonRangerMPal[];
extern const u8 gTrainerFrontPic_PokemonRangerFTiles[];
extern const u8 gTrainerFrontPic_PokemonRangerFPal[];
extern const u8 gTrainerFrontPic_AromaLadyTiles[];
extern const u8 gTrainerFrontPic_AromaLadyPal[];
extern const u8 gTrainerFrontPic_RuinManiacTiles[];
extern const u8 gTrainerFrontPic_RuinManiacPal[];
extern const u8 gTrainerFrontPic_LadyTiles[];
extern const u8 gTrainerFrontPic_LadyPal[];
