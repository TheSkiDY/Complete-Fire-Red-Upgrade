...
#define ABILITYEFFECT_CHECK_TRAPPING_SHADOW_TAG		0x15
#define ABILITYEFFECT_CHECK_TRAPPING_ARENA_TRAP		0x16
#define ABILITYEFFECT_CHECK_TRAPPING_MAGNET_PULL 	0x17
#define ABILITYEFFECT_CHECK_AS_ONE_CHILLING 		0x18
#define ABILITYEFFECT_CHECK_AS_ONE_GRIM 			0x19
#define ABILITYEFFECT_SWITCH_IN_WEATHER         	0xFF

#define ABILITY_ON_OPPOSING_FIELD(battlerId, abilityId) (AbilityBattleEffects(ABILITYEFFECT_CHECK_OTHER_SIDE, battlerId, abilityId, 0, 0))
#define AS_ONE_CHILLING_ON_OPPOSING_FIELD(battlerId) (AbilityBattleEffects(ABILITYEFFECT_CHECK_AS_ONE_CHILLING, battlerId, ABILITYBRANCH_KO_STAT_BOOST, 0, 0))
#define AS_ONE_GRIM_ON_OPPOSING_FIELD(battlerId) (AbilityBattleEffects(ABILITYEFFECT_CHECK_AS_ONE_GRIM, battlerId, ABILITYBRANCH_KO_STAT_BOOST, 0, 0))
#define SHADOW_TAG_ON_OPPOSING_FIELD(battlerId) (AbilityBattleEffects(ABILITYEFFECT_CHECK_TRAPPING_SHADOW_TAG, battlerId, ABILITYBRANCH_SWITCHOUT_PREVENTION, 0, 0))
#define ARENA_TRAP_ON_OPPOSING_FIELD(battlerId) (AbilityBattleEffects(ABILITYEFFECT_CHECK_TRAPPING_ARENA_TRAP, battlerId, ABILITYBRANCH_SWITCHOUT_PREVENTION, 0, 0))
#define MAGNET_PULL_ON_OPPOSING_FIELD(battlerId) (AbilityBattleEffects(ABILITYEFFECT_CHECK_TRAPPING_MAGNET_PULL, battlerId, ABILITYBRANCH_SWITCHOUT_PREVENTION, 0, 0))
