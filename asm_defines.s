...
.equ ANIM_TOXIC_DEBRIS, 0x52
.equ ANIM_SALT_CURE_DAMAGE, 0x53
...
.equ MOVE_ZIPPYZAP, 0x2FF
.equ MOVE_SPLISHYSPLASH, 0x300
.equ MOVE_FLOATYFALL, 0x301
.equ MOVE_PIKAPAPOW, 0x302
.equ MOVE_BOUNCYBUBBLE, 0x303
.equ MOVE_BUZZYBUZZ, 0x304
.equ MOVE_SIZZLYSLIDE, 0x305
.equ MOVE_GLITZYGLOW, 0x306
.equ MOVE_BADDYBAD, 0x307
.equ MOVE_SAPPYSEED, 0x308
.equ MOVE_FREEZYFROST, 0x309
.equ MOVE_SPARKLYSWIRL, 0x30A
.equ MOVE_VEEVEEVOLLEY, 0x30B

.equ MOVE_TERABLAST, 0x30C
.equ MOVE_SILKTRAP, 0x30D
.equ MOVE_AXEKICK, 0x30E
.equ MOVE_LASTRESPECTS, 0x30F
.equ MOVE_LUMINACRASH, 0x310
.equ MOVE_ORDERUP, 0x311
.equ MOVE_JETPUNCH, 0x312
.equ MOVE_SPICYEXTRACT, 0x313
.equ MOVE_SPINOUT, 0x314
.equ MOVE_POPULATIONBOMB, 0x315
.equ MOVE_ICESPINNER, 0x316
.equ MOVE_GLAIVERUSH, 0x317
.equ MOVE_REVIVALBLESSING, 0x318
.equ MOVE_SALTCURE, 0x319
.equ MOVE_TRIPLEDIVE, 0x31A
.equ MOVE_MORTALSPIN, 0x31B
.equ MOVE_DOODLE, 0x31C
.equ MOVE_FILLETAWAY, 0x31D
.equ MOVE_KOWTOWCLEAVE, 0x31E
.equ MOVE_FLOWERTRICK, 0x31F
.equ MOVE_TORCHSONG, 0x320
.equ MOVE_AQUASTEP, 0x321
.equ MOVE_RAGINGBULL, 0x322
.equ MOVE_MAKEITRAIN, 0x323
.equ MOVE_PSYBLADE, 0x324
.equ MOVE_HYDROSTEAM, 0x325
.equ MOVE_RUINATION, 0x326
.equ MOVE_COLLISIONCOURSE, 0x327
.equ MOVE_ELECTRODRIFT, 0x328
.equ MOVE_SHEDTAIL, 0x329
.equ MOVE_CHILLYRECEPTION, 0x32A
.equ MOVE_TIDYUP, 0x32B
.equ MOVE_POUNCE, 0x32C
.equ MOVE_TRAILBLAZE, 0x32D
.equ MOVE_CHILLINGWATER, 0x32E
.equ MOVE_HYPERDRILL, 0x32F
.equ MOVE_TWINBEAM, 0x330
.equ MOVE_RAGEFIST, 0x331
.equ MOVE_ARMORCANNON, 0x332
.equ MOVE_BITTERBLADE, 0x333
.equ MOVE_DOUBLESHOCK, 0x334
.equ MOVE_GIGATONHAMMER, 0x335
.equ MOVE_COMEUPPANCE, 0x336
.equ MOVE_AQUACUTTER, 0x337
.equ MOVE_BLAZINGTORQUE, 0x338
.equ MOVE_WICKEDTORQUE, 0x339
.equ MOVE_NOXIOUSTORQUE, 0x33A
.equ MOVE_COMBATTORQUE, 0x33B
.equ MOVE_MAGICALTORQUE, 0x33C
.equ MOVE_BLOODMOON, 0x33D
.equ MOVE_MATCHAGOTCHA, 0x33E
.equ MOVE_SYRUPBOMB, 0x33F
.equ MOVE_IVYCUDGEL, 0x340
.equ MOVE_ELECTROSHOT, 0x341
.equ MOVE_TERASTARSTORM, 0x342
.equ MOVE_FICKLEBEAM, 0x343
.equ MOVE_BURNINGBULWARK, 0x344
.equ MOVE_THUNDERCLAP, 0x345
.equ MOVE_MIGHTYCLEAVE, 0x346
.equ MOVE_TACHYONCUTTER, 0x347
.equ MOVE_HARDPRESS, 0x348
.equ MOVE_DRAGONCHEER, 0x349
.equ MOVE_ALLURINGVOICE, 0x34A
.equ MOVE_TEMPERFLARE, 0x34B
.equ MOVE_SUPERCELLSLAM, 0x34C
.equ MOVE_PSYCHICNOISE, 0x34D
.equ MOVE_UPPERHAND, 0x34E
.equ MOVE_MALIGNANTCHAIN, 0x34F
.equ MOVE_NIHILLIGHT, 0x350

//Z-Moves
.equ MOVE_BREAKNECK_BLITZ_P, 0x351
.equ MOVE_BREAKNECK_BLITZ_S, 0x352
.equ MOVE_ALL_OUT_PUMMELING_P, 0x353
.equ MOVE_ALL_OUT_PUMMELING_S, 0x354
.equ MOVE_SUPERSONIC_SKYSTRIKE_P, 0x355
.equ MOVE_SUPERSONIC_SKYSTRIKE_S, 0x356
.equ MOVE_ACID_DOWNPOUR_P, 0x357
.equ MOVE_ACID_DOWNPOUR_S, 0x358
.equ MOVE_TECTONIC_RAGE_P, 0x359
.equ MOVE_TECTONIC_RAGE_S, 0x35A
.equ MOVE_CONTINENTAL_CRUSH_P, 0x35B
.equ MOVE_CONTINENTAL_CRUSH_S, 0x35C
.equ MOVE_SAVAGE_SPIN_OUT_P, 0x35D
.equ MOVE_SAVAGE_SPIN_OUT_S, 0x35E
.equ MOVE_NEVER_ENDING_NIGHTMARE_P, 0x35F
.equ MOVE_NEVER_ENDING_NIGHTMARE_S, 0x360
.equ MOVE_CORKSCREW_CRASH_P, 0x361
.equ MOVE_CORKSCREW_CRASH_S, 0x362
.equ MOVE_INFERNO_OVERDRIVE_P, 0x363
.equ MOVE_INFERNO_OVERDRIVE_S, 0x364
.equ MOVE_HYDRO_VORTEX_P, 0x365
.equ MOVE_HYDRO_VORTEX_S, 0x366
.equ MOVE_BLOOM_DOOM_P, 0x367
.equ MOVE_BLOOM_DOOM_S, 0x368
.equ MOVE_GIGAVOLT_HAVOC_P, 0x369
.equ MOVE_GIGAVOLT_HAVOC_S, 0x36A
.equ MOVE_SHATTERED_PSYCHE_P, 0x36B
.equ MOVE_SHATTERED_PSYCHE_S, 0x36C
.equ MOVE_SUBZERO_SLAMMER_P, 0x36D
.equ MOVE_SUBZERO_SLAMMER_S, 0x36E
.equ MOVE_DEVASTATING_DRAKE_P, 0x36F
.equ MOVE_DEVASTATING_DRAKE_S, 0x370
.equ MOVE_BLACK_HOLE_ECLIPSE_P, 0x371
.equ MOVE_BLACK_HOLE_ECLIPSE_S, 0x372
.equ MOVE_TWINKLE_TACKLE_P, 0x373
.equ MOVE_TWINKLE_TACKLE_S, 0x374

.equ MOVE_CATASTROPIKA, 0x375
.equ MOVE_10000000_VOLT_THUNDERBOLT, 0x376
.equ MOVE_STOKED_SPARKSURFER, 0x377 //Paralyze, Target
.equ MOVE_EXTREME_EVOBOOST, 0x378 //Double, Ancient, Power
.equ MOVE_PULVERIZING_PANCAKE, 0x379
.equ MOVE_GENESIS_SUPERNOVA, 0x37A //Sets, up, Psychic, Terrain
.equ MOVE_SINISTER_ARROW_RAID, 0x37B
.equ MOVE_MALICIOUS_MOONSAULT, 0x37C
.equ MOVE_OCEANIC_OPERETTA, 0x37D
.equ MOVE_SPLINTERED_STORMSHARDS, 0x37E //Removes, Terrain
.equ MOVE_LETS_SNUGGLE_FOREVER, 0x37F
.equ MOVE_CLANGOROUS_SOULBLAZE, 0x380 //Ancient, Power
.equ MOVE_GUARDIAN_OF_ALOLA, 0x381
.equ MOVE_SEARING_SUNRAZE_SMASH, 0x382
.equ MOVE_MENACING_MOONRAZE_MAELSTROM, 0x383
.equ MOVE_LIGHT_THAT_BURNS_THE_SKY, 0x384
.equ MOVE_SOUL_STEALING_7_STAR_STRIKE, 0x385
...
.equ SPECIES_WYRDEER, 0x4D2
.equ SPECIES_KLEAVOR, 0x4D3
.equ SPECIES_URSALUNA, 0x4D4
.equ SPECIES_BASCULEGION, 0x4D5
.equ SPECIES_SNEASLER, 0x4D6
.equ SPECIES_OVERQWIL, 0x4D7
.equ SPECIES_ENAMORUS, 0x4D8

.equ SPECIES_GROWLITHE_H, 0x4D9
.equ SPECIES_ARCANINE_H, 0x4DA
.equ SPECIES_VOLTORB_H, 0x4DB
.equ SPECIES_ELECTRODE_H, 0x4DC
.equ SPECIES_TYPHLOSION_H, 0x4DD
.equ SPECIES_QWILFISH_H, 0x4DE
.equ SPECIES_SNEASEL_H, 0x4DF
.equ SPECIES_SAMUROTT_H, 0x4E0
.equ SPECIES_LILLIGANT_H, 0x4E1
.equ SPECIES_ZORUA_H, 0x4E2
.equ SPECIES_ZOROARK_H, 0x4E3
.equ SPECIES_BRAVIARY_H, 0x4E4
.equ SPECIES_SLIGGOO_H, 0x4E5
.equ SPECIES_GOODRA_H, 0x4E6
.equ SPECIES_AVALUGG_H, 0x4E7
.equ SPECIES_DECIDUEYE_H, 0x4E8
.equ SPECIES_BASCULIN_WHITE, 0x4E9
.equ SPECIES_BASCULEGION_F, 0x4EA
.equ SPECIES_ENAMORUS_THERIAN, 0x4EB

.equ SPECIES_SPRIGATITO, 0x4EC
.equ SPECIES_FLORAGATO, 0x4ED
.equ SPECIES_MEOWSCARADA, 0x4EE
.equ SPECIES_FUECOCO, 0x4EF
.equ SPECIES_CROCALOR, 0x4F0
.equ SPECIES_SKELEDIRGE, 0x4F1
.equ SPECIES_QUAXLY, 0x4F2
.equ SPECIES_QUAXWELL, 0x4F3
.equ SPECIES_QUAQUAVAL, 0x4F4
.equ SPECIES_LECHONK, 0x4F5
.equ SPECIES_OINKOLOGNE, 0x4F6
.equ SPECIES_TAROUNTULA, 0x4F7
.equ SPECIES_SPIDOPS, 0x4F8
.equ SPECIES_NYMBLE, 0x4F9
.equ SPECIES_LOKIX, 0x4FA
.equ SPECIES_PAWMI, 0x4FB
.equ SPECIES_PAWMO, 0x4FC
.equ SPECIES_PAWMOT, 0x4FD
.equ SPECIES_TANDEMAUS, 0x4FE
.equ SPECIES_MAUSHOLD, 0x4FF
.equ SPECIES_FIDOUGH, 0x500
.equ SPECIES_DACHSBUN, 0x501
.equ SPECIES_SMOLIV, 0x502
.equ SPECIES_DOLLIV, 0x503
.equ SPECIES_ARBOLIVA, 0x504
.equ SPECIES_SQUAWKABILLY, 0x505
.equ SPECIES_NACLI, 0x506
.equ SPECIES_NACLSTACK, 0x507
.equ SPECIES_GARGANACL, 0x508
.equ SPECIES_CHARCADET, 0x509
.equ SPECIES_ARMAROUGE, 0x50A
.equ SPECIES_CERULEDGE, 0x50B
.equ SPECIES_TADBULB, 0x50C
.equ SPECIES_BELLIBOLT, 0x50D
.equ SPECIES_WATTREL, 0x50E
.equ SPECIES_KILOWATTREL, 0x50F
.equ SPECIES_MASCHIFF, 0x510
.equ SPECIES_MABOSSTIFF, 0x511
.equ SPECIES_SHROODLE, 0x512
.equ SPECIES_GRAFAIAI, 0x513
.equ SPECIES_BRAMBLIN, 0x514
.equ SPECIES_BRAMBLEGHAST, 0x515
.equ SPECIES_TOEDSCOOL, 0x516
.equ SPECIES_TOEDSCRUEL, 0x517
.equ SPECIES_KLAWF, 0x518
.equ SPECIES_CAPSAKID, 0x519
.equ SPECIES_SCOVILLAIN, 0x51A
.equ SPECIES_RELLOR, 0x51B
.equ SPECIES_RABSCA, 0x51C
.equ SPECIES_FLITTLE, 0x51D
.equ SPECIES_ESPATHRA, 0x51E
.equ SPECIES_TINKATINK, 0x51F
.equ SPECIES_TINKATUFF, 0x520
.equ SPECIES_TINKATON, 0x521
.equ SPECIES_WIGLETT, 0x522
.equ SPECIES_WUGTRIO, 0x523
.equ SPECIES_BOMBIRDIER, 0x524
.equ SPECIES_FINIZEN, 0x525
.equ SPECIES_PALAFIN, 0x526
.equ SPECIES_VAROOM, 0x527
.equ SPECIES_REVAVROOM, 0x528
.equ SPECIES_CYCLIZAR, 0x529
.equ SPECIES_ORTHWORM, 0x52A
.equ SPECIES_GLIMMET, 0x52B
.equ SPECIES_GLIMMORA, 0x52C
.equ SPECIES_GREAVARD, 0x52D
.equ SPECIES_HOUNDSTONE, 0x52E
.equ SPECIES_FLAMIGO, 0x52F
.equ SPECIES_CETODDLE, 0x530
.equ SPECIES_CETITAN, 0x531
.equ SPECIES_VELUZA, 0x532
.equ SPECIES_DONDOZO, 0x533
.equ SPECIES_TATSUGIRI, 0x534
.equ SPECIES_ANNIHILAPE, 0x535
.equ SPECIES_CLODSIRE, 0x536
.equ SPECIES_FARIGIRAF, 0x537
.equ SPECIES_DUDUNSPARCE, 0x538
.equ SPECIES_KINGAMBIT, 0x539
.equ SPECIES_GREAT_TUSK, 0x53A
.equ SPECIES_SCREAM_TAIL, 0x53B
.equ SPECIES_BRUTE_BONNET, 0x53C
.equ SPECIES_FLUTTER_MANE, 0x53D
.equ SPECIES_SLITHER_WING, 0x53E
.equ SPECIES_SANDY_SHOCKS, 0x53F
.equ SPECIES_IRON_TREADS, 0x540
.equ SPECIES_IRON_BUNDLE, 0x541
.equ SPECIES_IRON_HANDS, 0x542
.equ SPECIES_IRON_JUGULIS, 0x543
.equ SPECIES_IRON_MOTH, 0x544
.equ SPECIES_IRON_THORNS, 0x545
.equ SPECIES_FRIGIBAX, 0x546
.equ SPECIES_ARCTIBAX, 0x547
.equ SPECIES_BAXCALIBUR, 0x548
.equ SPECIES_GIMMIGHOUL, 0x549
.equ SPECIES_GHOLDENGO, 0x54A
.equ SPECIES_WO_CHIEN, 0x54B
.equ SPECIES_CHIEN_PAO, 0x54C
.equ SPECIES_TING_LU, 0x54D
.equ SPECIES_CHI_YU, 0x54E
.equ SPECIES_ROARING_MOON, 0x54F
.equ SPECIES_IRON_VALIANT, 0x550
.equ SPECIES_KORAIDON, 0x551
.equ SPECIES_MIRAIDON, 0x552
.equ SPECIES_WALKING_WAKE, 0x553
.equ SPECIES_IRON_LEAVES, 0x554
.equ SPECIES_DIPPLIN, 0x555
.equ SPECIES_POLTCHAGEIST, 0x556
.equ SPECIES_SINISTCHA, 0x557
.equ SPECIES_OKIDOGI, 0x558
.equ SPECIES_MUNKIDORI, 0x559
.equ SPECIES_FEZANDIPITI, 0x55A
.equ SPECIES_OGERPON, 0x55B
.equ SPECIES_ARCHALUDON, 0x55C
.equ SPECIES_HYDRAPPLE, 0x55D
.equ SPECIES_GOUGING_FIRE, 0x55E
.equ SPECIES_RAGING_BOLT, 0x55F
.equ SPECIES_IRON_BOULDER, 0x560
.equ SPECIES_IRON_CROWN, 0x561
.equ SPECIES_TERAPAGOS, 0x562
.equ SPECIES_PECHARUNT, 0x563

.equ SPECIES_TAUROS_P_COMBAT, 0x564
.equ SPECIES_TAUROS_P_BLAZE, 0x565
.equ SPECIES_TAUROS_P_AQUA, 0x566
.equ SPECIES_WOOPER_P, 0x567
.equ SPECIES_URSALUNA_BLOODMOON, 0x568
.equ SPECIES_OINKOLOGNE_F, 0x569
.equ SPECIES_MAUSHOLD_THREE, 0x56A
.equ SPECIES_SQUAWKABILLY_BLUE, 0x56B
.equ SPECIES_SQUAWKABILLY_YELLOW, 0x56C
.equ SPECIES_SQUAWKABILLY_WHITE, 0x56D
.equ SPECIES_PALAFIN_HERO, 0x56E
.equ SPECIES_TATSUGIRI_DROOPY, 0x56F
.equ SPECIES_TATSUGIRI_STRETCHY, 0x570
.equ SPECIES_DUDUNSPARCE_THREE_SEGMENT, 0x571
.equ SPECIES_GIMMIGHOUL_ROAMING, 0x572
.equ SPECIES_POLTCHAGEIST_ARTISAN, 0x573
.equ SPECIES_SINISTCHA_MASTERPIECE, 0x574
.equ SPECIES_OGERPON_WELLSPRING, 0x575
.equ SPECIES_OGERPON_HEARTHFLAME, 0x576
.equ SPECIES_OGERPON_CORNERSTONE, 0x577
.equ SPECIES_TERAPAGOS_TERASTAL, 0x578
.equ SPECIES_TERAPAGOS_STELLAR, 0x579

.equ SPECIES_CLEFABLE_MEGA, 0x57A
.equ SPECIES_VICTREEBEL_MEGA, 0x57B
.equ SPECIES_STARMIE_MEGA, 0x57C
.equ SPECIES_DRAGONITE_MEGA, 0x57D
.equ SPECIES_MEGANIUM_MEGA, 0x57E
.equ SPECIES_FERALIGATR_MEGA, 0x57F
.equ SPECIES_SKARMORY_MEGA, 0x580
.equ SPECIES_FROSLASS_MEGA, 0x581
.equ SPECIES_EMBOAR_MEGA, 0x582
.equ SPECIES_EXCADRILL_MEGA, 0x583
.equ SPECIES_SCOLIPEDE_MEGA, 0x584
.equ SPECIES_SCRAFTY_MEGA, 0x585
.equ SPECIES_EELEKTROSS_MEGA, 0x586
.equ SPECIES_CHANDELURE_MEGA, 0x587
.equ SPECIES_CHESNAUGHT_MEGA, 0x588
.equ SPECIES_DELPHOX_MEGA, 0x589
.equ SPECIES_GRENINJA_MEGA, 0x58A
.equ SPECIES_PYROAR_MEGA, 0x58B
.equ SPECIES_MALAMAR_MEGA, 0x58C
.equ SPECIES_DRAGALGE_MEGA, 0x58D
.equ SPECIES_HAWLUCHA_MEGA, 0x58E
.equ SPECIES_FLOETTE_MEGA, 0x58F
.equ SPECIES_BARBARACLE_MEGA, 0x590
.equ SPECIES_ZYGARDE_MEGA, 0x591
.equ SPECIES_DRAMPA_MEGA, 0x592
.equ SPECIES_FALINKS_MEGA, 0x593
.equ SPECIES_HEATRAN_MEGA, 0x594
.equ SPECIES_DARKRAI_MEGA, 0x595
.equ SPECIES_ZERAORA_MEGA, 0x596
.equ SPECIES_RAICHU_MEGA_X, 0x597
.equ SPECIES_RAICHU_MEGA_Y, 0x598
.equ SPECIES_CHIMECHO_MEGA, 0x599
.equ SPECIES_ABSOL_MEGA_Z, 0x59A
.equ SPECIES_STARAPTOR_MEGA, 0x59B
.equ SPECIES_GARCHOMP_MEGA_Z, 0x59C
.equ SPECIES_LUCARIO_MEGA_Z, 0x59D
.equ SPECIES_GOLURK_MEGA, 0x59E
.equ SPECIES_MEOWSTIC_M_MEGA, 0x59F
.equ SPECIES_MEOWSTIC_F_MEGA, 0x5A0
.equ SPECIES_CRABOMINABLE_MEGA, 0x5A1
.equ SPECIES_GOLISOPOD_MEGA, 0x5A2
.equ SPECIES_MAGEARNA_MEGA, 0x5A3
.equ SPECIES_MAGEARNA_ORIGINAL_MEGA, 0x5A4
.equ SPECIES_SCOVILLAIN_MEGA, 0x5A5
.equ SPECIES_BAXCALIBUR_MEGA, 0x5A6
.equ SPECIES_TATSUGIRI_MEGA, 0x5A7
.equ SPECIES_TATSUGIRI_DROOPY_MEGA, 0x5A8
.equ SPECIES_TATSUGIRI_STRETCHY_MEGA, 0x5A9
.equ SPECIES_GLIMMORA_MEGA, 0x5AA
...
.equ ITEM_REMEDY, 0x2DA
.equ ITEM_FINE_REMEDY, 0x2DB
.equ ITEM_SUPERB_REMEDY, 0x2DC
.equ ITEM_MAX_HONEY, 0x2DD
.equ ITEM_JUBILIFE_MUFFIN, 0x2DE
.equ ITEM_PEWTER_CRUNCHIES, 0x2DF
.equ ITEM_SWEET_HEART, 0x2E0

.equ ITEM_ABILITY_SHIELD, 0x2E1
.equ ITEM_BOOSTER_ENERGY, 0x2E2
.equ ITEM_CLEAR_AMULET, 0x2E3
.equ ITEM_COVERT_CLOAK, 0x2E4
.equ ITEM_FAIRY_FEATHER, 0x2E5
.equ ITEM_LOADED_DICE, 0x2E6
.equ ITEM_MIRROR_HERB, 0x2E7
.equ ITEM_PUNCHING_GLOVE, 0x2E8
.equ ITEM_CORNERSTONE_MASK, 0x2E9
.equ ITEM_HEARTHFLAME_MASK, 0x2EA
.equ ITEM_WELLSPRING_MASK, 0x2EB
.equ ITEM_ADAMANT_CRYSTAL, 0x2EC
.equ ITEM_GRISEOUS_CORE, 0x2ED
.equ ITEM_LUSTROUS_GLOBE, 0x2EE

.equ ITEM_AUSPICIOUS_ARMOR, 0x2EF
.equ ITEM_MALICIOUS_ARMOR, 0x2F0
.equ ITEM_BLACK_AUGURITE, 0x2F1
.equ ITEM_LEADERS_CREST, 0x2F2
.equ ITEM_MASTERPIECE_TEACUP, 0x2F3
.equ ITEM_UNREMARKABLE_TEACUP, 0x2F4
.equ ITEM_METAL_ALLOY, 0x2F5
.equ ITEM_PEAT_BLOCK, 0x2F6
.equ ITEM_SCROLL_OF_DARKNESS, 0x2F7
.equ ITEM_SCROLL_OF_WATERS, 0x2F8
.equ ITEM_SYRUPY_APPLE, 0x2F9

.equ ITEM_ADAMANT_MINT, 0x2FA
.equ ITEM_BOLD_MINT, 0x2FB
.equ ITEM_BRAVE_MINT, 0x2FC
.equ ITEM_CALM_MINT, 0x2FD
.equ ITEM_CAREFUL_MINT, 0x2FE
.equ ITEM_GENTLE_MINT, 0x2FF
.equ ITEM_HASTY_MINT, 0x300
.equ ITEM_IMPISH_MINT, 0x301
.equ ITEM_JOLLY_MINT, 0x302
.equ ITEM_LAX_MINT, 0x303
.equ ITEM_LONELY_MINT, 0x304
.equ ITEM_MILD_MINT, 0x305
.equ ITEM_MODEST_MINT, 0x306
.equ ITEM_NAIVE_MINT, 0x307
.equ ITEM_NAUGHTY_MINT, 0x308
.equ ITEM_QUIET_MINT, 0x309
.equ ITEM_RASH_MINT, 0x30A
.equ ITEM_RELAXED_MINT, 0x30B
.equ ITEM_SASSY_MINT, 0x30C
.equ ITEM_SERIOUS_MINT, 0x30D
.equ ITEM_TIMID_MINT, 0x30E

.equ ITEM_ABSOLITE_Z, 0x30F
.equ ITEM_BARBARACITE, 0x310
.equ ITEM_BAXCALIBRITE, 0x311
.equ ITEM_CHANDELURITE, 0x312
.equ ITEM_CHESNAUGHTITE, 0x313
.equ ITEM_CHIMECHITE, 0x314
.equ ITEM_CLEFABLITE, 0x315
.equ ITEM_CRABOMINITE, 0x316
.equ ITEM_DARKRANITE, 0x317
.equ ITEM_DELPHOXITE, 0x318
.equ ITEM_DRAGALGITE, 0x319
.equ ITEM_DRAGONINITE, 0x31A
.equ ITEM_DRAMPANITE, 0x31B
.equ ITEM_EELEKTROSSITE, 0x31C
.equ ITEM_EMBOARITE, 0x31D
.equ ITEM_EXCADRITE, 0x31E
.equ ITEM_FALINKSITE, 0x31F
.equ ITEM_FERALIGITE, 0x320
.equ ITEM_FLOETTITE, 0x321
.equ ITEM_FROSLASSITE, 0x322
.equ ITEM_GARCHOMPITE_Z, 0x323
.equ ITEM_GLIMMORANITE, 0x324
.equ ITEM_GOLISOPITE, 0x325
.equ ITEM_GOLURKITE, 0x326
.equ ITEM_GRENINJITE, 0x327
.equ ITEM_HAWLUCHANITE, 0x328
.equ ITEM_HEATRANITE, 0x329
.equ ITEM_LUCARIONITE_Z, 0x32A
.equ ITEM_MAGEARNITE, 0x32B
.equ ITEM_MALAMARITE, 0x32C
.equ ITEM_MEGANIUMITE, 0x32D
.equ ITEM_MEOWSTICITE, 0x32E
.equ ITEM_PYROARITE, 0x32F
.equ ITEM_RAICHUNITE_X, 0x330
.equ ITEM_RAICHUNITE_Y, 0x331
.equ ITEM_SCOLIPITE, 0x332
.equ ITEM_SCOVILLAINITE, 0x333
.equ ITEM_SCRAFTINITE, 0x334
.equ ITEM_SKARMORITE, 0x335
.equ ITEM_STARAPTITE, 0x336
.equ ITEM_STARMINITE, 0x337
.equ ITEM_TATSUGIRINITE, 0x338
.equ ITEM_VICTREEBELITE, 0x339
.equ ITEM_ZERAORITE, 0x33A
.equ ITEM_ZYGARDITE, 0x33B
.equ ITEM_PORTABLE_PC, 0x33C
.equ ITEM_INFINITE_REPEL, 0x33D
.equ ITEM_ENDLESS_CANDY, 0x33E
.equ ITEM_CANDY_JAR, 0x33F
.equ ITEM_NORMAL_SHARD, 0x340
.equ ITEM_FIGHTING_SHARD, 0x341
.equ ITEM_FLYING_SHARD, 0x342
.equ ITEM_POISON_SHARD, 0x343
.equ ITEM_GROUND_SHARD, 0x344
.equ ITEM_ROCK_SHARD, 0x345
.equ ITEM_BUG_SHARD, 0x346
.equ ITEM_GHOST_SHARD, 0x347
.equ ITEM_STEEL_SHARD, 0x348
.equ ITEM_FIRE_SHARD, 0x349
.equ ITEM_WATER_SHARD, 0x34A
.equ ITEM_GRASS_SHARD, 0x34B
.equ ITEM_ELECTRIC_SHARD, 0x34C
.equ ITEM_PSYCHIC_SHARD, 0x34D
.equ ITEM_ICE_SHARD, 0x34E
.equ ITEM_DRAGON_SHARD, 0x34F
.equ ITEM_DARK_SHARD, 0x350
.equ ITEM_FAIRY_SHARD, 0x351
.equ ITEM_BASIC_CRATE, 0x352
.equ ITEM_REINFORCED_CRATE, 0x353
.equ ITEM_STAT_SCANNER, 0x354
