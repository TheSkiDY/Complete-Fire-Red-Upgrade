...
.equ MOVE_EFFECT_SPIKE_HIT, 		  0x41
...
.equ SHADOW_TERRAIN, 0x5
.equ DRACO_TERRAIN, 0x6
...
.equ SHADOW_TERRAIN_ACTIVE_ANIM, 0x51
.equ DRACO_TERRAIN_ACTIVE_ANIM, 0x52
.equ ANIM_TSPIKES_TOXIC_DEBRIS, 0x53
...
.equ ABILITY_PROTOSYNTHESIS, 0x39
.equ ABILITY_QUARKDRIVE, 0x3A
...
.equ ABILITY_IMPATIENT, 0x41
.equ ABILITY_BLAZE_LIKE, 0x42
.equ ABILITY_HEAVYBULLET, 0x43
.equ ABILITY_FOCUSEDWARRIOR, 0x44
.equ ABILITY_ROCKHEAD, 0x45
.equ ABILITY_DROUGHT, 0x46
.equ ABILITY_ARENATRAP, 0x47
.equ ABILITY_TYPE_BOOST, 0x48
.equ ABILITY_TOXICDEBRIS, 0x49
.equ ABILITY_NEUTRALIZINGGAS, 0x4A
.equ ABILITY_GOODASGOLD, 0x4B
.equ ABILITY_WISHPEARL, 0x4C
.equ ABILITY_UNUSED, 0x4D
.equ ABILITY_SWEETVEIL, 0x4E
.equ ABILITY_SKILLLINK, 0x4F
.equ ABILITY_MOTORDRIVE, 0x50
.equ ABILITY_MYTHICALSHIELD, 0x51
...
.equ ABILITY_AURA, 0x84
.equ ABILITY_FABULOUSDREAMS, 0x85
.equ ABILITY_AURABREAK, 0x86
.equ ABILITY_ATE, 0x87
.equ ABILITY_DEFLECTOR, 0x88
.equ ABILITY_COMPLETIONIST, 0x89
...
.equ ABILITY_BEWILDER, 0x92
.equ ABILITY_VALOUR, 0x93
...
.equ ABILITY_FORM_CHANGE, 0x9B
.equ ABILITY_PURIFIEDPOLLEN, 0x9C
.equ ABILITY_BEASTBOOST, 0x9D
.equ ABILITY_CORROSION, 0x9E
.equ ABILITY_COSTAR, 0x9F
...
.equ ABILITY_PUREAURA, 0xA5
.equ ABILITY_PURIFYINGSALT, 0xA6
.equ ABILITY_RKS_SYSTEM, 0xA7
.equ ABILITY_RAPIDKICKS, 0xA8
.equ ABILITY_OPPORTUNIST, 0xA9
.equ ABILITY_TERRORIZE, 0xAA
.equ ABILITY_SLUSHRUSH, 0xAB
.equ ABILITY_SOULHEART, 0xAC
.equ ABILITY_STAMINA, 0xAD
.equ ABILITY_SUPREMEOVERLORD, 0xAE
.equ ABILITY_WINDRIDER, 0xAF
...
.equ ABILITY_TERRAIN_SURGE, 0xB5
.equ ABILITY_CLOCKWORK, 0xB6
.equ ABILITY_OVERTHINKING, 0xB7
.equ ABILITY_BRUTEFORCE, 0xB8
...
.equ ABILITY_LURE, 0xD0
.equ ABILITY_POISONTOUCH, 0xD1
.equ ABILITY_ELECTROMORPHOSIS, 0xD2
.equ ABILITY_EARTHEATER, 0xD3
...
.equ ABILITY_TREASURES_OF_RUIN, 0xFA
...
.equ MOVE_FLAMEBULLET, 0x2FF
.equ MOVE_PHANTOMBOLT, 0x300
.equ MOVE_PIXIESPREE, 0x301
.equ MOVE_VAMPIRICBITE, 0x302
.equ MOVE_RUSTYWATER, 0x303
.equ MOVE_TWIRLINGDANCE, 0x304
.equ MOVE_NATUREBREAK, 0x305
.equ MOVE_METALARROWS, 0x306
.equ MOVE_TOXINECLENCH, 0x307
.equ MOVE_SOULFOCUS, 0x308
.equ MOVE_HITANDRUN, 0x309
.equ MOVE_STEELYSPIKES, 0x30A
.equ MOVE_LIVECOALS, 0x30B
.equ MOVE_SHADOWTERRAIN, 0x30C
.equ MOVE_DRACOTERRAIN, 0x30D
.equ MOVE_AQUACUTTER, 0x30E
.equ MOVE_AQUASTEP, 0x30F
.equ MOVE_ARMORCANNON, 0x310
.equ MOVE_AXEKICK, 0x311
.equ MOVE_BITTERBLADE, 0x312
.equ MOVE_BLAZINGTORQUE, 0x313
.equ MOVE_CHILLINGWATER, 0x314
.equ MOVE_CHILLYRECEPTION, 0x315
.equ MOVE_COLLISIONCOURSE, 0x316
.equ MOVE_COMBATTORQUE, 0x317
.equ MOVE_COMEUPPANCE, 0x318
.equ MOVE_DOODLE, 0x319
.equ MOVE_DOUBLESHOCK, 0x31A
.equ MOVE_ELECTRODRIFT, 0x31B
.equ MOVE_FILLETAWAY, 0x31C
.equ MOVE_FLOWERTRICK, 0x31D
.equ MOVE_GIGATONHAMMER, 0x31E
.equ MOVE_GLAIVERUSH, 0x31F
.equ MOVE_HYPERDRILL, 0x320
.equ MOVE_ICESPINNER, 0x321
.equ MOVE_JETPUNCH, 0x322
.equ MOVE_KOWTOWCLEAVE, 0x323
.equ MOVE_LASTRESPECTS, 0x324
.equ MOVE_LUMINACRASH, 0x325
.equ MOVE_MAGICALTORQUE, 0x326
.equ MOVE_MAKEITRAIN, 0x327
.equ MOVE_MORTALSPIN, 0x328
.equ MOVE_NOXIOUSTORQUE, 0x329
.equ MOVE_ORDERUP, 0x32A
.equ MOVE_POPULATIONBOMB, 0x32B
.equ MOVE_POUNCE, 0x32C
.equ MOVE_RAGEFIST, 0x32D
.equ MOVE_RAGINGBULL, 0x32E
.equ MOVE_REVIVALBLESSING, 0x32F
.equ MOVE_RUINATION, 0x330
.equ MOVE_SALTCURE, 0x331
.equ MOVE_SHEDTAIL, 0x332
.equ MOVE_SILKTRAP, 0x333
.equ MOVE_SPICYEXTRACT, 0x334
.equ MOVE_SPINOUT, 0x335
.equ MOVE_TERABLAST, 0x336
.equ MOVE_TIDYUP, 0x337
.equ MOVE_TORCHSONG, 0x338
.equ MOVE_TRAILBLAZE, 0x339
.equ MOVE_TRIPLEDIVE, 0x33A
.equ MOVE_TWINBEAM, 0x33B
.equ MOVE_WICKEDTORQUE, 0x33C
.equ MOVE_EMPTYSLOT_63X, 0x33D
.equ MOVE_EMPTYSLOT_64X, 0x33E
.equ MOVE_EMPTYSLOT_65X, 0x33F
.equ MOVE_EMPTYSLOT_66X, 0x340
.equ MOVE_EMPTYSLOT_67X, 0x341
.equ MOVE_EMPTYSLOT_68X, 0x342
.equ MOVE_EMPTYSLOT_69X, 0x343
.equ MOVE_EMPTYSLOT_70X, 0x344
.equ MOVE_EMPTYSLOT_71X, 0x345
.equ MOVE_EMPTYSLOT_72X, 0x346
.equ MOVE_EMPTYSLOT_73X, 0x347
.equ MOVE_EMPTYSLOT_74X, 0x348
.equ MOVE_EMPTYSLOT_75X, 0x349
.equ MOVE_EMPTYSLOT_76X, 0x34A
.equ MOVE_EMPTYSLOT_77X, 0x34B
.equ MOVE_EMPTYSLOT_78X, 0x34C
.equ MOVE_EMPTYSLOT_79X, 0x34D
.equ MOVE_EMPTYSLOT_80X, 0x34E
.equ MOVE_EMPTYSLOT_81X, 0x34F
.equ MOVE_EMPTYSLOT_82X, 0x350
.equ MOVE_EMPTYSLOT_83X, 0x351
.equ MOVE_EMPTYSLOT_84X, 0x352
.equ MOVE_EMPTYSLOT_85X, 0x353
.equ MOVE_EMPTYSLOT_86X, 0x354
.equ MOVE_EMPTYSLOT_87X, 0x355
.equ MOVE_EMPTYSLOT_88X, 0x356
.equ MOVE_EMPTYSLOT_89X, 0x357
.equ MOVE_EMPTYSLOT_90X, 0x358
.equ MOVE_EMPTYSLOT_91X, 0x359
.equ MOVE_EMPTYSLOT_92X, 0x35A
.equ MOVE_EMPTYSLOT_93X, 0x35B
.equ MOVE_EMPTYSLOT_94X, 0x35C
.equ MOVE_EMPTYSLOT_95X, 0x35D
.equ MOVE_EMPTYSLOT_96X, 0x35E
.equ MOVE_EMPTYSLOT_97X, 0x35F
.equ MOVE_EMPTYSLOT_98X, 0x360
.equ MOVE_EMPTYSLOT_99X, 0x361
.equ MOVE_EMPTYSLOT_100X, 0x362
.equ MOVE_EMPTYSLOT_101X, 0x363
.equ MOVE_EMPTYSLOT_102X, 0x364
.equ MOVE_EMPTYSLOT_103X, 0x365
.equ MOVE_EMPTYSLOT_104X, 0x366
.equ MOVE_EMPTYSLOT_105X, 0x367
.equ MOVE_EMPTYSLOT_106X, 0x368
.equ MOVE_EMPTYSLOT_107X, 0x369
.equ MOVE_EMPTYSLOT_108X, 0x36A
.equ MOVE_EMPTYSLOT_109X, 0x36B
.equ MOVE_EMPTYSLOT_110X, 0x36C
.equ MOVE_EMPTYSLOT_111X, 0x36D
.equ MOVE_EMPTYSLOT_112X, 0x36E
.equ MOVE_EMPTYSLOT_113X, 0x36F
.equ MOVE_EMPTYSLOT_114X, 0x370
.equ MOVE_EMPTYSLOT_115X, 0x371
.equ MOVE_EMPTYSLOT_116X, 0x372
.equ MOVE_EMPTYSLOT_117X, 0x373
.equ MOVE_EMPTYSLOT_118X, 0x374
.equ MOVE_EMPTYSLOT_119X, 0x375
.equ MOVE_EMPTYSLOT_120X, 0x376
.equ MOVE_EMPTYSLOT_121X, 0x377
.equ MOVE_EMPTYSLOT_122X, 0x378
.equ MOVE_EMPTYSLOT_123X, 0x379
.equ MOVE_EMPTYSLOT_124X, 0x37A
.equ MOVE_EMPTYSLOT_125X, 0x37B
.equ MOVE_EMPTYSLOT_126X, 0x37C
.equ MOVE_EMPTYSLOT_127X, 0x37D
.equ MOVE_EMPTYSLOT_128X, 0x37E
.equ MOVE_EMPTYSLOT_129X, 0x37F
.equ MOVE_EMPTYSLOT_130X, 0x380
.equ MOVE_EMPTYSLOT_131X, 0x381
.equ MOVE_EMPTYSLOT_132X, 0x382
.equ MOVE_EMPTYSLOT_133X, 0x383
.equ MOVE_EMPTYSLOT_134X, 0x384
.equ MOVE_EMPTYSLOT_135X, 0x385
.equ MOVE_EMPTYSLOT_136X, 0x386
.equ MOVE_EMPTYSLOT_137X, 0x387
.equ MOVE_EMPTYSLOT_138X, 0x388
.equ MOVE_EMPTYSLOT_139X, 0x389
.equ MOVE_EMPTYSLOT_140X, 0x38A
.equ MOVE_EMPTYSLOT_141X, 0x38B
.equ MOVE_EMPTYSLOT_142X, 0x38C
.equ MOVE_EMPTYSLOT_143X, 0x38D
.equ MOVE_EMPTYSLOT_144X, 0x38E
.equ MOVE_EMPTYSLOT_145X, 0x38F
.equ MOVE_EMPTYSLOT_146X, 0x390
.equ MOVE_EMPTYSLOT_147X, 0x391
.equ MOVE_EMPTYSLOT_148X, 0x392
.equ MOVE_EMPTYSLOT_149X, 0x393
.equ MOVE_EMPTYSLOT_150X, 0x394
.equ MOVE_EMPTYSLOT_151X, 0x395
.equ MOVE_EMPTYSLOT_152X, 0x396
.equ MOVE_EMPTYSLOT_153X, 0x397
.equ MOVE_EMPTYSLOT_154X, 0x398
.equ MOVE_EMPTYSLOT_155X, 0x399
.equ MOVE_EMPTYSLOT_156X, 0x39A
.equ MOVE_EMPTYSLOT_157X, 0x39B
.equ MOVE_EMPTYSLOT_158X, 0x39C
.equ MOVE_EMPTYSLOT_159X, 0x39D
.equ MOVE_EMPTYSLOT_160X, 0x39E
.equ MOVE_EMPTYSLOT_161X, 0x39F
.equ MOVE_EMPTYSLOT_162X, 0x3A0
.equ MOVE_EMPTYSLOT_163X, 0x3A1
.equ MOVE_EMPTYSLOT_164X, 0x3A2
.equ MOVE_EMPTYSLOT_165X, 0x3A3
.equ MOVE_EMPTYSLOT_166X, 0x3A4
.equ MOVE_EMPTYSLOT_167X, 0x3A5
.equ MOVE_EMPTYSLOT_168X, 0x3A6
.equ MOVE_EMPTYSLOT_169X, 0x3A7
.equ MOVE_EMPTYSLOT_170X, 0x3A8
.equ MOVE_EMPTYSLOT_171X, 0x3A9
.equ MOVE_EMPTYSLOT_172X, 0x3AA
.equ MOVE_EMPTYSLOT_173X, 0x3AB
.equ MOVE_EMPTYSLOT_174X, 0x3AC
.equ MOVE_EMPTYSLOT_175X, 0x3AD
.equ MOVE_EMPTYSLOT_176X, 0x3AE
.equ MOVE_EMPTYSLOT_177X, 0x3AF
.equ MOVE_EMPTYSLOT_178X, 0x3B0
.equ MOVE_EMPTYSLOT_179X, 0x3B1
.equ MOVE_EMPTYSLOT_180X, 0x3B2
.equ MOVE_EMPTYSLOT_181X, 0x3B3
.equ MOVE_EMPTYSLOT_182X, 0x3B4
.equ MOVE_EMPTYSLOT_183X, 0x3B5
.equ MOVE_EMPTYSLOT_184X, 0x3B6
.equ MOVE_EMPTYSLOT_185X, 0x3B7
.equ MOVE_EMPTYSLOT_186X, 0x3B8
.equ MOVE_EMPTYSLOT_187X, 0x3B9
.equ MOVE_EMPTYSLOT_188X, 0x3BA
.equ MOVE_EMPTYSLOT_189X, 0x3BB
.equ MOVE_EMPTYSLOT_190X, 0x3BC
.equ MOVE_EMPTYSLOT_191X, 0x3BD
.equ MOVE_EMPTYSLOT_192X, 0x3BE
.equ MOVE_EMPTYSLOT_193X, 0x3BF
.equ MOVE_EMPTYSLOT_194X, 0x3C0
.equ MOVE_EMPTYSLOT_195X, 0x3C1
.equ MOVE_EMPTYSLOT_196X, 0x3C2
.equ MOVE_EMPTYSLOT_197X, 0x3C3
.equ MOVE_EMPTYSLOT_198X, 0x3C4
.equ MOVE_EMPTYSLOT_199X, 0x3C5
.equ MOVE_EMPTYSLOT_200X, 0x3C6
.equ MOVE_EMPTYSLOT_201X, 0x3C7
.equ MOVE_EMPTYSLOT_202X, 0x3C8
.equ MOVE_EMPTYSLOT_203X, 0x3C9
.equ MOVE_EMPTYSLOT_204X, 0x3CA
.equ MOVE_EMPTYSLOT_205X, 0x3CB
.equ MOVE_EMPTYSLOT_206X, 0x3CC
.equ MOVE_EMPTYSLOT_207X, 0x3CD
.equ MOVE_EMPTYSLOT_208X, 0x3CE
.equ MOVE_EMPTYSLOT_209X, 0x3CF
.equ MOVE_EMPTYSLOT_210X, 0x3D0
.equ MOVE_EMPTYSLOT_211X, 0x3D1
.equ MOVE_EMPTYSLOT_212X, 0x3D2
.equ MOVE_EMPTYSLOT_213X, 0x3D3
.equ MOVE_EMPTYSLOT_214X, 0x3D4
.equ MOVE_EMPTYSLOT_215X, 0x3D5
.equ MOVE_EMPTYSLOT_216X, 0x3D6
.equ MOVE_EMPTYSLOT_217X, 0x3D7
.equ MOVE_EMPTYSLOT_218X, 0x3D8
.equ MOVE_EMPTYSLOT_219X, 0x3D9
.equ MOVE_EMPTYSLOT_220X, 0x3DA
.equ MOVE_EMPTYSLOT_221X, 0x3DB
.equ MOVE_EMPTYSLOT_222X, 0x3DC
.equ MOVE_EMPTYSLOT_223X, 0x3DD
.equ MOVE_EMPTYSLOT_224X, 0x3DE
.equ MOVE_EMPTYSLOT_225X, 0x3DF
.equ MOVE_EMPTYSLOT_226X, 0x3E0
.equ MOVE_EMPTYSLOT_227X, 0x3E1
.equ MOVE_EMPTYSLOT_228X, 0x3E2
.equ MOVE_EMPTYSLOT_229X, 0x3E3
.equ MOVE_EMPTYSLOT_230X, 0x3E4
.equ MOVE_EMPTYSLOT_231X, 0x3E5
.equ MOVE_EMPTYSLOT_232X, 0x3E6
.equ MOVE_EMPTYSLOT_233X, 0x3E7
.equ MOVE_EMPTYSLOT_234X, 0x3E8
.equ MOVE_EMPTYSLOT_235X, 0x3E9
.equ MOVE_EMPTYSLOT_236X, 0x3EA
.equ MOVE_EMPTYSLOT_237X, 0x3EB
.equ MOVE_EMPTYSLOT_238X, 0x3EC
.equ MOVE_EMPTYSLOT_239X, 0x3ED
.equ MOVE_EMPTYSLOT_240X, 0x3EE
.equ MOVE_EMPTYSLOT_241X, 0x3EF
.equ MOVE_EMPTYSLOT_242X, 0x3F0
.equ MOVE_EMPTYSLOT_243X, 0x3F1
.equ MOVE_EMPTYSLOT_244X, 0x3F2
.equ MOVE_EMPTYSLOT_245X, 0x3F3
.equ MOVE_EMPTYSLOT_246X, 0x3F4
.equ MOVE_EMPTYSLOT_247X, 0x3F5
.equ MOVE_EMPTYSLOT_248X, 0x3F6
.equ MOVE_EMPTYSLOT_249X, 0x3F7
.equ MOVE_EMPTYSLOT_250X, 0x3F8

//Z-Moves
.equ MOVE_BREAKNECK_BLITZ_P, 0x3F9
.equ MOVE_BREAKNECK_BLITZ_S, 0x3FA
.equ MOVE_ALL_OUT_PUMMELING_P, 0x3FB
.equ MOVE_ALL_OUT_PUMMELING_S, 0x3FC
.equ MOVE_SUPERSONIC_SKYSTRIKE_P, 0x3FD
.equ MOVE_SUPERSONIC_SKYSTRIKE_S, 0x3FE
.equ MOVE_ACID_DOWNPOUR_P, 0x3FF
.equ MOVE_ACID_DOWNPOUR_S, 0x400
.equ MOVE_TECTONIC_RAGE_P, 0x401
.equ MOVE_TECTONIC_RAGE_S, 0x402
.equ MOVE_CONTINENTAL_CRUSH_P, 0x403
.equ MOVE_CONTINENTAL_CRUSH_S, 0x404
.equ MOVE_SAVAGE_SPIN_OUT_P, 0x405
.equ MOVE_SAVAGE_SPIN_OUT_S, 0x406
.equ MOVE_NEVER_ENDING_NIGHTMARE_P, 0x407
.equ MOVE_NEVER_ENDING_NIGHTMARE_S, 0x408
.equ MOVE_CORKSCREW_CRASH_P, 0x409
.equ MOVE_CORKSCREW_CRASH_S, 0x40A
.equ MOVE_INFERNO_OVERDRIVE_P, 0x40B
.equ MOVE_INFERNO_OVERDRIVE_S, 0x40C
.equ MOVE_HYDRO_VORTEX_P, 0x40D
.equ MOVE_HYDRO_VORTEX_S, 0x40E
.equ MOVE_BLOOM_DOOM_P, 0x40F
.equ MOVE_BLOOM_DOOM_S, 0x410
.equ MOVE_GIGAVOLT_HAVOC_P, 0x411
.equ MOVE_GIGAVOLT_HAVOC_S, 0x412
.equ MOVE_SHATTERED_PSYCHE_P, 0x413
.equ MOVE_SHATTERED_PSYCHE_S, 0x414
.equ MOVE_SUBZERO_SLAMMER_P, 0x415
.equ MOVE_SUBZERO_SLAMMER_S, 0x416
.equ MOVE_DEVASTATING_DRAKE_P, 0x417
.equ MOVE_DEVASTATING_DRAKE_S, 0x418
.equ MOVE_BLACK_HOLE_ECLIPSE_P, 0x419
.equ MOVE_BLACK_HOLE_ECLIPSE_S, 0x41A
.equ MOVE_TWINKLE_TACKLE_P, 0x41B
.equ MOVE_TWINKLE_TACKLE_S, 0x41C
.equ MOVE_CATASTROPIKA, 0x41D
.equ MOVE_10000000_VOLT_THUNDERBOLT, 0x41E
.equ MOVE_STOKED_SPARKSURFER, 0x41F
.equ MOVE_EXTREME_EVOBOOST, 0x420
.equ MOVE_PULVERIZING_PANCAKE, 0x421
.equ MOVE_GENESIS_SUPERNOVA, 0x422
.equ MOVE_SINISTER_ARROW_RAID, 0x423
.equ MOVE_MALICIOUS_MOONSAULT, 0x424
.equ MOVE_OCEANIC_OPERETTA, 0x425
.equ MOVE_SPLINTERED_STORMSHARDS, 0x426
.equ MOVE_LETS_SNUGGLE_FOREVER, 0x427
.equ MOVE_CLANGOROUS_SOULBLAZE, 0x428
.equ MOVE_GUARDIAN_OF_ALOLA, 0x429
.equ MOVE_SEARING_SUNRAZE_SMASH, 0x42A
.equ MOVE_MENACING_MOONRAZE_MAELSTROM, 0x42B
.equ MOVE_LIGHT_THAT_BURNS_THE_SKY, 0x42C
.equ MOVE_SOUL_STEALING_7_STAR_STRIKE, 0x42D

//Max Moves
.equ MOVE_MAX_GUARD, 0x42E
.equ MOVE_MAX_STRIKE_P, 0x42F
.equ MOVE_MAX_STRIKE_S, 0x430
.equ MOVE_MAX_KNUCKLE_P, 0x431
.equ MOVE_MAX_KNUCKLE_S, 0x432
.equ MOVE_MAX_AIRSTREAM_P, 0x433
.equ MOVE_MAX_AIRSTREAM_S, 0x434
.equ MOVE_MAX_OOZE_P, 0x435
.equ MOVE_MAX_OOZE_S, 0x436
.equ MOVE_MAX_QUAKE_P, 0x437
.equ MOVE_MAX_QUAKE_S, 0x438
.equ MOVE_MAX_ROCKFALL_P, 0x439
.equ MOVE_MAX_ROCKFALL_S, 0x43A
.equ MOVE_MAX_FLUTTERBY_P, 0x43B
.equ MOVE_MAX_FLUTTERBY_S, 0x43C
.equ MOVE_MAX_PHANTASM_P, 0x43D
.equ MOVE_MAX_PHANTASM_S, 0x43E
.equ MOVE_MAX_STEELSPIKE_P, 0x43F
.equ MOVE_MAX_STEELSPIKE_S, 0x440
.equ MOVE_MAX_FLARE_P, 0x441
.equ MOVE_MAX_FLARE_S, 0x442
.equ MOVE_MAX_GEYSER_P, 0x443
.equ MOVE_MAX_GEYSER_S, 0x444
.equ MOVE_MAX_OVERGROWTH_P, 0x445
.equ MOVE_MAX_OVERGROWTH_S, 0x446
.equ MOVE_MAX_LIGHTNING_P, 0x447
.equ MOVE_MAX_LIGHTNING_S, 0x448
.equ MOVE_MAX_MINDSTORM_P, 0x449
.equ MOVE_MAX_MINDSTORM_S, 0x44A
.equ MOVE_MAX_HAILSTORM_P, 0x44B
.equ MOVE_MAX_HAILSTORM_S, 0x44C
.equ MOVE_MAX_WYRMWIND_P, 0x44D
.equ MOVE_MAX_WYRMWIND_S, 0x44E
.equ MOVE_MAX_DARKNESS_P, 0x44F
.equ MOVE_MAX_DARKNESS_S, 0x450
.equ MOVE_MAX_STARFALL_P, 0x451
.equ MOVE_MAX_STARFALL_S, 0x452
.equ MOVE_G_MAX_VINE_LASH_P, 0x453
.equ MOVE_G_MAX_VINE_LASH_S, 0x454
.equ MOVE_G_MAX_WILDFIRE_P, 0x455
.equ MOVE_G_MAX_WILDFIRE_S, 0x456
.equ MOVE_G_MAX_CANNONADE_P, 0x457
.equ MOVE_G_MAX_CANNONADE_S, 0x458
.equ MOVE_G_MAX_BEFUDDLE_P, 0x459
.equ MOVE_G_MAX_BEFUDDLE_S, 0x45A
.equ MOVE_G_MAX_VOLT_CRASH_P, 0x45B
.equ MOVE_G_MAX_VOLT_CRASH_S, 0x45C
.equ MOVE_G_MAX_GOLD_RUSH_P, 0x45D
.equ MOVE_G_MAX_GOLD_RUSH_S, 0x45E
.equ MOVE_G_MAX_CHI_STRIKE_P, 0x45F
.equ MOVE_G_MAX_CHI_STRIKE_S, 0x460
.equ MOVE_G_MAX_TERROR_P, 0x461
.equ MOVE_G_MAX_TERROR_S, 0x462
.equ MOVE_G_MAX_FOAM_BURST_P, 0x463
.equ MOVE_G_MAX_FOAM_BURST_S, 0x464
.equ MOVE_G_MAX_RESONANCE_P, 0x465
.equ MOVE_G_MAX_RESONANCE_S, 0x466
.equ MOVE_G_MAX_CUDDLE_P, 0x467
.equ MOVE_G_MAX_CUDDLE_S, 0x468
.equ MOVE_G_MAX_REPLENISH_P, 0x469
.equ MOVE_G_MAX_REPLENISH_S, 0x46A
.equ MOVE_G_MAX_MALODOR_P, 0x46B
.equ MOVE_G_MAX_MALODOR_S, 0x46C
.equ MOVE_G_MAX_MELTDOWN_P, 0x46D
.equ MOVE_G_MAX_MELTDOWN_S, 0x46E
.equ MOVE_G_MAX_DRUM_SOLO_P, 0x46F
.equ MOVE_G_MAX_DRUM_SOLO_S, 0x470
.equ MOVE_G_MAX_FIREBALL_P, 0x471
.equ MOVE_G_MAX_FIREBALL_S, 0x472
.equ MOVE_G_MAX_HYDROSNIPE_P, 0x473
.equ MOVE_G_MAX_HYDROSNIPE_S, 0x474
.equ MOVE_G_MAX_WIND_RAGE_P, 0x475
.equ MOVE_G_MAX_WIND_RAGE_S, 0x476
.equ MOVE_G_MAX_GRAVITAS_P, 0x477
.equ MOVE_G_MAX_GRAVITAS_S, 0x478
.equ MOVE_G_MAX_STONESURGE_P, 0x479
.equ MOVE_G_MAX_STONESURGE_S, 0x47A
.equ MOVE_G_MAX_VOLCALITH_P, 0x47B
.equ MOVE_G_MAX_VOLCALITH_S, 0x47C
.equ MOVE_G_MAX_TARTNESS_P, 0x47D
.equ MOVE_G_MAX_TARTNESS_S, 0x47E
.equ MOVE_G_MAX_SWEETNESS_P, 0x47F
.equ MOVE_G_MAX_SWEETNESS_S, 0x480
.equ MOVE_G_MAX_SANDBLAST_P, 0x481
.equ MOVE_G_MAX_SANDBLAST_S, 0x482
.equ MOVE_G_MAX_STUN_SHOCK_P, 0x483
.equ MOVE_G_MAX_STUN_SHOCK_S, 0x484
.equ MOVE_G_MAX_CENTIFERNO_P, 0x485
.equ MOVE_G_MAX_CENTIFERNO_S, 0x486
.equ MOVE_G_MAX_SMITE_P, 0x487
.equ MOVE_G_MAX_SMITE_S, 0x488
.equ MOVE_G_MAX_SNOOZE_P, 0x489
.equ MOVE_G_MAX_SNOOZE_S, 0x48A
.equ MOVE_G_MAX_FINALE_P, 0x48B
.equ MOVE_G_MAX_FINALE_S, 0x48C
.equ MOVE_G_MAX_STEELSURGE_P, 0x48D
.equ MOVE_G_MAX_STEELSURGE_S, 0x48E
.equ MOVE_G_MAX_DEPLETION_P, 0x48F
.equ MOVE_G_MAX_DEPLETION_S, 0x490
.equ MOVE_G_MAX_ONE_BLOW_P, 0x491
.equ MOVE_G_MAX_ONE_BLOW_S, 0x492
.equ MOVE_G_MAX_RAPID_FLOW_P, 0x493
.equ MOVE_G_MAX_RAPID_FLOW_S, 0x494
...
.equ ITEM_EFFECT_ROOM_EXTENDER, 138
.equ ITEM_EFFECT_RUNIC_MIRROR, 139
.equ ITEM_EFFECT_RUSTED_SWORD, 140
.equ ITEM_EFFECT_RUSTED_SHIELD, 141
.equ ITEM_EFFECT_PARALYZE_ORB, 142
.equ ITEM_EFFECT_SLEEP_ORB, 143
.equ ITEM_EFFECT_FROST_ORB, 144
...
.equ SPECIES_WISHIWASHI_SCHOOLING, 0x417
...
.equ SPECIES_LUGIA_SHADOW, 0x4A2
...
.equ SPECIES_WEEZING_G, 0x4BE
.equ SPECIES_MR_MIME_G, 0x4BF
.equ SPECIES_ARTICUNO_G, 0x4C0
.equ SPECIES_ZAPDOS_G, 0x4C1
.equ SPECIES_MOLTRES_G, 0x4C2
.equ SPECIES_SLOWKING_G, 0x4C3
.equ SPECIES_CORSOLA_G, 0x4C4
.equ SPECIES_ZIGZAGOON_G, 0x4C5
.equ SPECIES_LINOONE_G, 0x4C6
...
.equ SPECIES_TOXTRICITY_LOW_KEY_GIGA, 0x4E5
.equ SPECIES_CENTISKORCH_GIGA, 0x4E6
.equ SPECIES_HATTERENE_GIGA, 0x4E7
.equ SPECIES_GRIMMSNARL_GIGA, 0x4E8
.equ SPECIES_ALCREMIE_GIGA, 0x4E9
.equ SPECIES_COPPERAJAH_GIGA, 0x4EA
.equ SPECIES_DURALUDON_GIGA, 0x4EB
.equ SPECIES_URSHIFU_SINGLE_GIGA, 0x4EC
.equ SPECIES_URSHIFU_RAPID_GIGA, 0x4ED

.equ SPECIES_GLASTRIER, 0x4EE
.equ SPECIES_SPECTRIER, 0x4EF
.equ SPECIES_CALYREX_ICE, 0x4F0
.equ SPECIES_CALYREX_GHOST, 0x4F1
.equ SPECIES_WYRDEER, 0x4F2
.equ SPECIES_KLEAVOR, 0x4F3
.equ SPECIES_URSALUNA, 0x4F4
.equ SPECIES_BASCULEGION, 0x4F5
.equ SPECIES_SNEASLER, 0x4F6
.equ SPECIES_OVERQWIL, 0x4F7
.equ SPECIES_ENAMORUS, 0x4F8
.equ SPECIES_GROWLITHE_H, 0x4F9
.equ SPECIES_ARCANINE_H, 0x4FA
.equ SPECIES_VOLTORB_H, 0x4FB
.equ SPECIES_ELECTRODE_H, 0x4FC
.equ SPECIES_TYPHLOSION_H, 0x4FD
.equ SPECIES_QWILFISH_H, 0x4FE
.equ SPECIES_SNEASEL_H, 0x4FF
.equ SPECIES_SAMUROTT_H, 0x500
.equ SPECIES_LILLIGANT_H, 0x501
.equ SPECIES_ZORUA_H, 0x502
.equ SPECIES_ZOROARK_H, 0x503
.equ SPECIES_BRAVIARY_H, 0x504
.equ SPECIES_SLIGGOO_H, 0x505
.equ SPECIES_GOODRA_H, 0x506
.equ SPECIES_AVALUGG_H, 0x507
.equ SPECIES_DECIDUEYE_H, 0x508
.equ SPECIES_DIALGA_ORIGIN, 0x509
.equ SPECIES_PALKIA_ORIGIN, 0x50A
.equ SPECIES_BASCULIN_WHITE, 0x50B
.equ SPECIES_BASCULEGION_FEMALE, 0x50C
.equ SPECIES_ENAMORUS_THERIAN, 0x50D
...
.equ SPECIES_DUDUNSPARCE, 0x519
.equ SPECIES_TAROUNTULA, 0x51A
.equ SPECIES_SPIDOPS, 0x51B
.equ SPECIES_NYMBLE, 0x51C
.equ SPECIES_LOKIX, 0x51D
.equ SPECIES_RELLOR, 0x51E
.equ SPECIES_RABSCA, 0x51F
.equ SPECIES_GREAVARD, 0x520
.equ SPECIES_HOUNDSTONE, 0x521
.equ SPECIES_FLITTLE, 0x522
.equ SPECIES_ESPATHRA, 0x523
.equ SPECIES_FARIGIRAF, 0x524
.equ SPECIES_WIGLETT, 0x525
.equ SPECIES_WUGTRIO, 0x526
.equ SPECIES_DONDOZO, 0x527
.equ SPECIES_VELUZA, 0x528
.equ SPECIES_FINIZEN, 0x529
.equ SPECIES_PALAFIN, 0x52A
.equ SPECIES_SMOLIV, 0x52B
.equ SPECIES_DOLLIV, 0x52C
.equ SPECIES_ARBOLIVA, 0x52D
.equ SPECIES_CAPSAKID, 0x52E
.equ SPECIES_SCOVILLAIN, 0x52F
.equ SPECIES_TADBULB, 0x530
.equ SPECIES_BELLIBOLT, 0x531
.equ SPECIES_VAROOM, 0x532
.equ SPECIES_REVAVROOM, 0x533
.equ SPECIES_ORTHWORM, 0x534
.equ SPECIES_TANDEMAUS, 0x535
.equ SPECIES_MAUSHOLD, 0x536
.equ SPECIES_CETODDLE, 0x537
.equ SPECIES_CETITAN, 0x538
.equ SPECIES_FRIGIBAX, 0x539
.equ SPECIES_ARCTIBAX, 0x53A
.equ SPECIES_BAXCALIBUR, 0x53B
.equ SPECIES_TATSUGIRI, 0x53C
.equ SPECIES_CYCLIZAR, 0x53D
.equ SPECIES_PAWMI, 0x53E
.equ SPECIES_PAWMO, 0x53F
.equ SPECIES_PAWMOT, 0x540
.equ SPECIES_WATTREL, 0x541
.equ SPECIES_KILOWATTREL, 0x542
.equ SPECIES_BOMBIRDIER, 0x543
.equ SPECIES_SQUAWKABILLY, 0x544
.equ SPECIES_FLAMIGO, 0x545
.equ SPECIES_KLAWF, 0x546
.equ SPECIES_NACLI, 0x547
.equ SPECIES_NACLSTACK, 0x548
.equ SPECIES_GARGANACL, 0x549
.equ SPECIES_GLIMMET, 0x54A
.equ SPECIES_GLIMMORA, 0x54B
.equ SPECIES_SHROODLE, 0x54C
.equ SPECIES_GRAFAIAI, 0x54D
.equ SPECIES_FIDOUGH, 0x54E
.equ SPECIES_DACHSBUN, 0x54F
.equ SPECIES_MASCHIFF, 0x550
.equ SPECIES_MABOSSTIFF, 0x551
.equ SPECIES_BRAMBLIN, 0x552
.equ SPECIES_BRAMBLEGHAST, 0x553
.equ SPECIES_GIMMIGHOUL, 0x554
.equ SPECIES_GHOLDENGO, 0x555
.equ SPECIES_GREAT_TUSK, 0x556
.equ SPECIES_BRUTE_BONNET, 0x557
.equ SPECIES_SUICUNE_ANCIENT, 0x558
.equ SPECIES_SANDY_SHOCKS, 0x559
.equ SPECIES_SCREAM_TAIL, 0x55A
.equ SPECIES_FLUTTER_MANE, 0x55B
.equ SPECIES_SLITHER_WING, 0x55C
.equ SPECIES_ROARING_MOON, 0x55D
.equ SPECIES_IRON_TREADS, 0x55E
.equ SPECIES_VIRIZION_FUTURE, 0x55F
.equ SPECIES_IRON_MOTH, 0x560
.equ SPECIES_IRON_HANDS, 0x561
.equ SPECIES_IRON_JUGULIS, 0x562
.equ SPECIES_IRON_THORNS, 0x563
.equ SPECIES_IRON_BUNDLE, 0x564
.equ SPECIES_IRON_VALIANT, 0x565
.equ SPECIES_TING_LU, 0x566
.equ SPECIES_CHIEN_PAO, 0x567
.equ SPECIES_WO_CHIEN, 0x568
.equ SPECIES_CHI_YU, 0x569
.equ SPECIES_KORAIDON, 0x56A
.equ SPECIES_MIRAIDON, 0x56B
.equ SPECIES_TINKATINK, 0x56C
.equ SPECIES_TINKATUFF, 0x56D
.equ SPECIES_TINKATON, 0x56E
.equ SPECIES_CHARCADET, 0x56F
.equ SPECIES_ARMAROUGE, 0x570
.equ SPECIES_CERULEDGE, 0x571
.equ SPECIES_TOEDSCOOL, 0x572
.equ SPECIES_TOEDSCRUEL, 0x573
.equ SPECIES_KINGAMBIT, 0x574
.equ SPECIES_CLODSIRE, 0x575
.equ SPECIES_ANNIHILAPE, 0x576
.equ SPECIES_WOOPER_P, 0x577
.equ SPECIES_TAUROS_P, 0x578
.equ SPECIES_TAUROS_P_BLAZE, 0x579
.equ SPECIES_TAUROS_P_AQUA, 0x57A
.equ SPECIES_OINKOLOGNE_F, 0x57B
.equ SPECIES_PALAFIN_HERO, 0x57C
.equ SPECIES_SQUAWKABILLY_BLUE, 0x57D
.equ SPECIES_SQUAWKABILLY_YELLOW, 0x57E
.equ SPECIES_SQUAWKABILLY_WHITE, 0x57F
.equ SPECIES_DUDUNSPARCE_THREE, 0x580
.equ SPECIES_GIMMIGHOUL_ROAMING, 0x581
.equ SPECIES_MAUSHOLD_FOUR, 0x582
.equ SPECIES_TATSUGIRI_DROOPY, 0x583
.equ SPECIES_TATSUGIRI_STRETCHY, 0x584

.equ SPECIES_SCARLET_VIOLET_111X, 0x585
.equ SPECIES_SCARLET_VIOLET_112X, 0x586
.equ SPECIES_SCARLET_VIOLET_113X, 0x587
.equ SPECIES_SCARLET_VIOLET_114X, 0x588
.equ SPECIES_SCARLET_VIOLET_115X, 0x589
.equ SPECIES_SCARLET_VIOLET_116X, 0x58A
.equ SPECIES_SCARLET_VIOLET_117X, 0x58B
.equ SPECIES_SCARLET_VIOLET_118X, 0x58C
.equ SPECIES_SCARLET_VIOLET_119X, 0x58D
.equ SPECIES_SCARLET_VIOLET_120X, 0x58E
.equ SPECIES_SCARLET_VIOLET_121X, 0x58F
.equ SPECIES_SCARLET_VIOLET_122X, 0x590
.equ SPECIES_SCARLET_VIOLET_123X, 0x591
.equ SPECIES_SCARLET_VIOLET_124X, 0x592
.equ SPECIES_SCARLET_VIOLET_125X, 0x593
.equ SPECIES_SCARLET_VIOLET_126X, 0x594
.equ SPECIES_SCARLET_VIOLET_127X, 0x595
.equ SPECIES_SCARLET_VIOLET_128X, 0x596
.equ SPECIES_SCARLET_VIOLET_129X, 0x597
.equ SPECIES_SCARLET_VIOLET_130X, 0x598
.equ SPECIES_SCARLET_VIOLET_131X, 0x599
.equ SPECIES_SCARLET_VIOLET_132X, 0x59A
.equ SPECIES_SCARLET_VIOLET_133X, 0x59B
.equ SPECIES_SCARLET_VIOLET_134X, 0x59C
.equ SPECIES_SCARLET_VIOLET_135X, 0x59D
.equ SPECIES_SCARLET_VIOLET_136X, 0x59E
.equ SPECIES_SCARLET_VIOLET_137X, 0x59F
.equ SPECIES_SCARLET_VIOLET_138X, 0x5A0
.equ SPECIES_SCARLET_VIOLET_139X, 0x5A1
.equ SPECIES_SCARLET_VIOLET_140X, 0x5A2
.equ SPECIES_SCARLET_VIOLET_141X, 0x5A3
.equ SPECIES_CEBULACK, 0x5A4
.equ SPECIES_CEBULBA, 0x5A5
.equ SPECIES_CEBOGRE, 0x5A6
.equ SPECIES_SHARIK, 0x5A7
.equ SPECIES_SHARKADE, 0x5A8
.equ SPECIES_SHARKANO, 0x5A9
.equ SPECIES_RABBLIT, 0x5AA
.equ SPECIES_PYROSE, 0x5AB
.equ SPECIES_DOYEBUNNY, 0x5AC
.equ SPECIES_CLOCKOG, 0x5AD
.equ SPECIES_EMBIRD, 0x5AE
.equ SPECIES_TORCHAWK, 0x5AF
.equ SPECIES_BURSTWING, 0x5B0
.equ SPECIES_MOLEKID, 0x5B1
.equ SPECIES_MOLEBULK, 0x5B2
.equ SPECIES_TUCAM, 0x5B3
.equ SPECIES_DOREKEY, 0x5B4
.equ SPECIES_MAGICLOUD, 0x5B5
.equ SPECIES_OSTREECH, 0x5B6
.equ SPECIES_TURTRES, 0x5B7
.equ SPECIES_CARAXIC, 0x5B8
.equ SPECIES_VELYNX, 0x5B9
.equ SPECIES_PUFFINIGHT, 0x5BA
.equ SPECIES_FLAPPICE, 0x5BB
.equ SPECIES_KOMORDON, 0x5BC
.equ SPECIES_LIZEMBRA, 0x5BD
.equ SPECIES_BASIBLAZE, 0x5BE
.equ SPECIES_SPIRISCRUFF, 0x5BF
.equ SPECIES_SPIRIPALM, 0x5C0
.equ SPECIES_DEMOLETT, 0x5C1
.equ SPECIES_JUNGYENA, 0x5C2
.equ SPECIES_VESPIKING, 0x5C3
.equ SPECIES_APPLERAVE, 0x5C4
.equ SPECIES_EPEP, 0x5C5
.equ SPECIES_NAH, 0x5C6
.equ SPECIES_BULBASAUR_S, 0x5C7
.equ SPECIES_IVYSAUR_S, 0x5C8
.equ SPECIES_VENUSAUR_S, 0x5C9
.equ SPECIES_BEEDRILL_S, 0x5CA
.equ SPECIES_SANDSHREW_S, 0x5CB
.equ SPECIES_SANDSLASH_S, 0x5CC
.equ SPECIES_ZUBAT_S, 0x5CD
.equ SPECIES_GOLBAT_S, 0x5CE
.equ SPECIES_CROBAT_S, 0x5CF
.equ SPECIES_PARAS_S, 0x5D0
.equ SPECIES_PARASECT_S, 0x5D1
.equ SPECIES_MANKEY_S, 0x5D2
.equ SPECIES_PRIMEAPE_S, 0x5D3
.equ SPECIES_ABRA_S, 0x5D4
.equ SPECIES_KADABRA_S, 0x5D5
.equ SPECIES_ALAKAZAM_S, 0x5D6
.equ SPECIES_GEODUDE_S, 0x5D7
.equ SPECIES_GRAVELER_S, 0x5D8
.equ SPECIES_GOLEM_S, 0x5D9
.equ SPECIES_DODUO_S, 0x5DA
.equ SPECIES_DODRIO_S, 0x5DB
.equ SPECIES_GRIMER_S, 0x5DC
.equ SPECIES_MUK_S, 0x5DD
.equ SPECIES_GASTLY_S, 0x5DE
.equ SPECIES_HAUNTER_S, 0x5DF
.equ SPECIES_GENGAR_S, 0x5E0
.equ SPECIES_VOLTORB_S, 0x5E1
.equ SPECIES_ELECTRODE_S, 0x5E2
.equ SPECIES_LICKITUNG_S, 0x5E3
.equ SPECIES_KOFFING_S, 0x5E4
.equ SPECIES_WEEZING_S, 0x5E5
.equ SPECIES_SCYTHER_S, 0x5E6
.equ SPECIES_MAGBY_S, 0x5E7
.equ SPECIES_MAGMAR_S, 0x5E8
.equ SPECIES_MAGMORTAR_S, 0x5E9
.equ SPECIES_PINSIR_S, 0x5EA
.equ SPECIES_MAGIKARP_S, 0x5EB
.equ SPECIES_GYARADOS_S, 0x5EC
.equ SPECIES_LAPRAS_S, 0x5ED
.equ SPECIES_SNORLAX_S, 0x5EE
.equ SPECIES_CHIKORITA_S, 0x5EF
.equ SPECIES_BAYLEEF_S, 0x5F0
.equ SPECIES_MEGANIUM_S, 0x5F1
.equ SPECIES_CYNDAQUIL_S, 0x5F2
.equ SPECIES_QUILAVA_S, 0x5F3
.equ SPECIES_TYPHLOSION_S, 0x5F4
.equ SPECIES_TOTODILE_S, 0x5F5
.equ SPECIES_CROCONAW_S, 0x5F6
.equ SPECIES_FERALIGATR_S, 0x5F7
.equ SPECIES_SUNFLORA_S, 0x5F8
.equ SPECIES_WOOPER_S, 0x5F9
.equ SPECIES_QUAGSIRE_S, 0x5FA
.equ SPECIES_WYNAUT_S, 0x5FB
.equ SPECIES_WOBBUFFET_S, 0x5FC
.equ SPECIES_HERACROSS_S, 0x5FD
.equ SPECIES_SLUGMA_S, 0x5FE
.equ SPECIES_MAGCARGO_S, 0x5FF
.equ SPECIES_SWINUB_S, 0x600
.equ SPECIES_PILOSWINE_S, 0x601
.equ SPECIES_MAMOSWINE_S, 0x602
.equ SPECIES_MILTANK_S, 0x603
.equ SPECIES_TORCHIC_S, 0x604
.equ SPECIES_COMBUSKEN_S, 0x605
.equ SPECIES_BLAZIKEN_S, 0x606
.equ SPECIES_POOCHYENA_S, 0x607
.equ SPECIES_MIGHTYENA_S, 0x608
.equ SPECIES_SHROOMISH_S, 0x609
.equ SPECIES_BRELOOM_S, 0x60A
.equ SPECIES_DELCATTY_S, 0x60B
.equ SPECIES_SABLEYE_S, 0x60C
.equ SPECIES_MAWILE_S, 0x60D
.equ SPECIES_NUMEL_S, 0x60E
.equ SPECIES_CAMERUPT_S, 0x60F
.equ SPECIES_SEVIPER_S, 0x610
.equ SPECIES_SNORUNT_S, 0x611
.equ SPECIES_GLALIE_S, 0x612
.equ SPECIES_FROSLASS_S, 0x613
.equ SPECIES_BIDOOF_S, 0x614
.equ SPECIES_BIBAREL_S, 0x615
.equ SPECIES_BUNEARY_S, 0x616
.equ SPECIES_LOPUNNY_S, 0x617
.equ SPECIES_GIBLE_S, 0x618
.equ SPECIES_GABITE_S, 0x619
.equ SPECIES_GARCHOMP_S, 0x61A
.equ SPECIES_COTTONEE_S, 0x61B
.equ SPECIES_WHIMSICOTT_S, 0x61C
.equ SPECIES_MARACTUS_S, 0x61D
.equ SPECIES_SCRAGGY_S, 0x61E
.equ SPECIES_SCRAFTY_S, 0x61F
.equ SPECIES_DUCKLETT_S, 0x620
.equ SPECIES_ELGYEM_S, 0x621
.equ SPECIES_BEHEEYEM_S, 0x622
.equ SPECIES_AXEW_S, 0x623
.equ SPECIES_FRAXURE_S, 0x624
.equ SPECIES_HAXORUS_S, 0x625
.equ SPECIES_SKIDDO_S, 0x626
.equ SPECIES_GOGOAT_S, 0x627
.equ SPECIES_HAWLUCHA_S, 0x628
.equ SPECIES_DIANCIE_SHADOW, 0x629
.equ SPECIES_ORICORIO_R, 0x62A
.equ SPECIES_STUFFUL_S, 0x62B
.equ SPECIES_BEWEAR_S, 0x62C
.equ SPECIES_TSAREENA_S, 0x62D
.equ SPECIES_COMFEY_S, 0x62E
.equ SPECIES_SANDYGAST_S, 0x62F
.equ SPECIES_PALOSSAND_S, 0x630
.equ SPECIES_KOMALA_S, 0x631
.equ SPECIES_NICKIT_S, 0x632
.equ SPECIES_THIEVUL_S, 0x633
.equ SPECIES_ELDEGOSS_S, 0x634
.equ SPECIES_WOOLOO_S, 0x635
.equ SPECIES_DUBWOOL_S, 0x636
.equ SPECIES_TOXEL_S, 0x637
.equ SPECIES_TOXTRICITY_S, 0x638
.equ SPECIES_ALAKAZAM_S_MEGA, 0x639
.equ SPECIES_LANTURN_MEGA, 0x63A
.equ SPECIES_OCTILLERY_MEGA, 0x63B
.equ SPECIES_SMEARGLE_MEGA, 0x63C
.equ SPECIES_SWELLOW_MEGA, 0x63D
.equ SPECIES_CHIMECHO_MEGA, 0x63E
.equ SPECIES_TALONFLAME_MEGA, 0x63F
.equ SPECIES_LOPUNNY_S_MEGA, 0x640
.equ SPECIES_CARBINK_MEGA, 0x641
.equ SPECIES_DEMOLETT_SHELTER, 0x642
...
.equ ITEM_PINK_BOW, 0x2DA
.equ ITEM_ROOM_EXTENDER, 0x2DB
.equ ITEM_RELIC_MIRROR, 0x2DC
.equ ITEM_BLACK_AUGURITE, 0x2DD
...
.equ ITEM_EMPATHY_ROCK, 0x2E8
.equ ITEM_FREE_SPACE17, 0x2E9
.equ ITEM_FREE_SPACE18, 0x2EA
.equ ITEM_FREE_SPACE19, 0x2EB
.equ ITEM_INFINITE_REPEL, 0x2EC
.equ ITEM_PORTABLE_PC, 0x2ED
.equ ITEM_STAT_SCANNER, 0x2EE
.equ ITEM_CATCHING_CHARM, 0x2EF
.equ ITEM_EXP_CHARM, 0x2F0
.equ ITEM_NATURE_PILL_HARDY, 753
.equ ITEM_NATURE_PILL_LONELY, 754
.equ ITEM_NATURE_PILL_BRAVE, 755
.equ ITEM_NATURE_PILL_ADAMANT, 756
.equ ITEM_NATURE_PILL_NAUGHTY, 757
.equ ITEM_NATURE_PILL_BOLD, 758
.equ ITEM_NATURE_PILL_DOCILE, 759
.equ ITEM_NATURE_PILL_RELAXED, 760
.equ ITEM_NATURE_PILL_IMPISH, 761
.equ ITEM_NATURE_PILL_LAX, 762
.equ ITEM_NATURE_PILL_TIMID, 763
.equ ITEM_NATURE_PILL_HASTY, 764
.equ ITEM_NATURE_PILL_SERIOUS, 765
.equ ITEM_NATURE_PILL_JOLLY, 766
.equ ITEM_NATURE_PILL_NAIVE, 767
.equ ITEM_NATURE_PILL_MODEST, 768
.equ ITEM_NATURE_PILL_MILD, 769
.equ ITEM_NATURE_PILL_QUIET, 770
.equ ITEM_NATURE_PILL_BASHFUL, 771
.equ ITEM_NATURE_PILL_RASH, 772
.equ ITEM_NATURE_PILL_CALM, 773
.equ ITEM_NATURE_PILL_GENTLE, 774
.equ ITEM_NATURE_PILL_SASSY, 775
.equ ITEM_NATURE_PILL_CAREFUL, 776
.equ ITEM_NATURE_PILL_QUIRKY, 777
.equ ITEM_ELECTRIC_CANDY, 0x30A
.equ ITEM_MISTY_CANDY, 0x30B
.equ ITEM_PSYCHIC_CANDY, 0x30C
.equ ITEM_GRASSY_CANDY, 0x30D
.equ ITEM_PARALYZE_ORB, 0X30E
.equ ITEM_SLEEP_ORB, 0X30F
.equ ITEM_FROST_ORB, 0X310
.equ ITEM_SHINY_BALL, 0X311
.equ ITEM_SOLAR_BALL, 0X312
.equ ITEM_FLOOD_BALL, 0X313
.equ ITEM_HAIL_BALL, 0X314
.equ ITEM_EARTH_BALL, 0X315
.equ ITEM_FREE_790, 0x316
.equ ITEM_FREE_791, 0x317
.equ ITEM_FREE_792, 0x318
.equ ITEM_FREE_793, 0x319
.equ ITEM_FREE_794, 0x31A
.equ ITEM_FREE_795, 0x31B
.equ ITEM_FREE_796, 0x31C
.equ ITEM_FREE_797, 0x31D
.equ ITEM_FREE_798, 0x31E
.equ ITEM_FREE_799, 0x31F
.equ ITEM_FREE_800, 0x320
.equ ITEM_FREE_801, 0x321
.equ ITEM_FREE_802, 0x322
.equ ITEM_FREE_803, 0x323
.equ ITEM_FREE_804, 0x324
.equ ITEM_FREE_805, 0x325
.equ ITEM_FREE_806, 0x326
.equ ITEM_FREE_807, 0x327
.equ ITEM_FREE_808, 0x328
.equ ITEM_FREE_809, 0x329
.equ ITEM_FREE_810, 0x32A
.equ ITEM_FREE_811, 0x32B
.equ ITEM_FREE_812, 0x32C
.equ ITEM_FREE_813, 0x32D
.equ ITEM_FREE_814, 0x32E
.equ ITEM_FREE_815, 0x32F
.equ ITEM_FREE_816, 0x330
.equ ITEM_FREE_817, 0x331
.equ ITEM_FREE_818, 0x332
.equ ITEM_FREE_819, 0x333
.equ ITEM_FREE_820, 0x334
.equ ITEM_FREE_821, 0x335
.equ ITEM_FREE_822, 0x336
.equ ITEM_FREE_823, 0x337
.equ ITEM_FREE_824, 0x338
.equ ITEM_FREE_825, 0x339
.equ ITEM_FREE_826, 0x33A
.equ ITEM_FREE_827, 0x33B
.equ ITEM_FREE_828, 0x33C
.equ ITEM_FREE_829, 0x33D
.equ ITEM_FREE_830, 0x33E
.equ ITEM_FREE_831, 0x33F
.equ ITEM_FREE_832, 0x340
.equ ITEM_FREE_833, 0x341
.equ ITEM_FREE_834, 0x342
.equ ITEM_FREE_835, 0x343
.equ ITEM_FREE_836, 0x344
.equ ITEM_FREE_837, 0x345
.equ ITEM_FREE_838, 0x346
.equ ITEM_FREE_839, 0x347
.equ ITEM_FREE_840, 0x348
.equ ITEM_FREE_841, 0x349
.equ ITEM_FREE_842, 0x34A
.equ ITEM_FREE_843, 0x34B
.equ ITEM_FREE_844, 0x34C
.equ ITEM_FREE_845, 0x34D
.equ ITEM_FREE_846, 0x34E
.equ ITEM_FREE_847, 0x34F
.equ ITEM_FREE_848, 0x350
.equ ITEM_FREE_849, 0x351
.equ ITEM_FREE_850, 0x352
.equ ITEM_FREE_851, 0x353
.equ ITEM_FREE_852, 0x354
.equ ITEM_FREE_853, 0x355
.equ ITEM_FREE_854, 0x356
.equ ITEM_FREE_855, 0x357
.equ ITEM_FREE_856, 0x358
.equ ITEM_FREE_857, 0x359
.equ ITEM_FREE_858, 0x35A
.equ ITEM_FREE_859, 0x35B
.equ ITEM_FREE_860, 0x35C
.equ ITEM_FREE_861, 0x35D
.equ ITEM_FREE_862, 0x35E
.equ ITEM_FREE_863, 0x35F
.equ ITEM_FREE_864, 0x360
.equ ITEM_FREE_865, 0x361
.equ ITEM_FREE_866, 0x362
.equ ITEM_FREE_867, 0x363
.equ ITEM_FREE_868, 0x364
.equ ITEM_FREE_869, 0x365
.equ ITEM_FREE_870, 0x366
.equ ITEM_FREE_871, 0x367
.equ ITEM_FREE_872, 0x368
.equ ITEM_FREE_873, 0x369
.equ ITEM_FREE_874, 0x36A
.equ ITEM_FREE_875, 0x36B
.equ ITEM_FREE_876, 0x36C
.equ ITEM_FREE_877, 0x36D
.equ ITEM_FREE_878, 0x36E
.equ ITEM_FREE_879, 0x36F
.equ ITEM_FREE_880, 0x370
.equ ITEM_FREE_881, 0x371
.equ ITEM_FREE_882, 0x372
.equ ITEM_FREE_883, 0x373
.equ ITEM_FREE_884, 0x374
.equ ITEM_FREE_885, 0x375
.equ ITEM_FREE_886, 0x376
.equ ITEM_FREE_887, 0x377
.equ ITEM_FREE_888, 0x378
.equ ITEM_FREE_889, 0x379
.equ ITEM_FREE_890, 0x37A
.equ ITEM_FREE_891, 0x37B
.equ ITEM_FREE_892, 0x37C
.equ ITEM_FREE_893, 0x37D
.equ ITEM_FREE_894, 0x37E
.equ ITEM_FREE_895, 0x37F
.equ ITEM_FREE_896, 0x380
.equ ITEM_FREE_897, 0x381
.equ ITEM_FREE_898, 0x382
.equ ITEM_FREE_899, 0x383
.equ ITEM_FREE_900, 0x384
.equ ITEM_FREE_901, 0x385
.equ ITEM_FREE_902, 0x386
.equ ITEM_FREE_903, 0x387
.equ ITEM_FREE_904, 0x388
.equ ITEM_FREE_905, 0x389
.equ ITEM_FREE_906, 0x38A
.equ ITEM_FREE_907, 0x38B
.equ ITEM_FREE_908, 0x38C
.equ ITEM_FREE_909, 0x38D
.equ ITEM_FREE_910, 0x38E
.equ ITEM_FREE_911, 0x38F
.equ ITEM_FREE_912, 0x390
.equ ITEM_FREE_913, 0x391
.equ ITEM_FREE_914, 0x392
.equ ITEM_FREE_915, 0x393
.equ ITEM_FREE_916, 0x394
.equ ITEM_FREE_917, 0x395
.equ ITEM_FREE_918, 0x396
.equ ITEM_FREE_919, 0x397
.equ ITEM_FREE_920, 0x398
.equ ITEM_FREE_921, 0x399
.equ ITEM_FREE_922, 0x39A
.equ ITEM_FREE_923, 0x39B
.equ ITEM_FREE_924, 0x39C
.equ ITEM_FREE_925, 0x39D
.equ ITEM_FREE_926, 0x39E
.equ ITEM_FREE_927, 0x39F
.equ ITEM_FREE_928, 0x3A0
.equ ITEM_FREE_929, 0x3A1
.equ ITEM_FREE_930, 0x3A2
.equ ITEM_FREE_931, 0x3A3
.equ ITEM_FREE_932, 0x3A4
.equ ITEM_FREE_933, 0x3A5
.equ ITEM_FREE_934, 0x3A6
.equ ITEM_FREE_935, 0x3A7
.equ ITEM_FREE_936, 0x3A8
.equ ITEM_FREE_937, 0x3A9
.equ ITEM_FREE_938, 0x3AA
.equ ITEM_FREE_939, 0x3AB
.equ ITEM_FREE_940, 0x3AC
.equ ITEM_FREE_941, 0x3AD
.equ ITEM_FREE_942, 0x3AE
.equ ITEM_FREE_943, 0x3AF
.equ ITEM_FREE_944, 0x3B0
.equ ITEM_FREE_945, 0x3B1
.equ ITEM_FREE_946, 0x3B2
.equ ITEM_FREE_947, 0x3B3
.equ ITEM_FREE_948, 0x3B4
.equ ITEM_FREE_949, 0x3B5
.equ ITEM_FREE_950, 0x3B6
.equ ITEM_FREE_951, 0x3B7
.equ ITEM_FREE_952, 0x3B8
.equ ITEM_FREE_953, 0x3B9
.equ ITEM_FREE_954, 0x3BA
.equ ITEM_FREE_955, 0x3BB
.equ ITEM_FREE_956, 0x3BC
.equ ITEM_FREE_957, 0x3BD
.equ ITEM_FREE_958, 0x3BE
.equ ITEM_FREE_959, 0x3BF
.equ ITEM_FREE_960, 0x3C0
.equ ITEM_FREE_961, 0x3C1
.equ ITEM_FREE_962, 0x3C2
.equ ITEM_FREE_963, 0x3C3
.equ ITEM_FREE_964, 0x3C4
.equ ITEM_FREE_965, 0x3C5
.equ ITEM_FREE_966, 0x3C6
.equ ITEM_FREE_967, 0x3C7
.equ ITEM_FREE_968, 0x3C8
.equ ITEM_FREE_969, 0x3C9
.equ ITEM_FREE_970, 0x3CA
.equ ITEM_FREE_971, 0x3CB
.equ ITEM_FREE_972, 0x3CC
.equ ITEM_FREE_973, 0x3CD
.equ ITEM_FREE_974, 0x3CE
.equ ITEM_FREE_975, 0x3CF
.equ ITEM_FREE_976, 0x3D0
.equ ITEM_FREE_977, 0x3D1
.equ ITEM_FREE_978, 0x3D2
.equ ITEM_FREE_979, 0x3D3
.equ ITEM_FREE_980, 0x3D4
.equ ITEM_FREE_981, 0x3D5
.equ ITEM_FREE_982, 0x3D6
.equ ITEM_FREE_983, 0x3D7
.equ ITEM_FREE_984, 0x3D8
.equ ITEM_FREE_985, 0x3D9
.equ ITEM_FREE_986, 0x3DA
.equ ITEM_FREE_987, 0x3DB
.equ ITEM_FREE_988, 0x3DC
.equ ITEM_FREE_989, 0x3DD
.equ ITEM_FREE_990, 0x3DE
.equ ITEM_FREE_991, 0x3DF
.equ ITEM_FREE_992, 0x3E0
.equ ITEM_FREE_993, 0x3E1
.equ ITEM_FREE_994, 0x3E2
.equ ITEM_FREE_995, 0x3E3
.equ ITEM_FREE_996, 0x3E4
.equ ITEM_FREE_997, 0x3E5
.equ ITEM_FREE_998, 0x3E6
...
.equ EFFECT_REVIVAL_BLESSING, 247
